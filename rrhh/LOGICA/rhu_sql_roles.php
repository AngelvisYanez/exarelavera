...
function sentencias_rol($id, $Par_Sql)
{
    ...
    switch ($id) {
        ...
        case 73:
            ...
            $sql = "SELECT antici_rol.Ant_Cod, antici_rol.Ant_Fec, antici_rol.Ant_Val, CAST(antici_rol.Ant_Obs AS CHAR) as Ant_Obs, antici_rol.Ant_Est, 
        ...
        case 78:
            ...
            $sql = "SELECT DISTINCT antici_rol.Ant_Cod, antici_rol.Con_Cod, antici_rol.Ant_Fec, antici_rol.Ant_Val, CAST(antici_rol.Ant_Obs AS CHAR) as Ant_Obs, antici_rol.Ant_Est,
                    CASE WHEN rol_pagos.Rol_Est = 'I' THEN NULL ELSE det_an_rol.Rol_Cod END as Rol_Cod,
                    rol_pagos.Rol_Est,
