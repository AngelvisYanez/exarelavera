...
require_once("rhu_sql_relaci_lab.php");
...
class Class_Log_Conexion_relaci extends MysqlConexion{
...
class Class_Log_Datos_relaci extends MysqlDatos{
    ...
    */
    function consultasobBD($sen_sql,$param, $obBD = null)
    {
            ...
            return $this->consulta(sentencias_relaci($sen_sql,$Par_Sql), $obBD->conexion);
    }
    ...
    */
    ...
    {
            $Par_Sql= $this->parametros($param);
            $Query = sentencias_relaci($sen_sql,$Par_Sql);//mismo que el archivo sql
