...
require_once("rhu_sql_roles.php");
...
//    }
    ...
    function getGridRolMayorCero($Map_Cod=NULL,$Rol_Cod=NULL,$imprimirAll=NULL,$check_col_hs=NULL,$check_col_jorn=NULL,$obBD_conexion=NULL,$formulas=true){ 
        try{ 
            ...
            array_push($campos,array('label'=>'T.parcial','name'=>'Con_Tpa','hidden'=>true,'width'=>0));
            ...
            $map_rol=array();
            if(!empty($Map_Cod)) {
                $fields=$this->getArrayConsulta(77, array('Map_Cod'=>$Map_Cod,'Rol_Cod'=>$Rol_Cod,'imprimirAll'=>$imprimirAll,'check_col_hs'=>$check_col_hs,'check_col_jorn'=>$check_col_jorn), $obBD_conexion);
