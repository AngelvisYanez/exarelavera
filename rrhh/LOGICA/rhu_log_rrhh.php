...
class Class_Log_Datos_rrhh extends MysqlDatos{
    ...
    */
    function consultasobBD($sen_sql,$param, $obBD)
    {
            ...
            return $this->consulta(sentencias_rrhh($sen_sql,$Par_Sql), $obBD->conexion);
    }
    ...
    */
    ...
    {
            $Par_Sql= $this->parametros($param);
            $Query = sentencias_rrhh($sen_sql,$Par_Sql);//mismo que el archivo sql
