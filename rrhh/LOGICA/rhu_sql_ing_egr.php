...
function sentencias_rrhh_ing_egr($id,$Par_Sql)
{
    $sql="";
    switch($id){
        case 0:
        ...
        case 7:
            ...
            //$sql="SELECT * FROM campo_rol WHERE Cam_Cod = '7' and Map_Cod=$Par_Sql[Map_Cod] $type $var $sum ORDER BY Cam_Tip DESC,Cam_Ord ASC;";
            //echo $sql.'<br/>';
            break;
        case 8:
        ...
        {
            $sql="SELECT Rol_Cod,Rol_Num,Rol_Fei,Rol_Fef FROM rol_pagos 
                    WHERE Pec_Cod=$Par_Sql[Pec_Cod] AND Are_Cod=$Par_Sql[Are_Cod] AND Rol_Est='A'
                    ORDER BY Rol_Num DESC";
        }
