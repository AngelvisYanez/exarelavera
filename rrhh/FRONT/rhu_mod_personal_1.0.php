...
<HTML>
    <HEAD>		
        ...
        <TITLE><?Php echo "Personal Modificar [EXA]"; ?></TITLE>
        <meta charset="UTF-8">
    ...
    <BODY>
        <div class="panel panel-main">
            <div class="panel-heading exa-header"><h3 class="panel-title">&raquo;  Modificar Informaci&oacute;n del Personal</h3></div>
