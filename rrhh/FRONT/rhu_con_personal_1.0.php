...
<HTML>
    <HEAD>		
        ...
        <TITLE><?Php echo "Personal Consultar [EXA]"; ?></TITLE>
        <meta charset="UTF-8">
    ...
    <BODY>
        <div class="panel panel-main">
            <div class="panel-heading exa-header"><h3 class="panel-title">&raquo;  Consultar Informaci&oacute;n del Personal</h3></div>
