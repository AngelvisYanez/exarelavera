...
(function($ , undefined) {
  try {
        ...
        if(typeof skin_class!=='undefined'){
           $('#skin-colorpicker option[data-skin='+skin_class+']').prop('selected','selected');
           if(skin_class!=='skin-2')
            $('#skin-colorpicker').trigger('change');
        }
  ...
  $('#skin-colorpicker').on('change', function(){
	...
	function applyChanges(skin_class) {
		...
		var skin3_colors = ['', 'green', 'blue', 'red'];
