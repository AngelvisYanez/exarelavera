...
class finca_actividad extends AbstractModel{
    protected $_name = 'finca_actividad';
    protected $_primary = array('Fnc_Cod');
    protected $_state = 'Fnc_Est';
    ...
    public function sqlByNombre($id,$Par_Sql,$cond=null){
        ...
        switch($id){
            ...
            case "setEmpCod":
                ...
                break;
            case "setSucCod":
                $sql->where("Suc_Cod=?",$_SESSION['Ses_Suc_Cod']);
                //echo $this->getSqlString($sql)."<br/>";
                break;
            case "orderByDes":
                $sql->order('Fnc_Des asc');
                break;
            case "isActive":
