...
class exporta_dest extends AbstractModel{
    protected $_name = 'exporta_dest'; 
    protected $_primary = array('Exd_Cod');	
    protected $_state = 'Exd_Est';
    ...
    public function _selectBasic($cond=null,$limits=false){         
        return $this->select()
            ->join('pais',"pais.Pas_Cod=$this->_name.Pas_Cod",array('Pas_Nom','Pas_Sri')); 
    }
