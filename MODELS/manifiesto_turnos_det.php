...
class manifiesto_turnos_det extends AbstractModel{
    protected $_name = 'manifiesto_turnos_det';
    protected $_primary = array('Tud_Cod');
    protected $_state = 'Tud_Est';
    ...
    public function sqlByNombre($id,$Par_Sql,$cond=null){
        ...
        switch($id){
            ...
            case "orderByDes": 
                $sql->order('Tud_Fec asc, Tud_Hin asc');
                break;
