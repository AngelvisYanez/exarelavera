...
class precios extends AbstractModel{
    protected $_name = 'precios'; 
    protected $_primary = array('Pre_Cod');	
    protected $_state = 'Pre_Est';
    ...
    public function _selectBasic($cond=null,$limits=false){         
        return $this->select()
            ->join('sucursal',"sucursal.Suc_Cod=$this->_name.Suc_Cod",array())
            ->join('tipo_preci',"tipo_preci.Tpv_Cod=$this->_name.Tpv_Cod",array('Tpv_Des'))
        ; 
    }
