...
class proformas_det extends AbstractModel{
    protected $_name = 'proformas_det'; 
    protected $_primary = array('Prf_Cod', 'Pfd_Int', 'Pro_Cod');	
    protected $_state = '';
    ...
    public function _selectBasic($cond=null,$limits=false){         
        return $this->select()->join(
            'proformas', "proformas.Prf_Cod=$this->_name.Prf_Cod", array()
        ); 
    }
