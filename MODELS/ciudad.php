...
class ciudad extends AbstractModel{ 
    protected $_name = 'ciudad';
    protected $_primary = array('Ciu_Cod');
    protected $_state = 'Ciu_Est';
    ...
    public function sqlByNombre($id,$Par_Sql,$cond=null){
        ...
        switch($id){
            case "getProvincia":
                $sql->join('provincia', "provincia.Pro_Cod = $this->_name.Pro_Cod", array('Pro_Nom'));
                break;
            case "getPais":    
                $sql->join('pais', "pais.Pas_Cod = $this->_name.Pas_Cod", array('Pas_Nom'));
    ...
    public function sqlByNumero($id,$Par_Sql,$cond=null){
        ...
        switch($id){
             case 0:
                $sql=" UPDATE stock SET Stk_Can =$Par_Sql[Stock], Stk_Prp =$Par_Sql[Promedio]
