...
class pago_anticipo_proveedores extends AbstractModel{
    protected $_name = 'pago_anticipo_proveedores';
    protected $_primary = array('Pap_Cod');
    protected $_state = 'Pap_Est';
