...
class tipo_asien extends AbstractModel{
    protected $_name = 'tipo_asien';
    protected $_primary = array('Tia_Cod');
    protected $_state = 'Tia_Est';
    ...
    public function sqlByNumero($id,$Par_Sql,$cond=null){
        ...
        switch($id){
            case 0:
                $sql="SELECT Tia_Cod FROM tipo_asien WHERE Tia_Abr = '$Par_Sql[0]';";
                break;
