...
class tipo_compr extends AbstractModel{
    protected $_name = 'tipo_compr';
    protected $_primary = array('Tic_Cod');
    protected $_state = 'Tic_Est';
    ...
    public function sqlByNombre($id,$Par_Sql,$cond=null){
        ...
        switch($id){
            ...
            case "isActive":
                ...
                break;
            case "isFactura":
                $sql->where("$this->_name.Tic_Des='FACTURA'");
                //echo $this->getSqlString($sql)."<br/>";
                break;
