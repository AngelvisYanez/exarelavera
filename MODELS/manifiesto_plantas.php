...
class manifiesto_plantas extends AbstractModel{
    protected $_name = 'manifiesto_plantas'; 
    protected $_primary = array('Pla_Cod');	
    protected $_state = 'Pla_Est';
    ...
    public function _selectBasic($cond=null,$limits=false){         
        return $this->select(true,array('*', 'DATE_FORMAT(Pla_Dis, "%H:%i") as Pla_Dis'))
            ->join('ciudad', "ciudad.Ciu_Cod = $this->_name.Ciu_Cod",array('Ciu_Des'));            
    }
