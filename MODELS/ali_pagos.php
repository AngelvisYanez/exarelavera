...
class ali_pagos extends AbstractModel{
    protected $_name = 'ali_pagos';
    protected $_primary = array('Ali_Cod');
    protected $_state = 'Ali_Est';
    ...
    public function sqlByNombre($id,$Par_Sql,$cond=null){
        ...
        switch($id){
            ...
            case "isActive":
                ...
                break;
            case "isMovVetCod":
                $sql->where('ali_pagos.Vet_Cod=?',"{$Par_Sql['movAlicuota']}");
                break;
