...
class mesclas extends AbstractModel{
    protected $_name = 'mesclas'; 
    protected $_primary = array('Mes_Cod');	
    protected $_state = 'Mes_Est';	
    ...
    public function _selectBasic($cond=null,$limits=false){         
        return $this->select()
            ...
            ->joinLeft('banano_marca', "banano_marca.Bam_Cod = $this->_name.Bam_Cod", array('Bam_Nom','Bam_Tam')); 
    }
