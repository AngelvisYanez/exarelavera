...
class det_reposicion extends AbstractModel{
    protected $_name = 'det_reposicion';
    ...
    public function sqlByNumero($id,$Par_Sql,$cond=null){
        ...
        switch($id){
            case 1:
                $sql="SELECT COALESCE(max(Dre_Int)+1,1) as Dre_Int FROM det_reposicion WHERE Cop_Cod=$Par_Sql[Cop_Cod]";
                //echo $this->getSqlString($sql)."<br/>";
                break;
