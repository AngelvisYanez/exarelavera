...
<HTML>
	...
	<BODY>
		<div class="panel panel-main">
			<div class="panel-heading exa-header"><h3 class="panel-title">&raquo;Alta de Movimiento</h3></div>
    ...
    <script type="text/javascript">
      opt_bod=$('<option>Principal</option>').addClass('bolden').val(0);
      $('#Bod_Ori').append(opt_bod.clone(true));
    </script>
	</BODY>
</html>