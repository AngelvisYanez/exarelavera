...
require_once($APP_REAL_PATH."/bodega/LOGICA/bod_sql_bodega.php");

/* Clase para conexion a la capa de acceso a datos */
class Class_Log_Conexion_Bod extends MysqlConexion{ }

/* Clase para acceder a los datos*/ 
class Class_Log_Datos_Bod extends MysqlDatosContab{
    function __construct(){
        $this->setSentencias('sentencias_bodega');
    }
