...
$(function(){
    ...
    if(haciendas.length>0){
        ...
        haciendas.createGrid({
            caption:'Haciendas Productor',height: 150, datatype: "local",
            stateCol:'Prh_Est',stateConfig:{I:'cellRed2'},
            leyenda:[{icon:'stop red',label:'Anulados/Inactivos'}],
            colModel: [
                //{ label: 'Cód. Int.', name: 'Prh_Cod', width: 30 ,align:"center", key:true},
                { label: 'Cód. Int.', name: 'Index', width: 20 ,align:"center", key:true, hidden:true},
                { label: 'Cod. Hac.', name: 'Prh_Cod', width: 45,align:"center", hidden:true},
                { label: 'Cod. Magap', name: 'Prh_Mag', width: 45,align:"center"},
                { label: 'Inscrip. Magap', name: 'Prh_Inm', width: 45,align:"center"},
                { label: 'Hacienda', name: 'Prh_Nom', width: 100},
                { label: 'Hectareas', name: 'Prh_Hec', width: 45,align:"right"},
                { label: 'Direccion', name: 'Prh_Dir', width: 45,align:"right", hidden:true},
                { label: 'Direccion', name: 'Prh_Est', width: 45,align:"right", hidden:true},
                $.originalRow(),
            ...
            {caption:'Agregar Hacienda', buttonicon:'glyphicon glyphicon-plus', onClickButton: function(){ haciendasCreateForm.setData({}); haciendasCreateDlg.dialog('open'); } }
        ]);
