...
//var_dump($obBD_con1->getArrayConsulta("producto.selectWhere", array('where'=>'', 'setWhere'=>'setEmpCod'), $obBD_conexion,true));
//exit();        

/* Seleccionar El Producto a Producir */
if(isset($proAjax)||isset($matAjax)){
    $obBD_con1->getPageGridJson("producto.selectWhere", $_GET, $obBD_conexion);
}
...
<BODY>
    ...
    <div class="panel panel-main">
        <div class="panel-heading exa-header"><h3 class="panel-title">&raquo;  Combinacion Materiales</h3></div>
                            ...
                            $(document).ready(function () {
                                ...
                                kardexGrid.jqGrid({
                                    ...
                                    colModel: [                               
                                        ...
                                        { label: 'Detalle',name: 'Producto', width: 200},                                        
