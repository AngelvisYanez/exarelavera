...
<HEAD>		
    ...
    <script type="text/javascript" src="../VALIDACIONES/ban_val_tarja.js?x=1"></script>
</HEAD>
<BODY>
    <div class="panel panel-main">
        <div class="panel-heading exa-header"><h3 class="panel-title">&raquo;  Registrar Tarja (Comprobante de Recepci�n)</h3></div>
                ...
                <div class="col-sm-3">
                    ...
                    <fieldset class="exa-fieldset" id="container">
                        ...
                        <div class="form-group">    
                            ...
                            <div class="col-xs-9" >
                                <select id="Exc_Cod" name="Exc_Cod" class="form-control input-xs" required="" onchange="if($(this).val()!=='') $('#container').setData($(this).find('option:selected').data(),'name');">
