...
<HEAD>
    ...
    var buttonExtra=[
        { label: 'G'+$.createIcon('print'), name: 'imp1', width: 20, title:false, formatter:'gridButton', formatoptions:{action:'imprimirLiquida(null,$(this).data(\'originaldata\'))',data:function(o){ return {Lib_Cod:o.Lib_Cod,Lib_Mag:o.Lib_Mag}; },icon:'print',type:'info',title:'Imprimir Liquidacion Gerencial', conditional:function(o){ return o.Lib_Est!=='I'; }} },
        { label: '1'+$.createIcon('print'), name: 'imp1', width: 20, title:false, formatter:'gridButton', formatoptions:{action:'imprimirLiquida(true,$(this).data(\'originaldata\'))',data:function(o){ return {Lib_Cod:o.Lib_Cod,Lib_Mag:o.Lib_Mag}; },icon:'print',type:'info',title:'Imprimir Liquidacion No. 1', conditional:function(o){ return o.Lib_Est!=='I'; }} },
        { label: '2'+$.createIcon('print'), name: 'imp2', width: 20, title:false, formatter:'gridButton', formatoptions:{action:'imprimirLiquida(false,$(this).data(\'originaldata\'))',data:function(o){ return {Lib_Cod:o.Lib_Cod,Lib_Mag:o.Lib_Mag}; },icon:'print',type:'info',title:'Imprimir Liquidacion No. 2', conditional:function(o){ return o.Lib_Est!=='I'&&o.Lib_Mag==='S'; }}  }
    ];
...
<BODY>
    <div class="panel panel-main">
        <div class="panel-heading exa-header"><h3 class="panel-title">&raquo;  Consultar Liquidacion de Compra de Fruta</h3></div>
    ...
    function imprimirLiquida(legal, data){
        $.imprimirUrl("<?php echo $linkLiqui; ?>"+data['Lib_Cod']+(data['Lib_Mag']==='S'?"":"&gerencial=")+(legal===null?"&gerencial=":(legal?"":"&detallado=")));
    }
    </script>
