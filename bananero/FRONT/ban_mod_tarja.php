...
if(isset($getDetalle)){ 
    ...
    if($resp['success']){
        ...
        $resp['containers']=$obBD_con1->getArrayConsulta('exportacion_container.selectWhere', array('setWhere'=>'setEmpCod','where'=>array('Exc_Sem'=>$resp['dato']['Prt_Sem'],'Exc_Ano'=>$resp['dato']['Prt_Ano'])) , $obBD_conexion); 
...
<HEAD>		
    ...
    <script type="text/javascript">        
        var buttonExtra={ label: $.createIcon('pencil'), name: 'imp1', width: 25, formatter:'gridButton', formatoptions:{action:'editarTarja',data:'Prt_Cod',title:'Editar Tarja', conditional:function(o){ return o.Prt_Est!=='I'&&o.Lib_Cod===null; }/*, caseFalse: $.createIcon('remove red')*/ } , classes:'bgNoColor' };
...
<BODY>
    <div class="panel panel-main">
        <div class="panel-heading exa-header"><h3 class="panel-title">&raquo;  Modificar Tarja</h3></div>
                ...
                <div class="col-sm-3">
                    ...
                    <fieldset class="exa-fieldset" id="container">
                        ...
                        <div class="form-group">    
                            ...
                            <div class="col-xs-9" >
                                <select id="Exc_Cod" name="Exc_Cod" class="form-control input-xs datatrigger" required="" onchange="if($(this).val()!=='') $('#container').setData($(this).find('option:selected').data(),'name');">
                        ...
                        <div class="form-group">    
                            ...
                            <div class="col-xs-9" ><span data-name="Exc_Vap" class="form-control input-xs datatitle" ></span></div>
                        </div> 
                        <div class="form-group">
                            <label class="col-xs-3 control-label label-xs">Puerto:</label>  
                            <div class="col-xs-9" ><span data-name="Exc_Pto" class="form-control input-xs datatitle" ></span></div>
                        </div> 
                        <div class="form-group">    
                            <label class="col-xs-3 control-label label-xs">Zona:</label> 
                            <div class="col-xs-9" ><span data-name="Exc_Zon" class="form-control input-xs datatitle" ></span></div>
                        </div> 
