                ...
                <div id="editarDato" class="row" style="visibility: hidden;">
                    <div class="col-sm-6">
                        ...
                        <fieldset class="exa-fieldset" id="provFormTemp">
                            ...
                            <div class="form-group">
                                <label class="col-xs-4 control-label label-xs">C�digo Aux.:</label>
                                <div class="col-xs-6" >
                        ...
                        <fieldset class="exa-fieldset">
                            ...
                            <div>
                                 <button type="button" class="btn btn-sm btn-inverse" onclick="$('#editarDato').moveComp('#lista').updateGridsSizes();"><i class="glyphicon glyphicon-arrow-left"></i> Atr�s</button>
