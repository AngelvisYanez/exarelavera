...
<HEAD>
    ...
    <script type="text/javascript">
        var buttonExtra={ label: $.createIcon('trash'), name: 'imp1', width: 25, formatter:'gridButton', formatoptions:{action:'validaEliminacion',data:'Prt_Cod',icon:'trash',type:'danger',title:'Eliminar Tarja', conditional:function(o){ return o.Prt_Est!=='I'&&o.Lib_Cod===null; }/*, caseFalse: $.createIcon('remove red')*/ } , classes:'bgNoColor' };
    </script>
...
<BODY>
    <div class="panel panel-main">
        <div class="panel-heading exa-header"><h3 class="panel-title">&raquo;  Anular Tarja</h3></div>
