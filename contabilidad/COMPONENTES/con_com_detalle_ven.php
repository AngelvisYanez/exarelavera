...
*/
$rs_detalle = $obBD_con1->getArrayConsulta(381, $vet_codigo, $obBD_conexion);
$rs_usuVendedor = $obBD_con1->getRowConsulta(382, $vet_codigo, $obBD_conexion);
?>
<FIELDSET>
<legend>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="LetraNegra">
  <tr>
    <td colspan="4">
	  ...
	  */
	 $rs_pago_fac = $obBD_con1->getArrayConsulta(383, $vet_codigo, $obBD_conexion);
	 $For_Des=$Vet_Che=$Pag_Des=$Vet_Tot=$Vet_Cue=$Ban_Cod=$Bak_Cod=$Pag_Cod="";
         if (count($rs_pago_fac)>0){
    ...
    <tr>
	  ...
	  <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
		  ...
		  */
		  $row_rs_bancos = $obBD_con1->getRowConsulta(384, $Ban_Cod, $obBD_conexion);
			...
			else
	        {
				...
				*/ 
				$row_rs_banco = $obBD_con1->getRowConsulta(385, $Bak_Cod, $obBD_conexion);
        ...
        <tr>
          ...
          <td width="24%" class="LetraNegra">
           &nbsp;<?php echo formato_numero(!empty($Vet_Tot)?$Vet_Tot:0,2,2); ?>          
           </td>
        </tr>
		</table>	  		
        </td>
    ...
    <tr>
	  ...
	  <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
		  ...
		  * Bancos correspondientes al plan de cuentas 
		  */
		  $row_rs_bancos = $obBD_con1->getRowConsulta(384, $Ban_Cod2, $obBD_conexion);
			...
			else
	        {
				...
				* Cargar el banco de otros bancos 
				*/ 
				$row_rs_banco = $obBD_con1->getRowConsulta(385, $Bak_Cod2, $obBD_conexion);
				echo $row_rs_banco['Bak_Des'];
...
$rs_Info = $obBD_con1->getRowConsulta(386,$vet_codigo,$obBD_conexion);
$total_Info=$rs_Info['Vet_Cod'] > 0? 1 : 0;
if($total_Info!=0)	  
{	
	$rs_detalleVet = $obBD_con1->getArrayConsulta(387,$vet_codigo,$obBD_conexion);	
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
       <thead> 
         ...
         <?php foreach($rs_detalle as $row_rs_detalle){
			 ...
			 {
				 $rs_impuesto = $obBD_con1->getRowConsulta(388, $row_rs_detalle['Ren_Cod'],$obBD_conexion);	
		 ...
		 ?>
          ...
          <?php } 
			 ...
			 {
				 $rs_impuesto = $obBD_con1->getRowConsulta(388, $row_rs_detalle['Ren_Iva'],$obBD_conexion);	
		  ?>
             <tr height="20">
                <td align="center"><?Php echo $rs_impuesto['Ren_Sri']; ?></td>
