...
?>
	<FIELDSET>
		...
		*/
											$total = $total + round($row['Asi_Val2'], 2);
										} else {
											echo '&nbsp';
										} ?></td>
			...
			en el reporte compr se usan 3 decimales */
											$total_h = $total_h + round($row['Asi_Val2'], 2);
										} else {
											echo '&nbsp';
										} ?></td>
				</tr>
...
<?php
	...
	echo error_alerta("<< Error de componente: con_con_detalle_compr.php >> <br>Descripci�n: No se ha definido la Propiedad: com_codigo<br>
        com_codigo: Variable que contiene el c�digo del comprobante para mostrar el detalle", 2);
