  ...
  ciudad.Ciu_Cod = $Par_Sql[0]";
		...
		*/
		...
		case 201:
			...
			// 			(select Che_Num from cheques where if(asientos.Asi_Deh='D' 
			// 			AND Tia_Abr='EG',asientos.Asi_Cod-1,asientos.Asi_Cod) = cheques.Asi_Cod) as Che_Num, 
			...
			// 			Prv_Cod,
			// 			Com_Gen
			// 			FROM asientos, comprobantes, det_plan, tipo_asien
			...
			//AND det_plan.Pld_Est = 'A' GROUP BY comprobantes.Com_Cod, Com_Num, Tia_Ini, Com_Fec, comprobantes.Com_Con, asientos.Asi_Deh, det_plan.Pld_Des, Pld_Cdc, Pld_Rec, comprobantes.Com_Val
			//echo $sql.'<br>';
			// //ChromePhp::log("Consulta201: ",$sql);
			return $sql;
			break;
	...
	"; //AND Asi_Deh = '$Par_Sql[1]' $Par_Sql[2]
		...
		case 341:
			...
			*/
			...
			// 			AND comprobantes.Pec_Cod = $Par_Sql[4] $Par_Sql[5] $Par_Sql[3]"; //AND det_plan.Pld_Est = 'A' GROUP BY comprobantes.Com_Cod, Com_Num, Tia_Ini, Com_Fec, comprobantes.Com_Con, 						asientos.Asi_Deh, det_plan.Pld_Des, Pld_Cdc, Pld_Rec, comprobantes.Com_Val
			$sql = "SELECT comprobantes.Com_Cod, Com_Num, Tia_Ini, Tia_Abr, Com_Fec, asientos.Asi_Cod, comprobantes.Com_Con, 
					asientos.Asi_Deh, (asientos.Asi_Val) AS Asi_Val, det_plan.Pld_Des, Pld_Cdc, Pld_Rec, comprobantes.Com_Val, comprobantes.Cli_Cod, comprobantes.Prv_Cod, Com_Gen, pago_venta.Vet_Che ,Che_Num, tipos_pago.Pag_Des,
                    ...
                    WHERE (comprobantes.Com_Fec BETWEEN '$Par_Sql[0]' AND '$Par_Sql[1]') AND det_plan.Pld_Cod = '$Par_Sql[2]' AND comprobantes.Com_Est = 'A'
						AND comprobantes.Pec_Cod = $Par_Sql[4] $Par_Sql[5] $Par_Sql[3]";
			//echo $sql.'<br>';
			return $sql;
			break;
	}
