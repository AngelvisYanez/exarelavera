...
if (isset($modifyAut)) {
    ...
    if ($obBD_con1->fin_transaccion_nomsn($obBD_conexion->conexion)) {
        $responce['success'] = true;
        $response['fila'] = $obBD_con1->getRowConsulta(514, $Aut_Cod, $obBD_conexion);
...
/*
     * Get Sucursal by Emp_Cod
     */
$sucursal = $obBD_con1->getArrayConsulta(507, $Ses_Emp_Cod, $obBD_conexion);
                            ...
                            <form id="frm_alt_auto" name="frm_alt_auto" class="form-vertical" autocomplete="off">
                                <fieldset class="exa-fieldset">
                                    ...
                                    <div class="col-sm-2 col-sm-offset-1">
                                        ...
                                        <select id="Suc_Cod" name="Suc_Cod" class="form-control col-sm">
                                            <option value="0">Seleccionar ... </option>
                                            <?php
                                            foreach ($sucursal as $s) {
                                                echo "<option value='{$s['Suc_Cod']}'>{$s['Suc_Des']}</option>";
                                            }
                                            ?>
                                        </select>
                                    </div>
    ...
    <div id="editDialog" title="">
        <form id="formDialog" name="formDialog" class="form-horizontal" autocomplete="off">
            <fieldset>
                ...
                <!-- Autorizacion SRI-->
                <div class="form-group">
                    <label class="col-md-4 control-label label-xs required" for="Aut_Sri">No Autorización:</label>
                    <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input id="Aut_Fin" name="Aut_Fin" type="text" placeholder="" class="form-control input-xs" onkeypress="return validar_numeric(event)">
                    </div>
                </div>

                <!-- Numero de Items maximo-->
                <div class="form-group">
                    <label class="col-md-4 control-label label-xs required" for="Aut_Ima">N�mero de Items:</label>
                    <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input id="Aut_Adv" name="Aut_Adv" type="text" placeholder="Dias de anterioridad en las cuales ser� informada la caducidad" class="form-control input-xs" onkeypress="return validar_numeric(event)">
                    </div>
                </div>
