...
<BODY>
    ...
    <div class="panel panel-main">
        <div class="panel-heading exa-header"><h3 class="panel-title">&raquo;  Gesti�n de Centros de Consumo</h3></div>
                ...
                <div class="row">
                    <div class="col-sm-12">  
                        ...
                        <fieldset class="exa-fieldset">                           
                           <legend class="Titulos2">B�squeda de Centros de Consumo</legend> <!-- Form Name -->
            ...
            <div class="form-horizontal normal col-md-12" >
                <fieldset>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label class="col-sm-4 control-label">Acci�n:</label>
                        <div class="col-sm-8">
   ...
   <script type="text/javascript">
    ...
    gridComp.jqGrid({
            ...
            colModel: [
                { label: 'C�d.Int.', name: 'Con_Cod', key: true, width: 25,align:"center" },
                { label: 'Descripci�n', name: 'Con_Des', width: 250,editable:true},
                    ...
                    { label:'&nbsp;', name: 'act1', width: 35, align: 'center',viewable: false,title: false,
                        formatter:function (cellvalue, options, rowObject) { var action='';
                            if(rowObject['Con_Est']==='Activo')
                                action='<span class="btn btn-danger btn-xs" title="Anular" type="button" onclick="$.createDialogConfirm(\'Est� seguro que desea anular este Centro de Consumo?\','+rowObject.Con_Cod+',borraConsumo)"><i class="fa fa-ban"></i></span>';
                            else
                                action='<span class="btn btn-info btn-xs" title="Activar" type="button" onclick="$.createDialogConfirm(\'Est� seguro que desea activar este Centro de Consumo?\','+rowObject.Con_Cod+',activaConsumo)"><i class="fa fa-check"></i></span>';
