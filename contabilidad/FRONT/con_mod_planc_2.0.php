      				...
      				<? foreach($row_rs_planes as $row){
						...
						?>
					      <tr>
					        	...
					        	<td align="center">
					        		<button type="button" class="btn btn-primary btn-mini" title="Editar" onclick="Muestra_Aparecer();$('#plaCodigo').val('<?php echo $row['Pla_Cod']; ?>');$('#des_plan').val('<? echo $row['Pla_Obs']; ?>');"><i class=" icon-edit icon-white"></i></button>
					        	</td>
					        	<td align="center">
				    ...
				    <table width="300" border="0" cellspacing="0" cellpadding="0">
				      <tr>
				        <td width="212">         
				          ...
				          <input name="codpla" type="hidden" id="codpla" value="<? echo $codpla; ?>">
				        </td>
				      </tr>
				    </table>
				   </form> 
