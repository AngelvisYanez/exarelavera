...
if (isset($hdd_save2) or isset($hdd_save3)) {
	...
	if (isset($hdd_save)) {
		...
		/* Carga todos los periodos contables, Activos y Anulados sss*/
	...
	<div id="set1">
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table">
			<tr class="BarraTitulo">
				<td height="10">&raquo; Reporte General <?php echo $periodo; ?> </td>
			</tr>
			<tr>
						...
						?>
									...
									?>
											...
											<table width="274" border="0" cellpadding="0" cellspacing="0">
												<tr>
													...
													<td width="164">
														<button type="button" class="btn btn-success fileinput-button" title="Generar Reporte" name="button" id="button" onClick="validar_balance(this.form, this.form.txt_busqueda)">
										...
										?>
											...
											<table border="0" cellpadding="0" cellspacing="0">
												<tr>
													...
													<td width="154">
														<button type="button" class="btn btn-success fileinput-button" title="Generar Reporte" name="button" id="button" onClick="validar_buscar_cuenta(document.form1, 'grupo')">
															<i class="icon-check icon-white"></i>
															<span>Generar</span>
														</button>
														<input name="cantmodal" id="cantmodal" type="hidden" value="2">
							...
							?>
											...
											?>
												...
												<?php
												break;
											// CASO DE BUSQUEDA POR TOTALES
											case 2:
												if (isset($grupo)) {
													$total_debe_general = 0;
													$total_haber_general = 0;
													$total_saldos_general = 0;
													...
													<div id="Exportar_a_Excel">
														...
														<table width="100%" border="0" cellpadding="0" cellspacing="0" class="fixedHeader03" style="table-layout:fixed;">
															<thead>
																<tr>
																	...
																	<th align="center" width="22%">Detalle</th>
																	<th align="center" width="9%">Saldo Inicial</th>
																...
																if ($total_rs_rango > 0) {
																	foreach ($rs_rango as $row_rango) {
																		...
																		foreach ($rs_cuenta as $row_rs_cuenta) {
																			...
																			?>
																			<tr>
																				<td align="center"><?php echo $globalCounter ?></td>
																				<td align="center"><?php echo $row_rs_cuenta['Com_Cod']; ?></td>
																				<td align="center"><?php echo $row_rs_cuenta['Pld_Cdc']; ?></td>
																				<td align="center"><?php echo $row_rs_cuenta['Pld_Des']; ?></td>
																				...
																				<td align="right"><?php echo formato_numero($saldos, 2, 2); ?></td>
																				<td align="right"><?php
																					if ($row_rs_cuenta['Asi_Deh'] == 'D') {
																						echo formato_numero($row_rs_cuenta['Asi_Val'], 2, 2);
																						$total_debe += $row_rs_cuenta['Asi_Val'];
																					} else {
																						echo "0.00";
																					}
																				?></td>
																				<td align="right"><?php
																					if ($row_rs_cuenta['Asi_Deh'] == 'H') {
																						echo formato_numero($row_rs_cuenta['Asi_Val'], 2, 2);
																						$total_haber += $row_rs_cuenta['Asi_Val'];
																					} else {
																						echo "0.00";
																					}
																				?></td>
																				<td align="right"><?php
																					if ($tipo_grupo[0] == 2 || $tipo_grupo[0] == 3 || $tipo_grupo[0] == 4) {
																						$saldos += ($row_rs_cuenta['Asi_Val'] * ($row_rs_cuenta['Asi_Deh'] == 'H' ? 1 : -1));
																					} else {
																						$saldos += ($row_rs_cuenta['Asi_Val'] * ($row_rs_cuenta['Asi_Deh'] == 'D' ? 1 : -1));
																					}
																					echo formato_numero($saldos, 2, 2);
																				?></td>
																				<td align="center"><button type="button" class="btn btn-info btn-mini" title="Ver detalle" onclick="Muestra_Aparecer(); ajax_datos('<?php echo $_SERVER['php_SELF']; ?>?ajax_detalle=1&ajax_codigo=<?php echo $row_rs_cuenta['Com_Cod']; ?>', 'ajax_modal')">
																						<i class="icon-info-sign icon-white"></i>
																					</button></td>
																			</tr>
																			<?php
															...
															<tfoot>
																<tr>
																	...
																	<td align="right"><?php echo formato_numero($total_debe_general, 2, 2); ?></td>
																	<td align="right"><?php echo formato_numero($total_haber_general, 2, 2); ?></td>
																	<td align="right"><?php echo formato_numero($total_saldos_general, 2, 2); ?></td>
																	<td>&nbsp;</td>
																</tr>
															</tfoot>
														</table>
														<?php
														/* Muestra la barra de estados con la cantidad de registros encontrados  */
														echo barra_estado($globalCounter) . "<br>";
														?>
													</div>
													<?php
												}
													...
													<table width="220" border="0" cellpadding="0" cellspacing="0">
														<tr>
															<td width="110" scope="col">
																<form action="con_pri_reporte_cuenta.php" method="post" name="form2" id="form2" target="_blank">
																	<button type="button" class="btn btn-primary start" title="Imprimir Reporte" onclick="this.form.submit()"> <i class="icon-print icon-white"></i> <span>Imprimir</span> </button>
																	<input name="op" type="hidden" id="op" value="<?php echo $op; ?>">
																	<input name="Pec_Cod" type="hidden" id="Pec_Cod" value="<?php echo $Pec_Cod; ?>">
