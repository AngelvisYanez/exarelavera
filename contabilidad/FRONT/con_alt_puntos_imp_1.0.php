...
<?php 
/** 
* Descripci�n: Permite el ingreso de los puntos de impresi�n
...
{
	/**
	* Consulta datos de los puntos de impresi�n 
	*/
	...
	{ ?>
		<input name="Pun_Des" type="text" id="Pun_Des" size="30" maxlength="30" onblur="if (trim(this.value) != '')ajax_datos('<?Php echo $_SERVER['PHP_SELF']; ?>?ajax_emb=1&Pun_Des=' + this.value,'div_emb')" />&nbsp;<img src="../../mascaras/model1/imagenes/32x32/gtk-no.gif" width="22" height="22" />	�Punto de impresi�n <?php echo "<font style='text-transform:uppercase'>".$Pun_Des."</font>"; ?> ya existe!        
<?Php	}
exit();
}
...
<?Php echo mensaje_requerido(); ?>
 <table width="100%" cellpadding="0" cellspacing="0" border="0">
		...
		*/
    	...
    	<tr>
    	  <td width="16%" class="Etiqueta1"><span class="Asterisco">*</span> Descripci�n:</td>
