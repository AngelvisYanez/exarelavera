...
$sucursal_para_cabecera = (isset($_POST['cmb_sucursal']) && $_POST['cmb_sucursal'] != '') ? $_POST['cmb_sucursal'] : $Ses_Suc_Cod;
$row_institucion = $obBD_con1->getRowConsulta(126, $sucursal_para_cabecera, $obBD_conexion);
					...
					<td height="389" valign="top">
						<form name="form1" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
							...
							<table width="100%" border="0">
								<tr>
									<td width="40%"><?php include("../COMPONENTES/con_con_anio_mes_fecha.php"); ?></td>
									<td width="30%">
										<FIELDSET>
											<LEGEND><label class="Etiqueta1">Seleccionar Sucursal</label></LEGEND>
											<table width="100%" border="0">
												<tr>
						...
						<LEGEND><label class="Etiqueta1">Resultados de la búsqueda</label></LEGEND>
							<div id="Exportar" class="report-container">
								...
								<div class="report-table-wrapper">
											...
											$obBD_con1->cargarNodosComprobacion($Pla_Cod,0, $txt_fec_ini, $txt_fec_fin, $obBD_conexion, 3, $arreglo[0], 0, $utilidad, 0, $Max_Niv, 2, $cmb_sucursal); 
											?>
								</div>
							</div>
						</FIELDSET>
						...
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td width="100">
									<form action="con_pri_balcompr.php" method="post" name= "form2" id="form2" target="_blank">
