...
<?php
/**
* Descripcion: Permite imprimir el balance general
* Fecha de actualizacion:	2012-10-06
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr class="LetraNegra">
                <td colspan="4">
                  ...
                  $obBD_con1->cargarNodosBalance($Pla_Cod,0, $txt_fec_ini, $txt_fec_fin, $obBD_conexion, 1, $Pec_Cod, 0, $utilidad, 0, $Max_Niv, 2, $cmb_sucursal); 		
                  ?>
                </td>
              </tr>
              <tr class="LetraNegra">
