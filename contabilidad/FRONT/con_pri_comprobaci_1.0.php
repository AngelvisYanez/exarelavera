...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr class="LetraNegra">
	...
	*/
	$obBD_con1->cargarNodosComprobacion($Pla_Cod,0, $txt_fec_ini, $txt_fec_fin, $obBD_conexion, 3, $Pec_Cod, 0, $utilidad, 0, $Max_Niv, 2); 
	?></td>
  </tr>
  ...
  <tr class="LetraNegra">
    <td colspan="4"><table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="Texto_Reporte">
      ...
      <tr>
        <td height="9" align="left" valign="top">REPRESENTANTE LEGAL
          <p></p>
