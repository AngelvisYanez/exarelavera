...
if(isset($activarComp)){
    $data=$_POST;
    $obBD_con1->inicio_transaccion($obBD_conexion);                  
    //Cambiar Estado a Comprobante
    $obBD_con1->operacionobBD(28,$data,$obBD_conexion);
...
if(isset($loadData)){ 
    ...
    $responce['compro']=$obBD_con1->getRowConsulta(3, $data, $obBD_conexion,true);
    $responce['compro']['detalle']=$obBD_con1->getArrayConsulta(4, $data, $obBD_conexion,true);
...
<HTML>
    <HEAD>		
        ...
        <TITLE><?Php echo "Comprobantes Activar [EXA]"; ?></TITLE>
        <meta charset= "UTF-8">
        ...
        <script type="text/javascript">var alta=true, noEdit=false, editing=false, listsearch, compNoEdit, docuView, dataSend=new Array(), pec_min='<?php echo (!empty($perio['menor'])?substr($perio['menor'], 0, 4):'2015'); ?>', pec_max='<?php echo (!empty($perio['mayor'])?substr($perio['mayor'], 0, 4):substr($hoy, 0, 4)); ?>'; </script>   
        <script type="text/javascript" src="../VALIDACIONES/con_val_compr_2.js?x=d"></script>
        <style>                    
    ...
    <BODY>
        <div class="panel panel-main">
            <div class="panel-heading exa-header"><h3 class="panel-title">&raquo;  Activar Comprobantes</h3></div>
            ...
            <div id="main-panel">
               ...
               <div id="tabsSearch" class="ui-tab-fix ui-tabs">
                       ...
                       <div class="row">                                  
                            ...
                            <div class="col-xs-6">
                                ...
                                <div id='asien' class='filtros'>
                                    ...
                                    <div class="form-group">
                                        <label class="col-xs-4 control-label label-xs">Tipo:</label> 
                                        <div class="col-xs-3">
                ...
                <div style="min-height: 350px;">
                    ...
                    <div class="Titulos2"><span id="plan-footer"><strong>Leyenda:</strong> <span class="glyphicon glyphicon-ok green"></span> Activos | <span class="glyphicon glyphicon-lock yellow"></span>Generados Automaticamente</div>
                </div>    
            </div>        
            <div id="edit-panel" style="display: none;">                
                        <form id="formAsien" class="form-horizontal normal"  action="javascript:activarComp();"   >
                        <input name="Com_Cod" id="Com_Cod" type="hidden" value="" />
                        <input name="comp" type="hidden" value="" />
                       <div class="row">       
                           <div class="col-xs-3 no_doc_panel" style="display: none"></div>
                            <div id="asientoAutomatico" class="col-xs-6">
                                <fieldset class="exa-fieldset">
                                    <legend class="Titulos2">Datos del Comprobante de Egreso:</legend>
                                    <!-- static input-->
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-sm-8">                                           
                                          <select class="form-control input-xs readOnly" name="Tia_Cod" data-compr="Tia_Cod" id="Com_Tia_Cod" required="" readonly="" disabled="">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-xs-3">                                    
                                           <input type="text"  class="form-control input-xs readOnly" name="Com_Fec" data-compr="Com_Fec" id="Com_Com_Fec" value="" disabled=""  />
                                       </div>                                        
                                       <label class="col-xs-2 control-label label-xs ">No. Com.:</label>  
                                       <div class="col-xs-3">                                    
                                          <div class="input-group input-group-xs">
                                            <span class="input-group-addon" > # </span>
                                            <input class="form-control input-xs readOnly" name="Com_Num" data-compr="Com_Num" type="text" style="text-align:right" onkeypress="return  validar_decimal(event)" readonly="" disabled=""/>
                                          </div>                               
                                       </div> 
                                     </div>  
                                    <!-- static input-->
                                    <div class="form-group">
                                      ...
                                      <div class="col-sm-8"> 
                                          <textarea name="Com_Con" data-compr="Com_Con" id="Com_Com_Con" class="form-control input-xs readOnly" disabled="" style="textarea { resize:vertical ; }"></textarea>
                                      </div>                                  
                                    </div> 
                                    <!-- static input-->
                                    <div class="form-group">
                                      ...
                                      <div class="col-sm-8"> 
                                          <textarea name="Com_Obs" data-compr="Com_Obs" id="Com_Com_Obs" class="form-control input-xs readOnly" disabled="" style="textarea { resize:vertical ; }"></textarea>
                                      </div>                                  
                                    </div> 
                                </fieldset>
                            </div>
                            ...
                            <div id="doc_panel" class="col-xs-6 doc_panel">
                                <fieldset class="exa-fieldset">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-sm-8"> 
                                          <input data-compra="Tic_Des" data-venta="Tic_Des" type="text"  class="form-control input-xs readOnly" readonly=""></span>   
                                      </div>                                  
                                    </div> 
                                    <!-- static input-->
                                    <div class="form-group">
                                      ...
                                      <div class="col-sm-8"> 
                                          <input data-compra="Tri_Des" data-venta="Tri_Des" type="text"  class="form-control input-xs readOnly" readonly="">
                                      </div>                                  
                                    </div> 
                                    <!-- static input-->
                                    <div class="form-group">
                                      ...
                                      <div class="col-sm-4"> 
                                          <input data-compra="Prs_Ced" data-venta="Prs_Ced" type="text"  class="form-control input-xs readOnly" readonly="">
                                      </div>  
                                      <label class="col-xs-1 control-label label-xs ">Pago:</label> 
                                       <div class="col-xs-3">                                    
                                           <input data-compra="Tpc_Des" data-venta="Tpc_Des" type="text"  class="form-control input-xs readOnly" name="Tcp_Des" readonly="">
                                       </div> 
                                    </div> 
                                    <!-- static input-->
                                    <div class="form-group">
                                      ...
                                      <div class="col-sm-8"> 
                                          <input data-compra="Persona" data-venta="Persona" type="text"  class="form-control input-xs readOnly" readonly=""> 
                                      </div>                                  
                                    </div> 
                                     <!-- static input-->
                                    <div class="form-group">
                                       ...
                                       <div class="col-xs-4">  
                                            <input class="form-control input-xs readOnly" name="Doc_Num" id="Doc_Doc_Num"  type="text" readonly="" />
                                       </div> 
                                        <label class="col-xs-1 control-label label-xs ">Fecha:</label> 
                                       <div class="col-xs-3">                                    
                                           <input type="text"  class="form-control input-xs readOnly" name="Doc_Fec" data-compra="Cop_Fec"  data-venta="Caj_Fec" readonly="" />
                                       </div>        
                                     </div> 
                                     <!-- static input-->
                                    <div class="form-group">
                                      <label class="col-sm-3 control-label label-xs ">Observación:</label>  
                                      <div class="col-sm-8"> 
                                          <textarea  data-compra="Cop_Obs" data-venta="Vet_Obs" name="Doc_Obs" class="form-control input-xs readOnly" style="textarea { resize:vertical ; }"></textarea>
                                      </div>                                  
                                    </div> 
                                </fieldset>
                            </div>
                       ...
                       <div class="row">  
                           <div class="col-xs-3 no_doc_panel" style="display: none"></div>
                            <div class="col-xs-6">
                                <div>
                                    <table id="compNoEdit" class="readOnly"></table><div id="compNoEditPager"></div>
                                </div>                                    
                            </div>                           
                            <div class="col-xs-6 doc_panel">
                                <table id="docuView"></table><div id="docuViewPager"></div>
                            </div>
                       </div>   
                <div class="row"><div class="col-xs-3 no_doc_panel" style="display: none"></div><div class="col-xs-6" style="padding-top:10px;">
                    ...
                    <button  onclick="$('#formAsien').formSubmit();" id="btnAlta" class="btn btn-info btn-sm " title="Activar" ><i class="glyphicon glyphicon-ok"></i><span> Activar </span></button>
                </div></div>
        ...
        <script>
            ...
            function selectProv(prov){ $("#proveedor").setData(prov); $("#provDialog").dialog("close"); $('#formCops').formSubmit(); }        
            function selectClie(clie){ $("#cliente").setData(clie);; $("#cliDialog").dialog("close"); $('#formVets').formSubmit(); }   
        </script>
