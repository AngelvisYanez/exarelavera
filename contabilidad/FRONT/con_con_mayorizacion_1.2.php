														...
														<FIELDSET>
															...
															<table border="0" cellpadding="0" cellspacing="0">
																<tr>
																	...
																	<td width="215" valign="middle"><input name="txt_busqueda" type="text" id="txt_busqueda" value="<?Php echo $txt_busqueda; ?>" size="30" maxlength="50" onBlur="validar_cuentas(form1, this)" onKeyUp="parametro_injection(this)"></td>
																</tr>
															</table>
														</FIELDSET>
													</td>
							...
							?>
										...
										<div id="Exportar_a_Excel">
											...
											<table width="100%" border="1" cellpadding="0" cellspacing="0" class="fixedHeader03">
												<thead>
													<tr>
														<th align="center" width="4%">C&oacute;d. Int.</th>
														<th align="center" width="9%">Generaci&oacute;n</th>
														<th align="center" width="6%">No. Com.</th>
														<th align="center" width="9%">Fecha</th>
														<th align="center" width="28%" style="display:none">Cliente/Proveedor</th>
														<th align="center" width="19%">Detalle</th>
