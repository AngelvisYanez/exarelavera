...
?>
	<FIELDSET>
		<LEGEND><label class="Titulos2">Resultados de la busqueda</label></LEGEND>
        <table width="100%" border="1" cellpadding="0" cellspacing="0" class="fixedHeader01">
            ...
            <tbody>
                ...
                if($total_rs_buscar != 0) {
                    ...
                    <?php }//Fin del foreach
				} else {//Fin del if($total_rs_buscar != 0)
                    ?>
                    <tr>
                        <td width="10%">&nbsp;</td>
...
if (isset($ajax_buscador)) {
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" id="buscador">
        ...
        <td>
            <FIELDSET>
                <LEGEND><label class="Titulos2">B&uacute;squeda de Cuentas </label></LEGEND>
                <table width="444" border="0" cellpadding="0" cellspacing="0" >
                    <tr>
                        <td width="217">
                            <input name="op_opciones" id="op_opciones" type="radio" value="d" checked="checked" onClick="document.getElementById('op_op').value = this.value; setfocus(document.getElementById('buscta'))">
                            <span class="LetraNegra">Descripci&oacute;n</span>
                        </td>
                        <td width="227">
                            <input type="radio" name="op_opciones" id="op_opciones" value="c" onClick="document.getElementById('op_op').value = this.value; setfocus(document.getElementById('buscta'))">
                    ...
                    <tr>
                        ...
                        <td width="139" align="center">
                            <button type="button" class="btn btn-success fileinput-button" title="Buscar" onClick="ajax_datos('<?php echo $_SERVER['PHP_SELF']; ?>?buscod=' + document.getElementById('buscta').value + '&op=<?php echo $op; ?>&op_op=' + document.getElementById('op_op').value + '&name_input=' + document.getElementById('name_input').value + '&Pec_Cod=' + document.getElementById('Pec_Cod').value+'&Pla_Cod=<?php echo $Pla_Cod; ?>', 'busqueda')">
                                <i class="icon-search icon-white"></i><span>Buscar</span>
                            </button>
                        </td>
                    </tr>
                    </tbody>
...
} else {//Fin del if (isset($hdd_save))
	if (isset($hdd_save)) {
	...
	<HEAD>
        ...
        <script>
            $(function() { 
                /* Campo 1 */
                $( "#Com_Fec" ).datepicker();
                $( "#Com_Fec" ).change(function() { $( "#Com_Fec" ).datepicker( "option", "dateFormat", "yy-mm-dd" ); });
            });
        </script>
                                ...
                                <table width="304" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td width="120" align="center">
                                            <button type="button" class="btn btn-success fileinput-button" title="Buscar" onclick="validar_requeridos(this.form, 'Pec_Cod2', 0)">
                                                <i class="icon-search icon-white"></i> <span>Aceptar</span>
                                            </button>
                            ...
                            case 1: 
                                ...
                                <table width="99%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <FIELDSET>
                                            <LEGEND><label class="Etiqueta1">Buscar por cuenta:</label></LEGEND>
                                                <table border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td width="63" height="28" class="Etiqueta1"><span class="Asterisco">* </span>Cuenta:&nbsp;</td>
                                                        <td width="215" valign="middle">
                                                            <select name="bancos" id="bancos" onchange="$('#txt_busqueda').val($('#bancos').val());" style="width: 395px;">
                                                            ...
                                                            <input name="txt_busqueda" type="hidden" id="txt_busqueda" value="<?php echo $txt_busqueda; ?>" size="30" maxlength="50" onBlur="validar_cuentas(form1, this)" onKeyUp="parametro_injection(this)">
                                                        </td>
                                                    </tr>
                                                </table>
                                            </FIELDSET>
                                ...
                                <table width="274" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="0">
                                            ...
                                            <i class="icon-list-alt icon-white"></i> <span>Cuenta</span>
                                            </button>    
                                        </td>
                                        <td width="164">
                                            <button type="button" class="btn btn-success fileinput-button" title="Mayorizar" name="button" id="button" onClick="validar_balance(this.form, this.form.txt_busqueda)">
                                                <i class="icon-check icon-white"></i> <span>Mayorizar</span>
                                            </button>
                                                    ...
                                                    foreach($rs_cuenta as $row) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            */
                                                            ...
                                                            <td align="right" <?php if ($saldos<0){ echo "style='color:#FF0000'"; } ?>><?php echo formato_numero($saldos, 2, 2); ?></td>
                                                            <td align="center">
                                                                <button type="button" name="button<?php echo $i+1; ?>" id="button<?php echo $i+1; ?>" class="btn btn-info btn-mini" title="Ver detalle" onclick="Muestra_Aparecer(); ajax_datos('<?php echo $_SERVER['PHP_SELF']; ?>?ajax_detalle=1&ajax_codigo=<?php echo $row['Com_Cod']; ?>', 'ajax_modal')">
                            ...
                            <tr>
                                <td width="110" scope="col">
                                    <form action="con_pri_mayorizacion_1.1.php" method="post" name= "form2" id="form2" target="_blank">
                                        <button type="button" class="btn btn-primary start" title="Imprimir Mayor" onclick="this.form.submit()">
