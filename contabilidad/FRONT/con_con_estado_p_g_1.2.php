...
<HTML>
	<HEAD>
		...
		/* Header moderno */
		.balance-header {
			background: linear-gradient(135deg, #254463 0%, #1d354d 100%);
			color: #ffffff;
			padding: 12px 15px;
			border-radius: 0;
			margin: 0;
		...
		.balance-form-section > div:nth-child(3) {
			min-width: 0;
			max-width: 100%;
		}
		...
		.balance-form-section > div:nth-child(2) {
			width: 100%;
			max-width: 100%;
		}
		...
		.balance-fieldset input[type="radio"] {
			margin-right: 3px;
		}
		
		.balance-fieldset label[for="cta1"],
		.balance-fieldset label[for="cta2"] {
			margin-right: 8px;
		}
		...
		.balance-form-section > div:nth-child(3) table td {
			padding: 0 8px !important;
			width: auto;
		}
		
		.balance-form-section > div:nth-child(3) table td:first-child {
			width: auto;
			padding-right: 10px !important;
			padding-left: 5px !important;
		}
		
		.balance-form-section > div:nth-child(3) table td:nth-child(2) {
			width: auto;
			padding-right: 10px !important;
			padding-left: 5px !important;
		}
		
		.balance-form-section > div:nth-child(3) table td:last-child {
			width: auto;
		...
		.balance-form-section > div:nth-child(3) table {
			width: auto;
		}
		...
		.balance-table-container table#Exportar_a_Excel {
			width: 100% !important;
			max-width: 100% !important;
		}
		...
		table.balance-table#Exportar_a_Excel {
			width: 100% !important;
			max-width: 100% !important;
		}
		...
		.balance-table td:not(:first-child):not(:nth-child(2)):not(:last-child) {
			text-align: left;
		}
		...
		.balance-total-row td:last-child {
		...
		.balance-table-container table.LetraNegra h3 {
			font-weight: 400;
		}
		...
		.balance-table-container table td {
			text-align: left;
		}
		
		.balance-table-container table td[align="right"] {
			text-align: left !important;
		}
		
		/* Asegurar que todas las celdas con valores numéricos estén a la derecha */
		.balance-table-container table.LetraNegra td:last-child {
			text-align: left !important;
		}
		
		.balance-table-container table.LetraNegra td[align="right"] {
			text-align: left !important;
		}
		
		/* Estilos específicos para la tabla generada por cargarNodosBalance */
		.balance-table-container table.LetraNegra {
			font-size: 13px;
		}
				...
				<form name="form1" method="post" action="<?php  echo $_SERVER['PHP_SELF']; ?>">
					...
					<FIELDSET class="balance-fieldset">  
						...
						<div class="balance-table-container">
							<table width="100%" border="0" cellspacing="0" cellpadding="0" id="Exportar_a_Excel" class="balance-table">
								<tr class="LetraNegra">
									...
									$obBD_con1->cargarNodosBalance($Pla_Cod,0, $txt_fec_ini, $txt_fec_fin, $obBD_conexion, 2, $arreglo[0], 0, 0, 0, $Max_Niv, 2, $ctaUtilidad, $Pec_Cod2_completo, $Pec_Fei_periodo, $Pec_Fef_periodo); 	
									?></td>
								</tr>
							</table>
						</div>
						...
						<div class="balance-export-actions">
							...
							<form action="con_pri_estado_p_g_1.2.php" method="post" name= "form2" id="form2" target="_blank">
