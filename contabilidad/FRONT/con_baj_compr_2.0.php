...
if(isset($anularComp)){
    ...
    $obBD_con1->validaCierrePeriodo('comprobantes','Com_Fec','Com_Cod',$_POST['Com_Fec'],null,$obBD_conexion);                 
    //Cambiar Estado a Comprobante
    $obBD_con1->operacionobBD(26,$data,$obBD_conexion);
...
<HTML>
    <HEAD>		
        ...
        <TITLE><?Php echo "Comprobantes Anular [EXA]"; ?></TITLE>
        <meta charset= "UTF-8">
        ...
        <script type="text/javascript">var alta=false, duplica=false, anula=true, noEdit=false, editing=false, listsearch, compNoEdit, docuView, dataSend=new Array(), pec_min='<?php echo (!empty($perio['menor'])?substr($perio['menor'], 0, 4):'2015'); ?>', pec_max='<?php echo (!empty($perio['mayor'])?substr($perio['mayor'], 0, 4):substr($hoy, 0, 4)); ?>'; </script>   
    ...
    <BODY>
        <div class="panel panel-main">
            <div class="panel-heading exa-header"><h3 class="panel-title">&raquo;  Baja de Comprobantes</h3></div>
            ...
            <div id="main-panel">
               ...
               <div id="tabsSearch" class="ui-tab-fix ui-tabs">
                ...
                <div style="min-height: 350px;">
                    ...
                    <div class="Titulos2"><span id="plan-footer"><strong>Leyenda:</strong> <span class="glyphicon glyphicon-remove red"></span> Anulados/Inactivos | <span class="glyphicon glyphicon-lock yellow"></span>Generados Automaticamente</div>
                </div>    
            </div>        
            <div id="edit-panel" style="display: none;">                
                        <form id="formAsien" class="form-horizontal normal"  action="javascript:anularComp();"   >
                ...
                <div class="row"><div class="col-xs-3 no_doc_panel" style="display: none"></div><div class="col-xs-6" style="padding-top:10px;">
                    ...
                    <button id="btnBaja" onclick="$('#formAsien').formSubmit();" class="btn btn-danger btn-sm " title="Dar de Baja" ><i class="glyphicon glyphicon-trash"></i><span> Dar de Baja</span></button>
                </div></div>
