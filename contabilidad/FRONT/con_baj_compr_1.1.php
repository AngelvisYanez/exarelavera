...
{	
	...
	*/
	...
	{	
		if ($op_opciones == "d")
		{
			$row_rs_cabcomp = $obBD_con1->getArrayConsulta(154, $tabla.'*'.$txt_busqueda.'*'.$op.'*'.$Pec_Cod.'*'.$campo.'*'.$cmb_mes, $obBD_conexion);
		}
		else 
		{
			/**  
			...
			*/
			...
			$row_rs_cabcomp = $obBD_con1->getArrayConsulta(353, $tabla.'*'.$busqueda.'*'.$op.'*'.$Pec_Cod.'*'.$campo.'*'.$Par_Fec, $obBD_conexion);
		}  			
	}
		...
		if (isset($hdd_save2))
		{
			...
			*/
                    $obBD_con1->inicio_transaccion($obBD_conexion->conexion);  
                        $obBD_con1->grabarv_registros(sentencias_con(330,$obBD_con1->parametros($Com_Cod)), $obBD_conexion->conexion);
