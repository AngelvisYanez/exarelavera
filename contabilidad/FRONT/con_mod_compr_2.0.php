...
$dataDiario = $_POST;
$guardadoExitoso = 0;
if ($dataDiario['Diario_Generado'] == 'True') {
    ...
    $existeApertura = $obBD_con2->getArrayConsulta(501, $PecCod1, $obBD_conexion);
    $periodo = current($rs_periodos);

    $Com_Cod_Apertura = $existeApertura[0]['Com_Cod'];
    if (count($existeApertura) > 0) {
        $obBD_con1->operacionobBD(25, $Com_Cod_Apertura, $obBD_conexion);
        $obBD_con1->operacionobBD(29, $Com_Cod_Apertura, $obBD_conexion);
        $existeApertura = $obBD_con2->getArrayConsulta(501, $PecCod1, $obBD_conexion);
    }
          ...
          */
            ...
            if ($tamano > 0) {
              ...
              */
                ...
                $dataDiario['Com_Fec'] = $Anio + 1 . "-01-01"; //date("Y-m-d"); 
...
if (isset($saveData)) {
    ...
    if (!empty($asien))
        foreach ($asien as $row) {
            if(!empty($data["Cop_Cod"])){
                $obBD_con1->operacionobBD(33, array("Pld_Cod" => $row["Pld_Cod"], "Asi_Cod" => $row['Asi_Cod'] , "Cop_Cod" => $data["Cop_Cod"]), $obBD_conexion);
            }
    ...
    if ($obBD_con1->Error == 0) {
        if ($Ses_Emp_Cod == 300) {
            $responce = array('success' => true, 'codigo' => $codigo, 'link' => baseUrl("../../contabilidad/FRONT/con_pri_compr_2.1_empresa.php") . "?codigo=$Com_Cod&" . (!empty($form['Prv_Cod']) ? "tabla=proveedore&campo=Prv_Cod" : "tabla=cliente&campo=Cli_Cod") . "&tipo=$form[Tia_Cod]&Pec_Cod=$form[Pec_Cod]");
        } else {
...
<HEAD>
    ...
    <TITLE><?Php echo "Comprobantes Modificar [EXA]"; ?></TITLE>
    <meta charset="UTF-8">
...
<BODY>
    <div class="panel panel-main">
        <div class="panel-heading exa-header">
            <h3 class="panel-title">&raquo; Actualizar Comprobantes</h3>
        </div>
                                    ...
                                    <div class="col-xs-6">
                                        ...
                                        <div id='todos' class='filtros' style='display:none'>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-3">
                                                    <button type="submit" id="buscarDiario" class="btn btn-xs btn-success">
            ...
            <div id="edit-panel" style="display: none;">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6" style="padding-top:10px;">
                        ...
                        <button onclick="$.createDialogConfirm('¿Está seguro que desea guardar los cambios?',null,saveNoEdit)" type="button" class="btn btn-success btn-sm" title="Guardar Cambios"><i class="glyphicon glyphicon-floppy-disk"></i><span> Guardar</span></button>
                    </div>
                </div>
    ...
    <?php
    } elseif ($guardadoExitoso == 4) {
    ?>
        <script type="text/javascript">
            alert("Ya existe diario de apertura!");
        </script>
