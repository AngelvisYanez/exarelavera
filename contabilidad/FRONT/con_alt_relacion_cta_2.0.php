...
<BODY>
    ...
    <div class="panel panel-main">
        <div class="panel-heading exa-header"><h3 class="panel-title">&raquo;   Registrar Relaci�n Producto - Plan De Cuentas <?Php if(isset($Year[0])) echo 'Periodo '.$Year[0];?></h3></div>
            ...
            <?php if(isset($Pec_Cod)&&$Pec_Cod!=''){ ?>               
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <fieldset class="exa-fieldset">                           
                           <legend class="Titulos2">Parametrizaci�n Productos:</legend> <!-- Form Name -->
                           ...
                           <div class="">
                                ...
                                $(function() {
                                     ...
                                     $("#list").jqGrid({
                                            ...
                                            colModel: [
                                                { label: 'C�d.Int.', name: 'Pro_Cod', key: true, width: 25,align:"center", hidden:false },  
