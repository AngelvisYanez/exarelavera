...
<table width="609" border="0" cellpadding="0" cellspacing="0">
                      <td width="609" height="80" colspan="4" align="left" valign="bottom"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
                      <tr>
                        <td height="114" colspan="4" align="left" valign="bottom" class="Letra_punto_venta_2">&nbsp;</td>
                      </tr>
                      <tr>
			...
			{ 
              ...
              <td height="50" colspan="4" align="left" valign="bottom"><table width="100%" border="0" cellpadding="0" cellspacing="0" >
                ...
                <tr class="Letra_punto_venta_2">
                  <td height="14" align="left" valign="bottom">CANT.</td>
  ...
  <tr>
            <td height="100" colspan="4" align="right" valign="bottom"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
              <tr>
                <td width="82%" align="right">Tarifa 12%&nbsp;&nbsp;</td>
                <td width="18%" align="right"><?Php echo formato_numero($resultados[2]+0, 2, 1); ?></td>
              </tr>
              <tr>
