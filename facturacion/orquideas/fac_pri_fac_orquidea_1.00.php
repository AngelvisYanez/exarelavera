...
<table width="342" height="100%" border="0" align="left">
          <td width="336" height="176" colspan="4" align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Texto_Listados">
        <tr>
...
No:</td>
	...
	?>
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="Texto_normal_9">
              <tr>
              ...
              <tr>
                ...
                <td width="60" align="right"><?Php echo number_format($row_rs_cliente['Vet_Pru'], 2); ?>&nbsp;&nbsp;</td>
...
<tr>
            <td colspan="4" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Texto_normal_9">
              <tr>
