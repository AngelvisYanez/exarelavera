...
<tr>
          <td width="547" height="21" colspan="4" align="left" valign="top">
  <tr>
    <td height="174" colspan="4" align="left" valign="top"><table width="87%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_3">
      <tr>
        <td width="2%" height="14" align="right" valign="bottom">&nbsp;</td>
        <td width="63%" valign="bottom"><?php if ($row_rs_representante['Cli_Fac'] != "")
			{ 
				echo $row_rs_representante['Cli_Fac'];  
			}
			else { echo $row_rs_cliente['Prs_Ape'].' '.$row_rs_cliente['Prs_Nom']; }
		    ?></td>
        <td width="35%" rowspan="3" align="left" valign="middle"><table width="90%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_3">
          <tr>
      ...
      <tr>
        <td height="35" colspan="3" align="right" valign="bottom"><?Php 
	 $tarifa_0 = 0;
	 $tarifa_12 = 0;
	...
	?>
          <table width="97%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_3">
            <?php do{?>
            <tr>
              <td width="60" align="right"><div align="left"><?Php echo $row_rs_cliente['Vet_Can']?></div></td>
				  ...
				  */
				  ...
				  $total_rs_interes = $obBD_con1->numregistros();
					...
					{ 
						...
						?>
            <tr>
              <td align="right"><div align="left"><?Php echo $row_rs_interes['Vet_Can']?></div></td>
  ...
  <tr>
            <td height="121" colspan="4" valign="top"><table width="87%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_3">
              <tr>
                <td align="right">&nbsp;</td>
