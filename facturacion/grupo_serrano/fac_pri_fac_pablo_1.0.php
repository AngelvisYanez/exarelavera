...
<tr>
          <td width="547" height="49" colspan="4" align="left" valign="top"></td>
 </tr>
  <tr>
    <td height="601" colspan="4" align="left" valign="top"><table width="91%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_3">
      ...
      <tr>
        <td>&nbsp;</td>
        <td height="19" valign="middle"><?Php echo $row_institucion['Ciu_Des']; ?></td>
        <td align="center">&nbsp;</td>
      </tr>
      <tr>
        <td height="12" colspan="3" align="left" valign="bottom">&nbsp;</td>
      </tr>
      <tr>
				  ...
				  */
				  ...
				  $total_rs_interes = $obBD_con1->numregistros();
					...
					{ 
						...
						?>
            <tr>
              <td align="center"><div align="left"><?Php echo $row_rs_interes['Vet_Can']?></div></td>
...
<tr>
            <td colspan="4" valign="top"><table width="91%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_3">
              <tr>
                <td height="33" align="right"><!--Tarifa 0%-->&nbsp;&nbsp;</td>
                <td align="right"><?Php echo formato_numero($resultados[1]+0, 2, 1); ?></td>
              </tr>
              <tr>
                <td width="68%" height="33" align="right"><!--Tarifa 12%-->&nbsp;&nbsp;</td>
                <td width="32%" height="15" align="right"><?Php echo formato_numero($resultados[2]+0, 2, 1); ?></td>
              </tr>
              <tr>
                <td height="33" align="right"><!--Subtotal&nbsp;-->
                  &nbsp;</td>
                <td height="10" align="right"><?Php echo formato_numero($resultados[0], 2, 1); ?></td>
              </tr>
              <tr>
                <td height="33" align="right"><!--Descuento&nbsp;-->
                  &nbsp;</td>
                <td height="17" align="right"><?Php echo formato_numero($resultados[4], 2, 1); ?></td>
              </tr>                            
              <tr>
                <td height="33" align="right"><!--IVA&nbsp;-->
                  &nbsp;</td>
                <td height="10" align="right"><?Php echo formato_numero($resultados[3], 2, 1); ?></td>
              </tr>
              <tr>
                <td height="33" align="right"><!--TOTAL&nbsp;-->
                  &nbsp;</td>
