...
<table width="853"   border="0" align="left">
        <td width="847" height="438" colspan="4" valign="top"><table width="849" height="378" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr>
          <td height="140" >&nbsp;</td>
          <td height="140" >&nbsp;</td>
        ...
        <tr>
          <td width="298" height="37" >&nbsp;</td>
          <td height="37" >&nbsp;</td>
          <td height="37" valign="top" ><table width="98%" height="26" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
            <tr>
              <td width="42%">&nbsp;</td>
        ...
        <tr >
          <td height="36" align="left" valign="bottom" class="Letra_punto_venta_2">&nbsp;&nbsp;&nbsp; <? 
		if ($row_rs_renta['Aut_Cod'] != "") 
		{ 
  ...
  <tr valign="top">
    <td  valign="top"><table width="810" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#000000">
	<tr>
    ...
    <table width="805" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2" >
	 <tr align="center">
            <td colspan="6"></td>
          <tr align="center">
...
<?Php }//Fin del foreach ?>
	...
	<tr>
	  <td width="178" height="61" class="Letra_punto_venta_2">&nbsp;</td>
	  <td width="343" height="61" align="right">&nbsp;</td>
  	  <td width="109" height="61" class="Letra_punto_venta_2" align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>	  
	  <td width="1" class="Letra_punto_venta_2" align="right">&nbsp;</td>
	  <td width="159" align="right" valign="bottom" class="Letra_punto_venta_2"><strong><?Php echo number_format ($Total_Ret, 2,'.',''); ?></strong></td>
	</tr>
	</table>	  
</table>
  </tr>
