...
$.createSearchDialog('proDialog', [
    { label: 'C&oacute;d.Int.', name: 'Pro_Cod', key: true, width: 35, align: "center", hidden: false },
    { label: 'Descripcion', name: 'Ite_Lar', width: 110 },
    { label: 'Marca', name: 'Mar_Des', width: 40 },
    { label: 'Categoria', name: 'Cat_Des', width: 90, align: "center" },
    { label: 'Stock', name: 'Stk_Can', width: 30, align: "center" },
...
function imprimirProforma(reporteTabla, campos) {
    ...
    campos['items'].forEach(function (valor) {
        ...
        if (valor['Pro_Cod'] > 0) {
            ...
            //console.log(total);
            var fila = "<tr><td>" + valor['Vet_Can'] + "</td><td  align=left>" + valor['Ite_Lar'] + " " + valor['Prf_Adi'] + "</td><td>" + valor['Vet_Pru'] + "</td><td>" + valor['Vet_Imp'] + "</td><td align=right>" + valor['Vet_Imp'] + "</td></tr>";
