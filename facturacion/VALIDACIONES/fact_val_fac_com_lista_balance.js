...
function armarGridPrincipal() {
      var gridConfig = {
            caption: 'BALANCES COMPARATIVOS ',
            height: 430,
            colModel: [
                  { label: 'Pld. Cod', name: 'Pld_Cod', width: 10 },
                  { label: 'Plan', name: 'Pld_Cdc', width: 15, align: 'left' },
                  { label: 'Rubrolll', name: 'Pld_Des', width: 30, align: 'left' }
            ...
            loadComplete: function () {
                  ...
                  rowIds.forEach(function(rowId) {
                      ...
                      $grid.jqGrid('setCell', rowId, 'Asi_Val', totalGeneral);
                  });


                  $(this).jqGrid('footerData', 'set', {
                        Pld_Des: "<div style='text-align:center;'>   </div>",
      ...
      meses.forEach(function (mes) {
            gridConfig.colModel.push({
                  ...
                  name:  mes.charAt(0).toUpperCase() + mes.slice(1), // Nombre de la columna en minúsculas
                  width: 10,
                  align: 'right',
                  formatter: 'currency',
