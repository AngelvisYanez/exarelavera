...
$(function() {
    ...
    //Grid de registro de alicuotas
    grid.createGrid({
        caption: 'REGISTRO DE ALICUOTAS',
        height: '350',
        colModel: [
            { name: 'index', label: 'Index', width: 20, sorttype: 'int', align: 'center', hidden: true },
            { label: 'Cod', name: 'Ali_Cod', key: true, hidden: true },
            { label: '<span class="required"></span> Cliente', name: 'Cliente', width: 40, align: "center", title: true, formatter: 'input2', formatoptions: { id: '1', title: 'Buscar Cliente', action: "abrirDialogCliente", data: function(o) { return o; } }, resizable: false },

            { name: 'Cli_Cod_Ali', hidden: true, formatter: 'input3', formatoptions: { id: '3', attr: '' } },

            { name: 'Prs_Ced', hidden: true },
            { name: 'Prs_Cor', hidden: true },
            { name: 'Prs_Dir', hidden: true },
            { label: '<span class="required"></span>Num. Venta', name: 'Vet_Num', width: 20, align: "center", title: true, formatter: 'input2', formatoptions: { id: '1', title: 'Buscar Venta', action: "abrirDialogVenta", data: function(o) { return o; } }, resizable: false },

            { name: 'Vet_Cod_Ali', hidden: true, formatter: 'input3', formatoptions: { id: '3', attr: '' } },

            { label: 'Tipo de Venta', name: 'Tic_Des', width: 20, align: "center", title: false, formatter: 'input3', formatoptions: { id: '3', attr: '' } },
            { label: 'Fecha de Venta', name: 'Caj_Fec', width: 20, align: "center", title: false, formatter: 'input3', formatoptions: { id: '3', attr: '' } },
            { label: 'Saldo de Venta', name: 'Saldo', width: 20, align: "right", title: false, formatter: 'input3', formatoptions: { id: '3', attr: '' } },
            { label: '<span class="required"></span> Fecha', name: 'Ali_Fec_Venta', width: 15, align: 'center', title: false, formatter: 'input2', formatoptions: { id: '2', attr: '' } },
            { label: '<span class="required"></span> Pago', name: 'Ali_Pag', width: 20, align: 'center', title: false, formatter: 'input2', formatoptions: { id: '2', attr: '' } },
            { name: 'delete', label: '<i class="glyphicon glyphicon-remove"></i>', width: 10, align: 'center', viewable: false, formatter: 'gridButton', formatoptions: { action: quitarViaje, /*conditional: function(o) { console.log(o); return o.tarja === 'n' && o.Prh_Est !== 'I'; },*/ icon: 'remove', type: 'danger', title: 'Eliminar Item', data: function(o) { return o; } }, resizable: false }
    ...
    }, true, '#Cuo_Page', { view: false, refresh: false }).gridButtonAdd({
    ...
    gridMovAli.createGrid({
        ...
        shrinkToFit: true,
        colModel: [
            { label: 'C&oacute;d. Int.', name: 'VetCod', key: true, width: 15, align: "center", hidden: false },
            { label: 'Factura', name: 'Vet_Num', align: 'center', width: 30, formatter: function(cv, opt, ro) { return cv.toNum().padLeft(6,'0'); } },
            { label: 'Cliente', name: 'Cliente', align: 'left', width: 65 },
            { label: 'Tipo Venta', name: 'Tic_Des', width: 20 },
            { label: 'Fecha', name: 'Caj_Fec', align: 'center', width: 20 },
            { label: 'Total', name: 'Total', align: 'right', width: 15, formatter: 'currency', formatoptions: { prefix: '$ ', thousandsSeparator: ',', decimalSeparator: '.', defaultValue: '' } },
            { label: 'Abonos', name: 'Pagos', align: 'right', width: 15, 
                formatter: function(cv, opt, rowObject) { 
                    if (rowObject['Pagos'] === '' || rowObject['Pagos'] === null) { return "0.00"; } else { return formatMoney(rowObject['Pagos']); }
                }
            },
            { label: 'Saldo', name: 'Resto', align: 'right', width: 15,
                formatter: function(cv, opt, rowObject) {
                    if (rowObject['Resto'] === '0.00') { return "0.00"; } else { return formatMoney(rowObject['Resto']); }
                }
            },
        ],
        footerrow: true,
    ...
    }, true, '#tableAlicuotasPager', { refresh: false, view: false }).gridButtonsAdd([
        { caption: 'Exportar Excel', buttonicon: 'glyphicon glyphicon-download', onClickButton: function() { gridMovAli.jqGrid('exportGridExcel', { nombre: 'Alicuotas', hoja: 'HOJA 1' }); } }
    ]);
    ...
    $.createSearchDialog('#ventasDialog',
        ...
        [
            ...
            { label: 'N�mero Venta', name: 'Num_Vent', align: 'center', width: 50 },
            ...
            { label: '&nbsp;', name: 'act1', width: 20, align: 'center', viewable: false, formatter: 'gridButton', formatoptions: { action: 'selectVenta', conditional: function(o) { return o.Resto > 0; }, caseFalse: function() { return '<i class="glyphicon glyphicon-lock orange" title="Factura Pagada !"></i>'; }, title: 'Seleccionar Factura', icon: 'arrow-right', type: 'success' }, title: false }
        ], null, null, null, { headertitles: true }, {
            title: 'Ventas', height: '600',
...
/**
 * M�todo que se encarga de ir registro a registro sumando su abono y verificando que no sea superior al saldo
 */
