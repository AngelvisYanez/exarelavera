...
<body>
<table width="300" height="100%" border="0" align="left">
        ...
        <tr>
          <td colspan="2">Ciudad: <?Php echo $row_institucion['Ciu_Des']; ?></td>
          </tr>
        <tr>
          <td colspan="2">
            Cliente: 
	...
	?>
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta">
              ...
              <tr>
                ...
                <td width="40" align="right"><?Php echo number_format($row_rs_cliente['Vet_Imp'], 2); ?></td>
              </tr>
              <?Php 
				  /* 
				  * % de Descuento total 
...
<tr>
            <td colspan="4" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta">
              <tr>
                <td width="81%" align="right">Subtotal&nbsp;&nbsp;</td>
                <td width="30%" align="right"><?Php echo formato_numero($resultados[0], 2, 1); ?></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td align="right"><?Php echo formato_numero($resultados[2], 2, 1); ?></td>
              </tr>
              <tr>
