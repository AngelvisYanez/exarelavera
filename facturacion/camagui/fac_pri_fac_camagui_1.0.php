...
<tr>
          <td width="547" height="37" colspan="4" align="left" valign="top">
  <tr>
    <td height="165" colspan="4" align="left" valign="top"><table width="93%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_3">
      <tr>
        <td width="13%" height="19" align="right" valign="bottom">&nbsp;</td>
        <td colspan="2" valign="top"><?php if ($row_rs_representante['Cli_Fac'] != "")
			{ 
      ...
      <tr>
        <td height="21">&nbsp;</td>
        <td colspan="2" valign="top"><?php if ($row_rs_representante['Cli_Dir'] != "")
			{ 
      ...
      <tr>
        <td>&nbsp;</td>
        <td width="49%" height="21" valign="bottom"><?Php echo $row_institucion['Ciu_Des']; ?></td>
        <td width="38%" align="center" valign="middle"><table width="85%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_3">
          <tr>
            <td width="26%" align="right">&nbsp;<?php echo $dia;?></td>
            <td width="35%" align="right">&nbsp;<?php echo $mes;?></td>
            <td width="39%" align="right">&nbsp;<?php echo $anio;?></td>
          </tr>
        </table></td>
      </tr>
      <tr>
        <td height="45" colspan="3" align="right" valign="bottom"><?Php 
	 $tarifa_0 = 0;
	 $tarifa_12 = 0;
	
	?><br>
          <table width="99%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_3">
            <?php do{?>
            <tr>
              <td width="40" align="right"><?Php echo $row_rs_cliente['Vet_Can']?></td>
              <td width="180" align="left"><div align="left">&nbsp;&nbsp;<?Php echo $row_rs_cliente['Ite_Lar'].' '.$row_rs_cliente['Pro_Obs']?></div></td>
				  ...
				  */
				  ...
				  $total_rs_interes = $obBD_con1->numregistros();
					...
					{ 
						...
						?>
            <tr>
              <td align="right"><?Php echo $row_rs_interes['Vet_Can']?></td>
  ...
  <tr>
            <td height="121" colspan="4" valign="top"><table width="88%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_3">
              <tr>
                <td align="right"><!--Subtotal&nbsp;-->
                  &nbsp;</td>
                <td height="22" align="right"><?Php echo formato_numero($resultados[0], 2, 1); ?></td>
              </tr>
              <tr>
                <td align="right"><!--Descuento&nbsp;-->
                  &nbsp;</td>
                <td height="22" align="right"><?Php echo formato_numero($resultados[4], 2, 1); ?></td>
              </tr>
              <!-- <tr>
              ...
              <tr>
                <td width="68%" align="right"><!--Tarifa 12%&nbsp;-->
                  &nbsp;</td>
                <td width="32%" height="22" align="right">0.00
                  <?Php //echo formato_numero($resultados[2]+0, 2, 1); ?></td>
              </tr>
              <tr>
                <td align="right"><!--IVA&nbsp;-->
                  &nbsp;</td>
                <td height="22" align="right"><?Php echo formato_numero($resultados[3], 2, 1); ?></td>
              </tr>
              <tr>
                <td align="right"><!--TOTAL&nbsp;-->
                  &nbsp;</td>
                <td height="22" align="right"><strong><?php echo number_format($resultados[5], 2); ?></strong></td>
              </tr>
              <tr>
