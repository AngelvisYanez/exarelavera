...
<tr>
          <td width="547" height="65" colspan="4" align="left" valign="top">
  <tr>
    <td height="252" colspan="4" align="left" valign="top"><table width="93%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_3">
      <tr>
        <td width="4%" height="18" align="right" valign="bottom">&nbsp;</td>
        <td width="60%" valign="middle"><?php if ($row_rs_representante['Cli_Fac'] != "")
			{ 
				echo $row_rs_representante['Cli_Fac'];  
			}
			else { echo $row_rs_cliente['Prs_Ape'].' '.$row_rs_cliente['Prs_Nom']; }
		    ?></td>
        <td width="36%" rowspan="3" align="left" valign="middle"><table width="85%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_3">
          <tr>
  ...
  <tr>
            <td height="217" colspan="4" valign="top"><table width="89%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_3">
              <tr>
                <td align="right">&nbsp;</td>
              ...
              <tr>
                <td align="right"><!--Subtotal&nbsp;-->
                  &nbsp;</td>
                <td height="26" align="right"><?Php echo formato_numero($resultados[0], 2, 1); ?></td>
              </tr>
              <tr>
              ...
              <tr>
                <td width="68%" align="right"><!--Tarifa 12%&nbsp;-->
                  &nbsp;</td>
                <td width="32%" height="26" align="right">0.00
              ...
              <tr>
                <td align="right"><!--TOTAL&nbsp;-->
                  &nbsp;</td>
                <td height="26" align="right"><strong><?php echo number_format($resultados[5], 2); ?></strong></td>
              </tr>
              <tr>
