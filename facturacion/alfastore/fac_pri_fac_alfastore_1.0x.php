...
<table width="621" height="100%" border="0" align="center">
        ...
        <tr>
          <td colspan="4" align="center" class="LetraPlan">ALFA STORE</td>
        </tr>
        <tr>
          <td colspan="4" align="center" class="Texto_normal_10"><div align="center"> BOLIVAR Y JUAN MONTALVO TELEFONO: 072968640 MACHALA</div></td>
          </tr>
        <tr>
          <td align="left">&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr>
          ...
          <td align="left"><table width="47%" border="0" cellpadding="0" cellspacing="0" class="Texto_Reporte">
            <tr>
...
<tr>
            <td colspan="4" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Texto_Reporte">
              ...
              <tr>
                <td colspan="2" class="Texto_Listados"><strong>Nota:</strong> Descargue su Factura Electr&oacute;nica en http://exa.ofsercont.com</td>
              </tr>
            </table>                      
  <tr valign="top">
    <td valign="bottom">
