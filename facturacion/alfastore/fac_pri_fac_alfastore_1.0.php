...
<table width="571" height="96%" border="0" align="center">
        ...
        <tr>
          <td colspan="4" align="center" class="Letra_punto_venta_2"><strong>BOUTIQUE ALFA STORE</strong></td>
        </tr>
        <tr>
          <td colspan="4" align="center" class="Letra_punto_venta_2">&quot;EXCLISIVIDAD PARA NOSOTRAS&quot;</td>
        </tr>
        <tr>
          <td colspan="4" align="center" class="Texto_normal_10"><div align="center" class="Letra_punto_venta_2"> EL ORO-MACHALA / BOLIVAR Y JUAN MONTALVO / TELF: 072968640</div></td>
          </tr>
        <tr>
        ...
        <tr>
          ...
          <td><?php if ($row_rs_representante['Cli_Fac'] != "")
		    ...
		    ?></td>
          <td width="11%" align="left">CIUDAD<strong>:</strong></td>
          <td width="24%"><?Php echo $row_institucion['Ciu_Des']; ?></td>
          </tr>
        <tr>
        ...
        <tr>
          <td colspan="4" align="left" valign="top">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
              ...
              <tr>
                <td align="left" class="Letra_punto_venta_2"><strong>&nbsp;<!--Cant.--></strong>CANT.</td>
                <td width="420" align="left" class="Letra_punto_venta_2">PRODUCTO<strong>&nbsp;<!--Descripci&oacute;n--></strong></td>
                <td align="right" class="Letra_punto_venta_2">P. UNIT.&nbsp;<!--PVP--></td>
                <td align="right" class="Letra_punto_venta_2">IMPORTE<strong>&nbsp;<!--Total--></strong></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td width="43" align="right"><?Php echo number_format($row['Vet_Pru'], 2); ?>&nbsp;&nbsp;</td>
                <td width="64" align="right"><?Php echo number_format($row['Vet_Imp'], 2); ?></td>
              </tr>
              <?Php 
				  /* 
				  * % de Descuento total 
...
<tr>
            <td colspan="4" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
              <tr>
                <td colspan="4" align="left"><hr size=1></td>
              </tr>
              <tr>
                <td align="left"><?php 
		     if ($row_rs_cliente[0]['Vet_Xml']!="")
			 {
          		echo "CLAVE DE ACCESO: ".$row_rs_cliente[0]['Vet_Xml'];
			 }else{ echo "&nbsp;";}
          ?></td>
              ...
              <tr>
                ...
                <td align="right"><?Php echo formato_numero($resultados[0]-$resultados[4], 2, 1); ?></td>
              </tr>
              <tr>
                <td align="right"><strong>&nbsp;&nbsp;</strong></td>
              ...
              <tr>
                ...
                <td width="18%" align="right">TOTAL<strong>&nbsp;&nbsp;</strong></td>
                <td align="right"><?php echo number_format($resultados[5], 2); ?></td>
              </tr>
              <tr>
                <td colspan="3" class="Texto_Listados">&nbsp;</td>
              </tr>
            </table>
  <tr valign="top">
    <td valign="bottom">
