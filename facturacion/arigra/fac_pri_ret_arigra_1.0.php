...
<table width="853"   border="0" align="left">
        <td width="847" height="435" colspan="4" valign="top"><table width="849" height="399" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr>
          <td height="142" >&nbsp;</td>
          <td height="142" >&nbsp;</td>
        ...
        <tr>
          <td width="298" height="46" >&nbsp;</td>
          <td height="46" >&nbsp;</td>
          <td height="46" valign="middle" ><table width="84%" height="24" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
            <tr>
              <td width="42%" height="24">&nbsp;</td>
              <td width="58%" align="right" valign="bottom"><?Php $Fec_Emi=explode('-',$row_prin_renta['Ret_Fec']); ?>
...
<?Php }//Fin del foreach ?>
	...
	<tr>
	  ...
	  <td width="338" height="113" align="right">&nbsp;</td>
  	  <td width="110" height="113" class="Letra_punto_venta_2" align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>	  
