...
<table width="750"   border="0" align="left">
        ...
        <table width="743" height="135" border="0" align="left" style="table-layout:fixed;" cellpadding="0" cellspacing="0">
          ...
          <tr >
            <td height="18" colspan="2" valign="middle" class="Letra_punto_venta_2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row_prin_renta['Prs_Ape'].' '.$row_prin_renta['Prs_Nom']; ?></td>
          ...
          <tr>
            <td width="231" height="13" valign="top" class="Letra_punto_venta_2" >&nbsp;&nbsp;<?php echo $row_prin_renta['Tic_Des']; ?></td>
            <td width="205" colspan="-2" align="center" valign="bottom" class="Letra_punto_venta_2" ><?php 
		if ($row_rs_renta['Aut_Cod'] != "") 
		{ 
		...
		{  
            ...
            <td width="307" colspan="-2" align="center" valign="bottom" class="Letra_punto_venta_2"><?php echo $row_prin_renta['Cop_Fec']; ?></td>
          </tr>
          <tr >
            <td height="13" style="white-space: nowrap; overflow: hidden;" class="Letra_punto_venta_2" ><?php 
		if ($row_rs_renta['Aut_Cod'] != "") 
		{ 
		...
		?>
              &nbsp;</td>
            <td colspan="-2" align="center" valign="middle" class="Letra_punto_venta_2"><?php 
			if ($row_rs_renta['Aut_Cod'] != "") 
			{ 
