...
<table width="853"   border="0" align="left">
        <td width="847" height="438" colspan="4" valign="top"><table width="849" height="388" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr>
          <td height="140" >&nbsp;</td>
          <td height="140" >&nbsp;</td>
		...
		{  
          ...
          <td width="368" colspan="-2" align="left" valign="middle" class="Letra_punto_venta_2"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
            <tr>
              <td width="54%">&nbsp;</td>
              <td width="46%"><? echo $row_prin_renta['Cop_Fec']; ?></td>
            </tr>
          </table></td>
        </tr>
        <tr >
  ...
  <tr valign="top">
    <td  valign="top"><table width="797" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#000000">
	<tr>
    ...
    <table width="789" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2" >
	 <tr align="center">
            <td colspan="6"></td>
          <tr align="center">
          ...
          <tr align="center" >
            ...
            <td width="123" align="right">	<?Php $Ren_Por= $row['Ren_Por'].'%'; echo $Ren_Por; ?></td>
...
<?Php }//Fin del foreach ?>
	...
	<tr>
	  <td width="181" height="113" class="Letra_punto_venta_2">&nbsp;</td>
	  <td width="349" height="113" align="right">&nbsp;</td>
  	  <td width="113" height="113" class="Letra_punto_venta_2" align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>	  
	  <td width="1" class="Letra_punto_venta_2" align="right">&nbsp;</td>
	  <td width="133" align="right" valign="bottom" class="Letra_punto_venta_2"><strong><?Php echo number_format ($Total_Ret, 2,'.',''); ?></strong></td>
	</tr>
	</table>	  
</table>
  </tr>
