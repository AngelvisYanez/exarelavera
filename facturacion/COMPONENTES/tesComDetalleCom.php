    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
       <td class="Etiqueta1">Proveedor:</td>
        <td class="LetraNegra">&nbsp;<? echo $rs_info['Prs_Ape'].' '.$rs_info['Prs_Nom'];?></td>
        <td class="Etiqueta1">Creado el:</td>
        <td class="LetraNegra">&nbsp;<? echo $rs_usuVendedor['fecha']; ?></td>
      </tr>
      <tr>
        ...
        <td width="41%" class="LetraNegra">&nbsp;<? echo $rs_usuVendedor['Prs_Ape'].' '.$rs_usuVendedor['Prs_Nom']; ?></td>
      </tr>        
    </table>
