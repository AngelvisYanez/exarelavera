 ...
 */
$linea1 = "LIQUIDACIÓN DE COMPRA DE BIENES Y ";
$linea2 = "PRESTACIÓN DE SERVICIOS";

include dirname(__file__).'/../COMPONENTES/tesPdfGlobal.php';

$infoFact = $datoXml['infoLiquidacionCompra'];
$pdf->setField(128, 22, $linea1, '', 9);
$pdf->setField(128, 26, $linea2, '', 9);
...
$pdf->setField(40, 103, $infoFact['razonSocialProveedor'], null, null, null, 160);
$pdf->setField(13, 108, "RUC / CI:", 'B', 8);
$pdf->setField(30, 108, $infoFact['identificacionProveedor']);
...
$pdf->SetCWidths(array(8, 15, 81, 20, 20, 15, 15, 20));
$pdf->Row(array('No.', 'CÓDIGO', 'DESCRIPCIÓN', 'CANTIDAD', 'PRECIO U.', 'TARIFA', 'DESC.', 'TOTAL'), true, false);
$pdf->SetFont('Arial', '', 8);
$pdf->SetCAligns(array('L', 'C', 'L', 'C', 'R', 'C', 'C', 'R'));
$pdf->SetCHeight(5);
