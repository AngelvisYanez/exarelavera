				  ...
				  <tr >
					...
					<FIELDSET>
					  ...
					  <table  width="100%" border="0">
        							<tr>
          								<td width="182"><input id="op_opciones2" name="op_opciones2" type="radio" value="d" checked onClick="
		   												document.getElementById('op_opciones2').value='d';
		   												setfocus(document.getElementById('<?Php echo $Nombre_Buscador; ?>'))"  />
              							<span class="LetraNegra">Item</span></td>
          								<td width="701"><input type="radio" id="op_opciones2" name="op_opciones2" value="r" onClick="
														document.getElementById('op_opciones2').value='r';
		 												setfocus(document.getElementById('<?Php echo $Nombre_Buscador; ?>'))" />
              							<span class="LetraNegra">Código de barra</span> </td>
        							</tr>
      				 </table>	  					    
					  <table width="75%" height="35"  border="0" cellpadding="0" cellspacing="0">
						<tbody id="tbusqueda">
						  <tr class="BarraBusqueda">
							<td width="18%"><div align="right"><strong>Descripci&oacute;n:</strong></div></td>
							<td width="49%">
							<input name="<?Php echo $Nombre_Buscador; ?>" type="text" id="<?Php echo $Nombre_Buscador; ?>" size="40" maxlength="40" style="text-transform:uppercase">
