...
<?php
	if (count($rs_buscta) > 0) 
	{
		...
		{ 
			...
			nuevaFila_guiaRemi('c_contenido','<?php echo $row_rs_buscta['Pro_Cod'];?>','<?php echo $row_rs_buscta['Ite_Lar'];?>','<?php if ($row_rs_buscta['Pre_Pvp'] > 0){ echo $row_rs_buscta['Pre_Pvp']; } ?>','<?php echo $codigonota; ?>','','','<?php echo $bloc_cant; ?>','si','0','0','0','<?php echo $row_rs_buscta['Mar_Des']; ?>');">
