...
?>
	  ...
	  <?php }//Fin del foreach $row_rs_cuentas 
		 } ?>
	  <tr>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
...
<label class="Titulos2">Cheques</label>
 ...
 ?>
	...
	<input type="image" name="imageField" src="../../imagenes/banco_machala.jpg" title="Ver cheque" width="22" height="35">	</td>	
	</form>
		<form action="tes_pri_cheque_pac_1.0.php" method="post" name= "form3" target="_blank">
		  <td width="3%" align="center"><input name="codigo" type="hidden" id="codigo" value="<?php echo $cod; ?>">
			  ...
			  <input name="ban" type="hidden" id="ban" value="<?php echo $ban; ?>">
			  <input name="pro" type="hidden" id="pro" value="<?php echo $pro; ?>">
			  <input type="image" name="imageField" src="../../imagenes/banco_pacifico.jpg" title="Ver cheque" width="24" height="23">		  </td>
		</form>
		<form action="tes_pri_cheque_rum_1.0.php" method="post" name= "form3" target="_blank">
		  <td width="3%" align="center"><input name="codigo" type="hidden" id="codigo" value="<?php echo $cod; ?>">
			  ...
			  <input name="ban" type="hidden" id="ban" value="<?php echo $ban; ?>">
			  <input name="pro" type="hidden" id="pro" value="<?php echo $pro; ?>">
			  <input type="image" name="imageField" src="../../imagenes/banco_ruminahui.jpg" title="Ver cheque" width="30" height="15">		  </td>
		</form>
		<form action="tes_pri_cheque_gua_1.0.php" method="post" name= "form3" target="_blank">
		  <td width="3%" align="center"><input name="codigo" type="hidden" id="codigo" value="<?php echo $cod; ?>">
			  ...
			  <input name="ban" type="hidden" id="ban" value="<?php echo $ban; ?>">
			  <input name="pro" type="hidden" id="pro" value="<?php echo $pro; ?>">
			  <input type="image" name="imageField" src="../../imagenes/banco_guayaquil.JPG" title="Ver cheque" width="36" height="18">		  </td>
		</form>
...
{
	echo error_alerta("<< Error de componente: tesComConCheque.php >> <br>Descripción: No se ha definido la Propiedad: 	
		Com_Com_Cod<br>Pec_Cod: Variable que contiene el código del comprobante de egreso", 2); 	
}
?>