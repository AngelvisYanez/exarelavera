...
*/
$rs_buscta =  $obBD_con2->getArrayConsulta(53, $buscador.'*'.$Ses_Suc_Cod.'*'.$Pec_Cod,$obBD_conexion2);	
?>
<br>
<?Php 
...
<thead>
	<tr class="Cabecera1">
        <th width="12%" align="center"><strong>C&oacute;d. Int.</strong></th>
        <th width="45%"><strong>Descripci&oacute;n</strong></th>
        <th width="10%">Iva</th>
