		...
		$armado_xml .="<".$Eti_raiz[3].">"; //<infoAdicional>
			...
			foreach($rs_infoAdicional as $row)
			{
			 ...
			 if($rs_infoCliente['Prs_Dir']!=''){
				...
				$armado_xml.="<".$Eti_infoAdicional[0]." nombre='Direcci�n'>-</".$Eti_infoAdicional[0].">";	
			 }
			 
			 if($rs_infoCliente['Prs_Tel']!=''){
				$armado_xml.="<".$Eti_infoAdicional[0]." nombre='Tel�fono'>".$rs_infoCliente['Prs_Tel']."</".$Eti_infoAdicional[0].">"; 
			 }else{
				$armado_xml.="<".$Eti_infoAdicional[0]." nombre='Tel�fono'>-</".$Eti_infoAdicional[0].">"; 
			 }			 
			 ...
			 if($rs_infoCliente['Vet_Obs']!=''){
				$armado_xml.="<".$Eti_infoAdicional[0]." nombre='Observaci�n'>".$rs_infoCliente['Vet_Obs']."</".$Eti_infoAdicional[0].">"; 
			 }else{
				$armado_xml.="<".$Eti_infoAdicional[0]." nombre='Observaci�n'>-</".$Eti_infoAdicional[0].">"; 
			 }
