	...
	*/	
	...
	$armado_xml = "<".$Eti_raiz[0].">";  //<infoTributaria>
				...
				*/
				...
				$cadena=str_replace("/","",$rs_infoCliente['fecha'])."01".$rs_infoEmpresa['Emp_Ruc'].$rs_infoEmpresa['Cof_Fac'].$rs_infoEmpresa['Suc_Sri'].$rs_infoCliente['Pun_Sri'].$ceroDoc.$rs_infoCliente['Vet_Num']."12345678".$rs_infoEmpresa['Cof_Fte'];				
				$factor = 2;
				$suma = 0;
				...
				*/
				...
				$armado_xml.="<".$Eti_infoFac[2].">".$rs_infoEmpresa['Emp_Cnt']."</".$Eti_infoFac[2].">".    //<obligadoContabilidad>
							"<".$Eti_infoFac[3].">".$rs_infoCliente['Ide_Prv']."</".$Eti_infoFac[3].">". 	//<tipoIdentificacionComprador>
							"<".$Eti_infoFac[4].">".mb_convert_encoding($rs_infoCliente['Prs_Nom']." ".$rs_infoCliente['Prs_Ape'], 'UTF-8', 'ISO-8859-1')."</".$Eti_infoFac[4].">".   //<razonSocialComprador>
							...
							"<".$Eti_infoFac[8].">";    													//<totalConImpuestos>
									$rs_totImpuesto = $obBD_con1->getArrayConsulta(1210, $Tan_Cod."*".$Cod_infoFac[8], $obBD_conexion);
									unset ($row);
									...
									$desgloDscto=$rs_infoTotales['Dscto']/count($rs_importeImptos);																										
										...
										$armado_xml.="<".$Eti_totImp[0].">";   //<totalImpuesto>
										   ...
										   "<".$Eti_totImpDat[2].">".($datosImpto['imp']-$desgloDscto)."</".$Eti_totImpDat[2].">".	//<baseImponible>
				...
				*/
				...
				$armado_xml.="<".$Eti_detalle[0].">";    //<detalle>
						...
						$armado_xml.="<".$Eti_cabDetalle[0].">".$row_itemDetalle['Pro_Cod']."</".$Eti_cabDetalle[0].">".    //<codigoPrincipal>
									...
									"<".$Eti_cabDetalle[2].">".mb_convert_encoding(trim($row_itemDetalle['Pro_Obs']), 'UTF-8', 'ISO-8859-1')."</".$Eti_cabDetalle[2].">".    //<descripcion>
									"<".$Eti_cabDetalle[3].">".$row_itemDetalle['Vet_Can']."</".$Eti_cabDetalle[3].">".          //<cantidad>
									"<".$Eti_cabDetalle[4].">".formato_numero($row_itemDetalle['Vet_Pru'],2,1)."</".$Eti_cabDetalle[4].">".         //<precioUnitario>  
		...
		$armado_xml .="<".$Eti_raiz[3].">"; //<infoAdicional>
			...
			foreach($rs_infoAdicional as $row)
			{
			 ...
			 if($rs_infoCliente['Prs_Dir']!=''){
				$armado_xml.="<".$Eti_infoAdicional[0]." nombre='DirecciÛn'>".mb_convert_encoding($rs_infoCliente['Prs_Dir'], 'UTF-8', 'ISO-8859-1')."</".$Eti_infoAdicional[0].">";	
			 }else{
				$armado_xml.="<".$Eti_infoAdicional[0]." nombre='DirecciÛn'>-</".$Eti_infoAdicional[0].">";	
			 }
			 
			 if($rs_infoCliente['Prs_Tel']!=''){
				$armado_xml.="<".$Eti_infoAdicional[0]." nombre='TelÈfono'>".$rs_infoCliente['Prs_Tel']."</".$Eti_infoAdicional[0].">"; 
			 }else{
				$armado_xml.="<".$Eti_infoAdicional[0]." nombre='TelÈfono'>-</".$Eti_infoAdicional[0].">"; 
			 }			 
			 ...
			 if($rs_infoCliente['Vet_Obs']!=''){
				$armado_xml.="<".$Eti_infoAdicional[0]." nombre='ObservaciÛn'>".$rs_infoCliente['Vet_Obs']."</".$Eti_infoAdicional[0].">"; 
			 }else{
				$armado_xml.="<".$Eti_infoAdicional[0]." nombre='ObservaciÛn'>-</".$Eti_infoAdicional[0].">"; 
			 }
