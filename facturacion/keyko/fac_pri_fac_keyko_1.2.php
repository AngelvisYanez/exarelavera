...
<table width="366" height="100%" border="0" align="left">
<tr>
          <td width="360" height="323" colspan="4" align="left" valign="top">
          <table width="96%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
        <tr>
          <td height="45" align="right" valign="bottom">&nbsp;</td>
          <td width="47%" valign="bottom">&nbsp;</td>
          <td width="49%">&nbsp;</td>
        </tr>
        <tr>
          <td width="4%" height="20" align="left" valign="bottom">&nbsp;</td>
          <td colspan="2">
        ...
        <tr>
          <td height="23">&nbsp;</td>
          <td valign="middle"><?php if ($row_rs_representante['Cli_Fac'] != "")
			{ 
          ...
          <table height="25" width="75%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
            <tr>
              <td width="24%" align="right" valign="top">&nbsp;<?php echo $dia;?></td>
              <td width="36%" align="right" valign="top">&nbsp;<?php echo $mes;?></td>
              <td width="40%" align="right" valign="top">&nbsp;<?php echo $anio;?></td>
            </tr>
          </table></td>
          </tr>
        <tr>
          <td height="23">&nbsp;</td>
          <td valign="middle"><?Php echo $row_institucion['Ciu_Des']; ?></td>
          </tr>
        <tr>
	...
	?>
            <table width="89%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
              <tr>
              ...
              <?php do{
				...
				?>
                <tr>
                    <td width="35" align="left"><div align="left"><?Php echo "1"; ?></div></td>
                    <td width="120"><div align="left">&nbsp;<?Php echo "Consumo de alimentos"; ?></div></td>
                    <td width="40" align="right"><?Php echo number_format($totImp, 2); ?>&nbsp;&nbsp;</td>
                    <td width="50" align="right" ><div align="right"><?Php echo number_format($totImp, 2); ?></div></td>
                </tr>
				<?php
				/* 
				* Suma del descuento 
...
<tr>
            <td colspan="4" valign="top"><table width="84%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
              <tr>
                <td width="22%" height="23" align="right"><!--Subtotal&nbsp;-->&nbsp;</td>
                <td width="78%" align="right"><?Php echo formato_numero($resultados[0], 2, 1); ?></td>
              </tr>
              <tr>
                <td height="23" align="right"><!--Descuento&nbsp;-->&nbsp;</td>
                <td align="right"><?Php echo formato_numero($resultados[4], 2, 1); ?></td>
              </tr>
              <tr>
                <td height="23" align="right"><!--Tarifa 0%&nbsp;-->&nbsp;</td>
                <td align="right"><?Php echo formato_numero($resultados[1]+0, 2, 1); ?></td>
              </tr>
              <!--<tr>
                <td width="81%" height="20" align="right"><!--Tarifa 12%&nbsp;>&nbsp;</td>
                <td width="30%" align="right"><?Php //echo formato_numero($resultados[2]+0, 2, 1); ?></td>
              </tr>-->
              <tr>
                <td height="23" align="right"><!--IVA&nbsp;-->&nbsp;</td>
                <td align="right"><?Php echo formato_numero($resultados[3], 2, 1); ?></td>
              </tr>
              <tr>
                <td height="23" align="right"><!--TOTAL&nbsp;-->&nbsp;</td>
