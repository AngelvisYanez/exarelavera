...
<tr>
	...
	?>
            <table width="90%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
              ...
              <?php do{?>
              <tr>
                <td width="35" align="left"><div align="left"><?Php echo $row_rs_cliente['Vet_Can']?></div></td>
                <td width="120"><div align="left">&nbsp;<?Php echo $row_rs_cliente['Ite_Lar'].' '.$row_rs_cliente['Pro_Obs']?></div></td>
                <td width="40" align="right"><?Php echo number_format($row_rs_cliente['Vet_Pru'], 2); ?>&nbsp;&nbsp;</td>
                <td width="50" align="right" ><div align="right"><?Php echo number_format($row_rs_cliente['Vet_Imp'], 2); ?></div></td>
              </tr>
              <?Php 
				  /* 
				  * % de Descuento total 
...
<tr>
            <td colspan="4" valign="top"><table width="86%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
              <tr>
