...
<table width="853"   border="0" align="left">
        <td width="847" height="479" colspan="4" valign="top"><table width="849" height="432" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr>
          <td height="140" >&nbsp;</td>
          <td height="140" >&nbsp;</td>
        ...
        <tr>
          <td width="298" height="75" >&nbsp;</td>
          <td height="75" >&nbsp;</td>
          <td height="75" valign="top" ><table width="96%" height="26" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
            <tr>
              <td width="42%">&nbsp;</td>
        ...
        <tr >
          <td height="13" colspan="2" align="left" valign="middle" class="Letra_punto_venta_2"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
            <tr>
              ...
              <td width="77%" valign="bottom"><? echo $row_prin_renta['Prs_Ape'].' '.$row_prin_renta['Prs_Nom']; ?></td>
            </tr>
          </table></td>
        ...
        <tr >
          <td height="35" colspan="2" align="left" valign="bottom" class="Letra_punto_venta_2"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
            <tr>
              <td width="23%" height="30">&nbsp;</td>
              <td width="77%" valign="bottom"><? echo $row_prin_renta['Prs_Dir']; ?></td>
            </tr>
          </table></td>
          <td height="35" valign="bottom" class="Letra_punto_venta_2"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
            <tr>
              <td width="38%">&nbsp;</td>
        ...
        <tr >
          <td height="57" colspan="3" valign="top" class="Letra_punto_venta_2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
        </tr>
        <tr>
          <td height="30" align="center" valign="middle" class="Letra_punto_venta_2" ><? echo $row_prin_renta['Tic_Des']; ?></td>
          <td align="center" valign="middle" class="Letra_punto_venta_2" ><? 
		if ($row_rs_renta['Aut_Cod'] != "") 
		{ 
		...
		{  
          ...
          <td width="368" colspan="-2" align="left" valign="middle" class="Letra_punto_venta_2"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
            <tr>
              <td width="49%">&nbsp;</td>
              <td width="51%"><? echo $row_prin_renta['Cop_Fec']; ?></td>
            </tr>
          </table></td>
        </tr>
        <tr >
          <td height="23" align="left" valign="bottom" class="Letra_punto_venta_2">&nbsp;</td>
        ...
        <tr >
          <td height="38" colspan="3" align="left" valign="bottom" class="Letra_punto_venta_2"><? 
		if ($row_rs_renta['Aut_Cod'] != "") 
		{ 
  ...
  <tr valign="top">
    <td  valign="top"><table width="766" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#000000">
	<tr>
    ...
    <table width="767" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2" >
	 <tr align="center">
            <td colspan="6"></td>
          <tr align="center">
...
<?Php }//Fin del foreach ?>
	...
	<tr>
	  <td width="177" height="82" class="Letra_punto_venta_2">&nbsp;</td>
	  <td width="338" height="82" align="right">&nbsp;</td>
  	  <td width="110" height="82" class="Letra_punto_venta_2" align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>	  
	  <td width="1" class="Letra_punto_venta_2" align="right">&nbsp;</td>
	  <td width="120" align="right" valign="bottom" class="Letra_punto_venta_2"><strong><?Php echo number_format ($Total_Ret, 2,'.',''); ?></strong></td>
	</tr>
	</table>	  
</table>
  </tr>
