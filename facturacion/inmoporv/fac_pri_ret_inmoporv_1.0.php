...
<table width="853"   border="0" align="left">
        <td width="847" height="452" colspan="4" valign="top"><table width="849" height="400" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr>
          <td height="152" >&nbsp;</td>
          <td height="152" >&nbsp;</td>
          <td height="152" valign="bottom" >&nbsp;</td>
        </tr>
        <tr>
          <td width="298" height="40" >&nbsp;</td>
          <td height="37" >&nbsp;</td>
          <td height="37" valign="top" ><table width="97%" height="26" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
            <tr>
              <td width="42%">&nbsp;</td>
  ...
  <tr valign="top">
    <td  valign="top"><table width="808" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#000000">
	<tr>
    ...
    <table width="800" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2" >
	 <tr align="center">
            <td colspan="6"></td>
          <tr align="center">
          ...
          <tr align="center" >
            ...
            <td width="225"    ><?Php $Sri_Imp=$row['Ret_Imp']; echo $Sri_Imp;  ?></td>
            <td width="114" align="right"  ><?Php $Ren_Bas = number_format($row['Ret_Bas'], 2,'.',','); echo $Ren_Bas; ?></td>
            <td width="124" align="right">	<?Php $Ren_Por= $row['Ren_Por'].'%'; echo $Ren_Por; ?></td>
...
<?Php }//Fin del foreach ?>
	...
	<tr>
	  <td width="177" height="113" class="Letra_punto_venta_2">&nbsp;</td>
	  <td width="345" height="113" align="right">&nbsp;</td>
  	  <td width="108" height="113" class="Letra_punto_venta_2" align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>	  
	  <td width="1" class="Letra_punto_venta_2" align="right">&nbsp;</td>
	  <td width="157" align="right" valign="bottom" class="Letra_punto_venta_2"><strong><?Php echo number_format ($Total_Ret, 2,'.',''); ?></strong></td>
	</tr>
	</table>	  
</table>
  </tr>
