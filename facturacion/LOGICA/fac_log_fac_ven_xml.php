...
require_once ("fac_sql_fac_ven_xml.php");
	...
	*/
	...
	function cabeceraReporteStandar($sucursal, $titulo, $subtitulo,$obBD)
	{
		...
		<table align="center" width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr align="center">
			  <td width="16%" rowspan="4" valign="top"><img src="../../mascaras/model1/img/logo/mics.png" width="91" height="67" /></td>
			  <td width="65%" class="TITULO_REPORTE_2"><?Php echo $row_institucion['Emp_Nom']; ?></td>
			  <td width="19%" rowspan="5" valign="top"><img src="<?php echo $row_institucion['Emp_Log']; ?>" width="83" height="67" /></td>
			</tr>
			<tr align="center">
