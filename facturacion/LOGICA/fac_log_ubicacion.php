<?Php 
/**
 * Logica de las paginas de ubicacion
 *
...
require_once("fac_sql_ubicacion.php");
...
class Class_Log_Conexion_Ubi extends MysqlConexion{
...
class Class_Log_Datos_Ubi extends MysqlDatos{
	...
	*/
	function consultasobBD($sen_sql,$param, $obBD)
	{
		...
		return $this->consulta(sentencias_ubi($sen_sql,$Par_Sql), $obBD->conexion);
	}
	...
	*/
	...
	{
		$Par_Sql= $this->parametros($param);
		return $this->grabarv_registros(sentencias_ubi($sen_sql,$Par_Sql), $obBD->conexion);
	}
