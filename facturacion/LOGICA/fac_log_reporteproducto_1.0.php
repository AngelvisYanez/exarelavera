...
require_once("fac_sql_reporteproducto_1.0.php");
...
class Class_Log_Conexion_Rep extends MysqlConexion{
...
class Class_Log_Datos_Rep extends MysqlDatosContab{
	...
	*/
	function consultasobBD($sen_sql,$param, $obBD)
	{
		...
		return $this->consulta(sentencias_rep($sen_sql,$Par_Sql), $obBD->conexion);
	}
	...
	*/
	...
	{
		$Par_Sql= $this->parametros($param);
		return $this->grabarv_registros(sentencias_rep($sen_sql,$Par_Sql), $obBD->conexion);
	}
