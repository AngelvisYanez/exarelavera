...
require_once("inv_sql_ventas.php");
...
class Class_Log_Datos_Ven extends MysqlDatos{
	...
	*/
	function consultasobBD($sen_sql,$param, $obBD = null)
	{
		...
		return $this->consulta(sentencias_ven($sen_sql,$Par_Sql), $obBD->conexion);
	}
	...
	*/
	...
	{
		$Par_Sql= $this->parametros($param);
		return $this->grabarv_registros(sentencias_ven($sen_sql,$Par_Sql), $obBD->conexion);
	}
