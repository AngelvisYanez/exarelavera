    ...
    switch($id)
    {
        ...
        case 3:
         ...
         case 4:
            ...
            */
            ...
            break;
        case 5:
            $sql="INSERT INTO mesclas(`Pro_Cod`,`Mes_Nom`,`Mes_Des`,`Mes_Res`,`Mes_Max`)
                        VALUES($Par_Sql[Pro_Cod],'$Par_Sql[Mes_Nom]','$Par_Sql[Mes_Des]',1,$Par_Sql[Mes_Max]);";
            //echo $sql.'<br/>';
            break;
        case 6:
        ...
        case 88:
            $sql="SELECT
                    ...
                    FROM kardex_ie
                      WHERE 
                      Kar_Est='A' and kardex_ie.Pro_Cod = $Par_Sql[0]
                      order by kar_fec asc, Kar_Can desc";
            break;
        ...
        case 23:
            ...
            */
            $sql = "SELECT Mes_Cod,mesclas.Pro_Cod,producto.Ite_Cod,Mes_Nom,Mes_Des,Ite_Lar,Ite_Cor,Mes_Max FROM mesclas
