...
require_once("fac_sql_transporte.php");
...
class Class_Log_Conexion_Tra extends MysqlConexion{
...
class Class_Log_Datos_Tra extends MysqlDatos{
	...
	*/
	...
	function InsetPersonaTransporte($sen_Prs,$paramPrs,$sen_Cli,$paramTra)
	{
		/**
		 * Objeto de coneccion
		 * @var Class_Log_Conexion_Cli
		 */         
		$obBD = new Class_Log_Conexion_Tra($_SESSION['Ses_Dat_Dis']);
		 ...
		 */
		$this->grabarv_registros(sentencias_tra($sen_Cli,$this->parametros($paramTra)),$obBD->conexion);
