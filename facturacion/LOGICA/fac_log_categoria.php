...
require_once "fac_sql_categoria.php";
...
class Class_Log_Conexion_Tes extends MysqlConexion {} //Fin de clase Class_Log_Conexion
...
class Class_Log_Datos_Tes extends MysqlDatos
{
    ...
    function consultasobBD($sen_sql, $param, $obBD = null)
    {
        ...
        return $this->consulta(
            sentencias_tes($sen_sql, $Par_Sql),
            $obBD->conexion
        );
    }
     ...
     */
    function cabeceraReporteStandar(
        $sucursal,
        $titulo,
        $subtitulo,
        $obBD = null
        ...
        $row_provincia = $this->getRowConsulta(
            21,
            $row_institucion["Ciu_Cod"],
            $obBD
        );
        ...
        ?>
				<table width="80%" border="0" cellpadding="0" cellspacing="0">
				  <tr align="center">
				    <td width="5%" rowspan="6" valign="top"><img src="<?php echo $row_institucion[
            "Emp_Log"
        ]; ?>" width="83" height="67" /></td>
				    <td width="75%" class="TITULO_REPORTE_2"><?php echo $row_institucion[
            "Emp_Nom"
        ]; ?></td>
				  </tr>
				  <tr align="center">
				    <td valign="top" class="Texto_Reporte"><div align="center"><strong>R.U.C.:</strong> &nbsp;<?php echo $row_institucion[
            "Emp_Ruc"
        ]; ?>&nbsp;		      <strong>TELEFONO:</strong>&nbsp;<?php echo $row_institucion[
    "Suc_Te1"
]; ?></div></td>
			      </tr>
				  <tr align="center">
				    <td valign="top" class="Texto_Reporte"><div align="center"><strong>DIRECCION:</strong>&nbsp;<?php echo $row_institucion[
            "Suc_Dir"
        ]; ?></div></td>
			      </tr>
				  <tr align="center">
				    <td valign="top" class="Texto_Reporte"><div align="center"><strong>E-MAIL:</strong> &nbsp;<?php echo $row_institucion[
            "Suc_Cor"
        ]; ?></div></td>
			      </tr>
				  <tr align="center">
        ...
        if (count($row_provincia) > 0) {
            $provincia =
                " - " .
                $row_provincia["Pro_Nom"] .
                " - " .
                $row_provincia["Pas_Nom"];
        } else {
            $provincia = "";
        }
     ...
     */
    function pieReporteStandar($sucursal, $usuario, $obBD = null)
    {
        /* Consulta de la cabecera del reporte */
        $row_institucion = $this->getRowConsulta(22, $sucursal, $obBD);
