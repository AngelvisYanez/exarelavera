...
<table width="571" height="96%" border="0" align="center">
          <td width="565" height="186" colspan="4" align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
        <tr>
          <td colspan="4" align="center" class="Letra_punto_venta_2"><?Php echo $row_institucion['Emp_Nom'] ?></td>
        </tr>
        <tr>
          <td colspan="4" align="center" class="Texto_normal_10"><div align="center" class="Letra_punto_venta_2"><?Php echo $row_institucion['Suc_Dir'] ?></div></td>
          </tr>
        <tr>
...
<tr>
            <td colspan="4" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
              <tr>
				<!-- TARIFA DEL IVA -->
                <td width="89%" align="right">Tarifa <?=$resultados[6]?>% &nbsp;&nbsp;</td>
              ...
              <tr>
                <td colspan="2" class="Texto_Listados">&nbsp;</td>
              </tr>
            </table>                      
  <tr valign="top">
    <td valign="bottom">
