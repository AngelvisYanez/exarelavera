...
<table width="348" height="100%" border="0" align="left">
<tr>
          <td width="360" height="408" colspan="4" align="left" valign="top">
          <table width="96%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
        <tr>
          <td height="77" align="right" valign="bottom">&nbsp;</td>
          <td valign="bottom">&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td width="13%" height="23" align="right" valign="bottom">
No:</td>
          <td width="47%" valign="bottom">&nbsp;<input name="Vet_Cod" type="hidden" id="Vet_Cod" value="<?Php echo $cliente; ?>" ><?php echo $row_rs_cliente['Vet_Cod']; ?></td>
          <td width="40%" align="right" valign="top">
            <table width="88%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
              <tr>
                <td width="24%" align="right">&nbsp;<?php echo $dia;?></td>
                <td width="36%" align="right">&nbsp;<?php echo $mes;?></td>
                <td width="40%" align="right">&nbsp;<?php echo $anio;?></td>
              </tr>
          </table></td>
          </tr>
        <tr>
...
<tr>
            <td colspan="4" valign="top"><table width="94%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
              ...
              <tr>
                <td height="20" align="right"><!--IVA&nbsp;-->&nbsp;</td>
