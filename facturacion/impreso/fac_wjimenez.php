...
<span style="top:<?php echo $topCab-20;?>px;left:0px;" class="cabecera"><strong>*JIMENEZ RUIZ WELLINGTON RAMIRO*</strong></span>
...
<?php if (!empty($resultados[7]) && floatval($resultados[7]) != 0): ?>
	<span aling="rigth" style="top:<?php echo $posTot+90;?>px;left:110px;" class="flota">Valor Efectivo:</span>
	<span aling="rigth" style="top:<?php echo $posTot+90;?>px;left:210px;" class="flota rigth"><?php echo number_format($resultados[7], 2); ?></span>
	<!-- <span><?php echo number_format($resultados[7], 2); ?></span> -->
<?php endif; ?>
<?php if (!empty($resultados[8]) && floatval($resultados[8]) != 0): ?>
	<span aling="rigth" style="top:<?php echo $posTot+105;?>px;left:110px;" class="flota">Cambio:</span>
	<!-- <span style="text-align: right;" colspan="3">Cambio:</span> -->
	<span aling="rigth" style="top:<?php echo $posTot+105;?>px;left:210px;" class="flota rigth"><?php echo number_format($resultados[8], 2); ?></span>
	<!-- <span><?php echo number_format($resultados[8], 2); ?></span> -->
<?php endif; ?>

<?php if($claveacceso!=''){?>
<span style="top:<?php echo $posTot+125;?>px;left:0px;" class="flota">TIPO DE PAGO:</span>
<span style="top:<?php echo $posTot+140?>px;left:0px;" class="flota"><?php echo $row_pagoSri['Tpc_Sri'].' - '.substr($row_pagoSri['Tpc_Des'],0,28).'&nbsp;&nbsp;'.number_format($resultados[5], 2); ?></span>

<span style="top:<?php echo $posTot+180;?>px;left:0px;" class="flota">DESCARGUE SU COMPROBANTE EN:</span>
<span style="top:<?php echo $posTot+195;?>px;left:0px;" class="flota">http://exa.ofsercont.com/pdf.php</span>
<?php }?>
</div>
</body>
</html>
