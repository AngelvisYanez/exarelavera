...
<body>
    ...
    do{?>
        <span style="<?php echo "top:{$aux}px;left:".getCss($docp,'item_cant','x')."px;width:".getCss($docp,'item_cant','width')."px;" ?>" class="flota number"><?php echo round($row_rs_cliente['Vet_Can'],1);?></span>
        <span style="<?php echo "top:{$aux}px;left:".getCss($docp,'item_desc','x')."px;width:".getCss($docp,'item_desc','width')."px;" ?>" class="flota truncate"><?php echo $row_rs_cliente['Ite_Cor'].' '.$row_rs_cliente['Pro_Obs'];?></span>
        <span style="<?php echo "top:{$aux}px;left:".getCss($docp,'item_prun','x')."px;width:".getCss($docp,'item_prun','width')."px;font-stretch:condensed;line-height: 16px;" ?>" class="flota number"><?php echo number_format($row_rs_cliente['Vet_Pru'], 2);?></span>
    ...
    <?php $aux+=26; }while ($row_rs_cliente = $obBD_con1->fetch_assoc ($rs_cliente));
