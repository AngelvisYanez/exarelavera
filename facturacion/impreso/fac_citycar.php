...
<span style="top:<? echo $topCab-20;?>px;left:0px;" class="cabecera"><strong>*  C I T Y C A R  *</strong></span>
...
<span style="top:<? echo $top+95;?>px;left:0px; font-weight: bold;" class="flota">Detalle&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cant&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Valor&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Total</span>
...
<? $posTot=$aux+80;?>
<span style="top:<? echo $posTot;?>px;left:110px;" class="flota">Descuento:</span>
<span style="top:<? echo $posTot;?>px;left:210px;" class="flota rigth"><?Php echo formato_numero($resultados[4], 2, 1); ?></span>

<span style="top:<? echo $posTot+15;?>px;left:110px;" class="flota">Subtotal:</span>
<span style="top:<? echo $posTot+15;?>px;left:210px;" class="flota rigth"><?Php echo formato_numero($resultados[0], 2, 1); ?></span>
