...
<span style="top:<? echo $top-20;?>px;left:0px;" class="flota">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;** C O R A U T O  ** </span>
<span style="top:<? echo $top;?>px;left:0px;" class="flota">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;COMPROBANTE DE VENTA</span>
<span style="top:<? echo $top+25;?>px;left:0px;" class="flota">CLIENTE:&nbsp;<? if ($row_rs_representante['Cli_Fac'] != ""){echo $row_rs_representante['Cli_Fac'];}else{ echo $row_rs_cliente['Prs_Ape'].' '.$row_rs_cliente['Prs_Nom'];}?></span>
<span style="top:<? echo $top+40;?>px;left:0px;" class="flota">CI:&nbsp;<? if ($row_rs_representante['Cli_Fac'] != ""){echo $row_rs_representante['Cli_Ruf'];}else{echo $row_rs_cliente['Prs_Ced'];}?></span>
<span style="top:<? echo $top+40;?>px;left:145px;" class="flota">FECHA:&nbsp;<? echo $dia.'/'.$mes.'/'.$anio; ?></span>
<? if($claveacceso!=''){?>
<span style="top:<? echo $top+55;?>px;left:0px;" class="flota">CLAVE ACCESO/AUTORIZACION:</span>
<span style="top:<? echo $top+70;?>px;left:0px; text-align: left; width: 270px;" class="flota ca"><? echo $row_rs_cliente['Vet_Xml'];?></span>
<? }?>

<span style="top:<? echo $top+105;?>px;left:0px;" class="flota">DETALLE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CANT&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;P.U.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TOTAL</span>
<span style="top:<? echo $top+115;?>px;left:0px;" class="flota">------------------------------------------</span>
<? $aux=160;
do{?>	
    <span style="top:<? echo $aux; ?>px;left:0px;" class="flota"><? echo $row_rs_cliente['Ite_Cor'].' '.$row_rs_cliente['Pro_Obs'];?></span>
	<span style=" top:<? echo $aux+15; ?>px;left:90px;" class="flota"><? echo formato_numero($row_rs_cliente['Vet_Can'],1,1);?></span>
    <span style="top:<? echo $aux+15; ?>px;left:118px;" class="flota rigth"><? echo number_format($row_rs_cliente['Vet_Pru'], 4);?></span>
...
?>
<span style="top:<? echo $aux+110;?>px;left:0px;" class="flota">------------------------------------------</span>
...
<span style="top:<? echo $posTot;?>px;left:190px;" class="flota rigth"><?Php echo formato_numero($resultados[0], 2, 1); ?></span>

<span style="top:<? echo $posTot+15;?>px;left:110px;" class="flota">Descuento:</span>
<span style="top:<? echo $posTot+15;?>px;left:190px;" class="flota rigth"><?Php echo formato_numero($resultados[4], 2, 1); ?></span>

<span style="top:<? echo $posTot+30;?>px;left:110px;" class="flota">Tarifa 0%:</span>
<span style="top:<? echo $posTot+30;?>px;left:190px;" class="flota rigth"><?Php echo formato_numero($resultados[1]+0, 2, 1); ?></span>

<span style="top:<? echo $posTot+45;?>px;left:110px;" class="flota">Tarifa 12%:</span>
<span style="top:<? echo $posTot+45;?>px;left:190px;" class="flota rigth"><?Php echo formato_numero($resultados[2]+0, 2, 1); ?></span>

<span style="top:<? echo $posTot+60;?>px;left:110px;" class="flota">IVA:</span>
<span style="top:<? echo $posTot+60;?>px;left:190px;" class="flota rigth"><?Php echo formato_numero($resultados[3], 2, 1); ?></span>

<span aling="rigth" style="top:<? echo $posTot+75;?>px;left:110px;" class="flota">TOTAL:</strong></span>
<span aling="rigth" style="top:<? echo $posTot+75;?>px;left:190px;" class="flota rigth"><strong><?php echo number_format($resultados[5], 2); ?></strong></span>
<? if($claveacceso!=''){?>
<span style="top:<? echo $posTot+110;?>px;left:0px;" class="flota">DESCARGUE SU COMPROBANTE EN:</span>
<span style="top:<? echo $posTot+125;?>px;left:0px;" class="flota">http://app.contaduriaonline.com/pdf.php</span>
<span style="top:<? echo $posTot+140;?>px;left:0px;" class="flota">SISTEMA CONTABLE ODIN v1.2</span>
<span style="top:<? echo $posTot+155;?>px;left:0px;" class="flota">CONTRATA ODIN: 0982738458 </span>
<? }?>
</div>
</body>
</html>
