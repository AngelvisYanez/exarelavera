...
<span style="top:150px;left:60px;" class="flota"><?php if ($row_rs_representante['Cli_Fac'] != ""){echo substr($row_rs_representante['Cli_Fac'],0,40);}else{ echo substr($row_rs_cliente['Prs_Ape'].' '.$row_rs_cliente['Prs_Nom'],0,40);}?></span>
<span style="top:179px;left:60px;" class="flota"><?php if ($row_rs_representante['Cli_Dir'] != ""){echo substr($row_rs_representante['Cli_Dir'],0,41);}else{echo substr($row_rs_cliente['Prs_Dir'],0,41);}?></span>
<span style="top:210px;left:120px;" class="flota"><?php if ($row_rs_representante['Cli_Fac'] != ""){echo $row_rs_representante['Cli_Ruf'];}else{echo $row_rs_cliente['Prs_Ced'];}?></span>
<span style="top:237px;left:60px;" class="flota"><?php echo $row_institucion['Ciu_Des'];?></span>
<span style="top:187px;left:475px;" class="flota"><?php echo $dia.'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$mes.'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$anio; ?></span>
...
do{ if($row_rs_cliente['Vet_Obs']!=""){$obs='<strong>OBSERV: </strong>'.$row_rs_cliente['Vet_Obs'];}?>
    ...
    <span style="top:<?php echo $aux; ?>px;left:75px;" class="flota"><?php echo $row_rs_cliente['Ite_Lar'].' '.$row_rs_cliente['Pro_Obs'];?></span>
...
<span style="top:790px;left:50px; text-align: left; width: 350px;line-height: 2.0;" class="flota"><?php echo strtoupper(num2letras(formato_numero($resultados[5], 2,1)));?></span>
...
<span style="top:<?php echo $posTot+140;?>px;left:540px;" class="flota rigth"><!--TOTAL&nbsp;--><strong><?php echo number_format($resultados[5], 2); ?></strong></span>
