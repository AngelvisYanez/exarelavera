...
<span style="top:150px;left:710px;" class="flota"><? echo $Fec_Emi[2].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$Fec_Emi[1].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$Fec_Emi[0]; ?></span>
<span style="top:215px;left:70px;" class="flota"><? echo $row_prin_renta['Prs_Ape'].' '.$row_prin_renta['Prs_Nom']; ?></span>
<span style="top:210px;left:710px;" class="flota"><? echo $row_prin_renta['Prs_Ced']; ?></span>

<span style="top:265px;left:70px;" class="flota"><? echo $row_prin_renta['Prs_Dir']; ?></span>
<span style="top:257px;left:730px;" class="flota"><? echo $row_prin_renta['Ciu_Des']; ?></span>

<span style="top:355px;left:70px;" class="flota"><? echo $row_prin_renta['Tic_Des']; ?></span>
<span style="top:355px;left:370px;" class="flota"><? echo $row_prin_renta['Cop_Num'];; ?></span>
<span style="top:355px;left:700px;" class="flota"><? echo $row_prin_renta['Cop_Fec']; ?></span>

<span style="top:410px;left:30px;" class="flota"><? echo $row_prin_renta['Cop_Aut'];  ?></span>
<span style="top:410px;left:700px;" class="flota"><? echo $row_prin_renta['Cop_Cad']; ?></span>
