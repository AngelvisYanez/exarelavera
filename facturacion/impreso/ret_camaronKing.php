...
<span style="top:130px;left:690px;" class="flota"><? echo $Fec_Emi[2].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$Fec_Emi[1].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$Fec_Emi[0]; ?></span>
<span style="top:170px;left:70px;" class="flota"><? echo $row_prin_renta['Prs_Ape'].' '.$row_prin_renta['Prs_Nom']; ?></span>
<span style="top:180px;left:710px;" class="flota"><? echo $row_prin_renta['Prs_Ced']; ?></span>

<span style="top:215px;left:70px;" class="flota"><? echo $row_prin_renta['Prs_Dir']; ?></span>
<span style="top:215px;left:730px;" class="flota"><? echo $row_prin_renta['Ciu_Des']; ?></span>

<span style="top:280px;left:70px;" class="flota"><? echo $row_prin_renta['Tic_Des']; ?></span>
<span style="top:280px;left:370px;" class="flota"><? echo $row_prin_renta['Cop_Num'];; ?></span>
<span style="top:280px;left:700px;" class="flota"><? echo $row_prin_renta['Cop_Fec']; ?></span>

<span style="top:330px;left:10px;" class="flota"><? echo $row_prin_renta['Cop_Aut'];  ?></span>
<span style="top:330px;left:700px;" class="flota"><? echo $row_prin_renta['Cop_Cad']; ?></span>
...
{ ?>
	...
	<span style="top:<? echo $fila;?>px;left:825px;" class="flota"><? echo $Val_Ret=formato_numero((formato_numero($row['Ret_Bas'],2,1)* $row['Ren_Por'])/100,2,1); $Total_Ret+=$Val_Ret; ?></span>
