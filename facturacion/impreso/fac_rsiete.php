...
<span style="top:<? echo $topCab-20;?>px;left:250px;" class="empres"><strong>  RSIETE CIA. LTDA.</strong></span>
<span style="top:<? echo $topCab+7;?>px;left:190px;" class="cabecera"><strong>  CANTERA RIO SIETE RSIETE CIA. LTDA.</strong></span>
<span style="top:<? echo $topCab+28;?>px;left:260px;" class="cabecera"><? echo "<strong>RUC:</strong> ".$row_institucion['Emp_Ruc']?></span>
<span style="top:<? echo $topCab+49;?>px;left:0px; padding-top: 5px; padding-bottom: 5px; padding-left: 240px; padding-right: 108px; border: 1px solid; background-color: #0000ff;" class="mini"><strong>VENTA DE MATERIALES PETREOS</strong></span>

<!--DATOS NOTA DE ENTREGA-->
<span style="top:<? echo $topCab-15;?>px;left:565px;" class="mini"> <strong>NOTA DE ENTREGA</strong></span>
...
<!--DATOS DE CLIENTE-->
<span style="top:<? echo $top+10;?>px;left:5px;" class="flota"><strong>CLIENTE:</strong>&nbsp;<? echo $row_rs_cliente['Prs_Ape'].' '.$row_rs_cliente['Prs_Nom'];?></span>
<span style="top:<? echo $top+10;?>px;left:385px;" class="flota"><strong>CI/RUC:</strong>&nbsp;<? if ($row_rs_representante['Cli_Fac'] != ""){echo $row_rs_representante['Cli_Ruf'];}else{echo $row_rs_cliente['Prs_Ced'];}?></span>
<span style="top:<? echo $top+30;?>px;left:5px;" class="flota"><strong>DIRECCION:</strong>&nbsp;<? echo $row_rs_cliente['Prs_Dir']?></span>
<span style="top:<? echo $top+30;?>px;left:385px;" class="flota"><strong>CORREO:</strong>&nbsp;<? echo $row_rs_cliente['Prs_Cor']?></span>

<!--ITEMS/PRODUCTOS-->
<span style="top:<? echo $top+50;?>px;left:0px; font-weight: bold; border: 1px solid; padding-left: 25px; padding-right: 25px; padding-top: 2px; padding-bottom: 2px;" class="flota">Cantidad</span>
<span style="top:<? echo $top+50;?>px;left:102px; font-weight: bold; border: 1px solid; padding-left: 125px; padding-right: 125px; padding-top: 2px; padding-bottom: 2px;" class="flota">Material</span>
<span style="top:<? echo $top+50;?>px;left:398px; font-weight: bold; border: 1px solid; padding-left: 48px; padding-right: 48px; padding-top: 2px; padding-bottom: 2px;" class="flota">P.Unitario</span>
<span style="top:<? echo $top+50;?>px;left:550px; font-weight: bold; border: 1px solid; padding-left: 55px; padding-right: 55px; padding-top: 2px; padding-bottom: 2px;" class="flota">Total</span>

<? $aux=$top+80;
do{?>	
		<span style=" top:<? echo $aux; ?>px;left:40px;" class="flota"><? echo formato_numero($row_rs_cliente['Vet_Can'],1,1);?></span>
    <span style="top:<? echo $aux; ?>px;left:130px;" class="flota"><? echo substr ($row_rs_cliente['Ite_Lar'].' '.$row_rs_cliente['Pro_Obs'],0,35);?></span>
		
    <span style="top:<? echo $aux; ?>px;left:465px;" class="flota rigth"><? echo number_format($row_rs_cliente['Vet_Pru'], 4);?></span>
    <span style="top:<? echo $aux; ?>px;left:610px;" class="flota rigth"><? echo number_format($row_rs_cliente['Vet_Imp'], 2);?></span>

<? $aux+=20; }while ($row_rs_cliente = $obBD_con1->fetch_assoc ($rs_cliente));
...
<span style="top:<? echo $aux+165;?>px;left:280px; "class="mini center"><strong>RECIBI<br>CONFORME</strong>&nbsp;</span>
...
<? $posTot=$aux+100;?>
<span style="top:<? echo $posTot;?>px;left:465px;" class="flota rigth">Descuento:</span>
<span style="top:<? echo $posTot;?>px;left:610px;" class="flota rigth"><?Php echo formato_numero($resultados[4], 2, 1); ?></span>

<span style="top:<? echo $posTot+15;?>px;left:465px;" class="flota rigth">Subtotal:</span>
<span style="top:<? echo $posTot+15;?>px;left:610px;" class="flota rigth"><?Php echo formato_numero($resultados[0], 2, 1); ?></span>

<span style="top:<? echo $posTot+30;?>px;left:465px;" class="flota rigth">Tarifa 0%:</span>
<span style="top:<? echo $posTot+30;?>px;left:610px;" class="flota rigth"><?Php echo formato_numero($resultados[1]+0, 2, 1); ?></span>

<span style="top:<? echo $posTot+45;?>px;left:465px;" class="flota rigth">Tarifa <?=$resultados[6]?>%: </span>
<span style="top:<? echo $posTot+45;?>px;left:610px;" class="flota rigth"><?Php echo formato_numero($resultados[2]+0, 2, 1); ?></span>

<span style="top:<? echo $posTot+60;?>px;left:465px;" class="flota rigth">IVA:</span>
<span style="top:<? echo $posTot+60;?>px;left:610px;" class="flota rigth"><?Php echo formato_numero($resultados[3], 2, 1); ?></span>

<span aling="rigth" style="top:<? echo $posTot+75;?>px;left:465px;" class="flota rigth"><strong>TOTAL:</strong></span>
<span aling="rigth" style="top:<? echo $posTot+75;?>px;left:610px;" class="flota rigth"><strong><?php echo number_format($resultados[5], 2); ?></strong></span>
