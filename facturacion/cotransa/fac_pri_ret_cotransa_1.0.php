...
<table width="853"   border="0" align="left">
        <td width="847" height="449" colspan="4" valign="top"><table width="849" height="399" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr>
          <td height="140" >&nbsp;</td>
          <td height="140" >&nbsp;</td>
        ...
        <tr>
          <td width="298" height="50" >&nbsp;</td>
          <td height="56" >&nbsp;</td>
          <td height="56" valign="top" ><table width="99%" height="26" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
            <tr>
              <td width="42%">&nbsp;</td>
        ...
        <tr >
          <td height="13" colspan="2" align="left" valign="middle" class="Letra_punto_venta_2"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
            <tr>
              ...
              <td width="77%"><? echo $row_prin_renta['Prs_Ape'].' '.$row_prin_renta['Prs_Nom']; ?></td>
            </tr>
          </table></td>
        ...
        <tr >
          <td height="67" colspan="3" valign="top" class="Letra_punto_venta_2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr >
          <td height="46" align="left" valign="bottom" class="Letra_punto_venta_2">&nbsp;&nbsp;&nbsp; <? 
		if ($row_rs_renta['Aut_Cod'] != "") 
		{ 
  ...
  <tr valign="top">
    ...
    <table width="807" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2" >
	 <tr align="center">
            <td colspan="6"></td>
          <tr align="center">
		  ...
		  { ?>
          <tr align="center" >
            <td width="65" align="center"  ><?Php $Ejerci=$Eje_Fis[0]; echo $Ejerci; unset($Ejerci);  ?></td>
            <td width="129"   ><?Php $Sri_Cod=$row['Ren_Sri']; echo $obBD_con1->codAir($Sri_Cod); //"&nbsp"  ?></td>
            <td width="209"    ><?Php $Sri_Imp=$row['Ret_Imp']; echo $Sri_Imp;  ?></td>
            <td width="162" align="right"  ><?Php $Ren_Bas = number_format($row['Ret_Bas'], 2,'.',','); echo $Ren_Bas; ?></td>
            <td width="108" align="right">	<?Php $Ren_Por= $row['Ren_Por'].'%'; echo $Ren_Por; ?></td>
