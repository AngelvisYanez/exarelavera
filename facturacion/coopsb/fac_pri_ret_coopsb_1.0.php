...
<table width="853"   border="0" align="left">
        <td width="847" height="157" colspan="4" valign="top"><table width="849" height="153" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr>
          <td height="35" >&nbsp;</td>
          <td height="35" >&nbsp;</td>
          <td height="35" valign="bottom" ><table width="89%" height="26" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
            <tr>
              <td width="42%">&nbsp;</td>
        ...
        <tr >
          <td height="20" colspan="2" align="left" valign="bottom" class="Letra_punto_venta_2"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
            <tr>
              <td width="23%">&nbsp;</td>
              <td width="77%"><? echo $row_prin_renta['Prs_Dir']; ?></td>
            </tr>
          </table></td>
        ...
        <tr >
          <td height="23" colspan="3" valign="top" class="Letra_punto_venta_2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
        </tr>
        <tr>
          <td height="15" align="center" valign="bottom" class="Letra_punto_venta_2" >
		  <? 
		  		if ($row_prin_renta['Tic_Sri']=="3" || $row_prin_renta['Tic_Sri']=="03")
				{
		  			echo "LIQUIDACIÓN DE COMPRAS"; 
				}else{
					echo $row_prin_renta['Tic_Des']; 
				}
		  ?>
          </td>
        ...
        <tr >
          <td height="22" align="left" valign="bottom" class="Letra_punto_venta_2">&nbsp;&nbsp; <? 
		if ($row_rs_renta['Aut_Cod'] != "") 
		{ 
      ...
      <tr valign="top">
    <td  valign="top"><table width="790" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#000000">
	<tr>
    ...
    <table width="784" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2" >
	 <tr align="center">
            <td colspan="6"></td>
          <tr align="center">
          ...
          <tr align="center" >
            ...
            <td width="148" align="right"  ><?Php $Ren_Bas = number_format($row['Ret_Bas'], 2,'.',','); echo $Ren_Bas; ?></td>
...
<?Php }//Fin del foreach ?>
	...
	<tr>
	  <td width="178" height="20" class="Letra_punto_venta_2">&nbsp;</td>
	  <td width="343" align="right">&nbsp;</td>
  	  <td width="109" class="Letra_punto_venta_2" align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>	  
	  <td width="1" class="Letra_punto_venta_2" align="right">&nbsp;</td>
	  <td width="139" align="right" valign="bottom" class="Letra_punto_venta_2"><strong><?Php echo number_format ($Total_Ret, 2,'.',''); ?></strong></td>
	</tr>
	</table>	  
</table>
  </tr>
