...
<table width="341" height="100%" border="0" align="left">
<tr>
          <td width="335" height="193" colspan="4" align="left" valign="top">
          <table width="98%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
        <tr>
          <td width="11%" height="110" align="right" valign="bottom">&nbsp;</td>
          <td colspan="2" valign="bottom" height="18"><?php if ($row_rs_representante['Cli_Fac'] != "")
			{ 
        ...
        <tr>
          ...
          <td width="51%" rowspan="2" align="right" valign="bottom"><table width="89%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
            <tr>
	...
	?>
            <table width="91%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
              <tr>
              ...
              <?php do{?>
              <tr>
                <td width="50" align="left"><div align="left"><?Php echo $row_rs_cliente['Vet_Can']?></div></td>
                <td width="120"><div align="left">&nbsp;<?Php echo $row_rs_cliente['Ite_Lar'].' '.$row_rs_cliente['Pro_Obs']?></div></td>
                <td width="55" align="right"><?Php echo number_format($row_rs_cliente['Vet_Pru'], 2); ?>&nbsp;&nbsp;</td>
                <td width="45" align="right" ><div align="right"><?Php echo number_format($row_rs_cliente['Vet_Imp'], 2); ?></div></td>
              </tr>
              <?Php 
				  /* 
				  * % de Descuento total 
...
<tr>
			...
			<table width="91%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
              <tr>
                <td height="15" align="right"><!--Tarifa 0%-->&nbsp;&nbsp;</td>
                <td align="right"><?Php echo formato_numero($resultados[1]+0, 2, 1); ?></td>
              </tr>
              <tr>
                <td width="68%" align="right"><!--Tarifa 12%&nbsp;-->&nbsp;</td>
                <td width="32%" height="20" align="right"><?Php echo formato_numero($resultados[2]+0, 2, 1); ?></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td height="20" align="right"><?php echo number_format($resultados[5], 2); ?></td>
              </tr>
              <tr>
