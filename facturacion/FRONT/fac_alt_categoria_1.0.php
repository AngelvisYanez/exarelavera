...
if(isset($_POST['hdd']))
{
	...
	{						
		...
		$obBD_con1->operacionobBD(1026,$_POST['Cat_Cdc']."*".$_POST['Cat_Des']."*".$_POST['Cat_Tip']."*".$nivel_actual."*".$Ses_Emp_Cod,$obBD_conexion);
...
{
	$obBD_con1->inicio_transaccion($obBD_conexion->conexion);
	$obBD_con1->operacionobBD(1027,$_POST['Cat_Cod']."*".$_POST['Cat_Des']."*".$_POST['Cat_Tip']."*".$nivel_actual,$obBD_conexion);
	$obBD_con1->fin_transaccion($obBD_conexion->conexion);
}
/**
...
<?php 
    ...
    <?php echo barra_estado($total_nivel+0);?>
    </FIELDSET>
    <br>
    ...
    <tr>
            ...
            <?Php }?>               		
       		<td width="57%"><!-- Boton para regresar a los niveles anteriores -->	    
    <button type="button1" name="button1" onclick="Muestra_Aparecer();" class="btn btn-success fileinput-button" > <i class="icon-plus icon-white"></i> <span>&nbsp;&nbsp;Agregar&nbsp;&nbsp;</span> </button></td>
       </tr>
       </table>
       <br />	
           </td>
			...
			?>
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td width="86%">&nbsp;<input type="text" name="Cat_Cdc" id="Cat_Cdc" value="<?php echo $cadena_codigo; ?>"/>						</td>
					</tr>
					<tr>
