...
<HTML>
    <HEAD>		
        ...
        <TITLE><?php echo "Parametrización Codigos Sri [EXA]"; ?></TITLE>
        <meta charset= "UTF-8">
...
<BODY>
    ...
    <div class="panel panel-main">
        <div class="panel-heading exa-header"><h3 class="panel-title">&raquo;  Modificar codigos SRI</h3></div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <fieldset class="exa-fieldset">
                            <legend class="Titulos2">Buscar Codigo SRI</legend>
                            <form id="empForm" class="form-horizontal normal" action="javascript:$('#list').Search('#empForm','codAjax');$('#formulario').hide().moveComp('#grilla').updateGridsSizes();"> 
                                <div class="form-group">
                                    <label class="col-sm-1 control-label">B&uacute;squeda</label>
                                    <div class="col-sm-4">
                                        <div class="input-group">                        
                                            <input name="search" onkeydown="if (event.keyCode === 13) this.form.submit()" type="text"  placeholder="Ingrese Codigo a buscar..." autofocus="" class="form-control input-sm  clearable submit"><input type="text" style="display:none"/>
                    ...
                    <div class="col-sm-12" style="min-height: 250px;">
                        <fieldset class="exa-fieldset">
                            <legend class="Titulos2">Resultados de la busqueda</legend>
                            <table id="list"></table>
                    ...
                    <div class="col-sm-6">
                        <form id="codForm" class="form-horizontal normal" action="javascript:$.createDialogConfirm(null,null,saveCod)"  > 
                            <input id="Ren_Cod" name="Ren_Cod" type="hidden" />
                            <fieldset class="exa-fieldset">
                            ...
                            <div style="/*padding: 10px;*/">
                                <a onclick="$('#formulario').moveComp('#grilla').updateGridsSizes();" class="btn btn-inverse btn-sm" title="Volver Atrás"><i class="glyphicon glyphicon-arrow-left"></i><span>&nbsp;&nbsp;Atr&aacute;s&nbsp;&nbsp;</span></a><span style="width: 150px;"></span>
                                <button type="subtmit" class="btn btn-success btn-sm" title="Guardar Cambios" > <i class="glyphicon glyphicon-floppy-disk"></i> <span>Guardar</span> </button>
                            </div>
                    ...
                    <div class="col-sm-6">
                        <fieldset class="exa-fieldset">
                            <legend class="Titulos2">Cuentas Contables (Periodo <span id="anio"><?php echo $periodo['Pla_Fec'] ?></span>)</legend> 
                            ...
                            <button id="btnCompra" onclick="tipo='C';$('#cuenDialog').dialog('open');" title="Buscar Cuentas" type="button" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-check"></i><span> Seleccionar Cuenta</span></button>
                            <div style="height: 10px;"></div>
                            <div style="padding-bottom: 5px; min-height: 100px;">
                                <table id="ventas"></table>                               
                            </div>
                            <button id="btnVenta" onclick="tipo='V';$('#cuenDialog').dialog('open');" title="Buscar Cuentas" type="button" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-check"></i><span> Seleccionar Cuenta</span></button>
                        </fieldset>  
                    </div>
                    </div>
                </div>   
