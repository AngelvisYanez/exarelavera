    ...
    if (empty($vendedor['Pun_Cod']) || empty($autoriz['Aut_Cod'])) $resp = array('success' => false, 'message' => "No tiene autorizacion para generar Retenciones!", 'Ret_Num_Old' => 0, 'Ret_Num' => '');
        ...
        if (!empty($Ret_Num)) {
            ...
            if ($num_existe_gencod['total'] * 1 > 0) {
                $resp['success'] = false;
                $resp['message'] = "La Retenci�n N�mero $Ret_Num ya Existe en el Sistema!";
            }
...
if (isset($saveDocument)) {
    ...
    if ($obBD_conIns->Error == 0) {
        ...
        $response = array(
            'success' => true, 'Vet_Impr' => "" . (!empty($reportes[1]) ? "$reportes[1]?Vet_Cod=" : "") . "$Vet_Cod",
...
<BODY>
    <div class="panel panel-main">
        <div class="panel-heading exa-header">
            <h3 class="panel-title ">&raquo; Consultar Despachos</h3>
            ...
            <div id="documentoSearch">
                ...
                <script>
                    ...
                    $('#searchGrid').createGrid({
                            ...
                            height: 270,
                            datatype: "local",
                            caption: 'Resultados <div class="pull-right"><b>ORDENAR POR:</b>&nbsp;<select id="OrderBy"><option value="">No ordenar</option><option value="order by caja_aper.Caj_Fec DESC ">Fecha Venta</option><option value="order by ventas.Vet_Num DESC ">Num. Documento</option><select>&nbsp;</div>',
                            colModel: [{
                            ...
                            loadComplete: function() {
                                $(this).jqGrid('footerData', 'set', {
                                    cliente_per: "<div style='text-align:right;'>TOTAL: </div>",
                                    subtotal: $(this).jqGrid('getCol', 'subtotal', true, 'sum'),
                                    impuesto: $(this).jqGrid('getCol', 'impuesto', true, 'sum'),
                                    ...
                                    <fieldset class="exa-fieldset" id="clieFormTemp">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-7">
                                                ...
                                                <div class="input-group input-group-xs">
                                                    <input name="Prs_Ced" onkeydown="if (event.keyCode === 13) $.SearchOrDialog('#clieDialog',selectCliente);" type="text" placeholder="Ingrese Cliente..." class="form-control input-xs datatrigger clearable dialogSearch" tabindex="1" required="" readonly="readonly" />
                                                    <span class="input-group-btn">
                                                        <button id="Cli_Btn" type="button" onclick="$('#clieDialog').dialog('open');" class="btn btn-success btn-xs" title="Buscar Cliente" tabindex="2" disabled="true"><span class="glyphicon glyphicon-search"></span></button>
                                                        <button type="button" onclick="$('#clieCreateForm').setData({}).find('.validate').find('i').removeAttr('class'); $('#clieCreateDialog').dialog('open');" class="btn btn-success btn-xs" title="Registrar Cliente" tabindex="2" disabled="true"><span class="glyphicon glyphicon-plus"></span></button>
                                ...
                                <div class="col-md-7 col-xs-12">
                                    <fieldset class="exa-fieldset" id="docuFormTemp">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-3">
                                                <input type="text" id="Caj_Fec" name="Caj_Fec" class="form-control input-xs datepickers" readonly>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-6">
                                                <select id="Tic_Cod" name="Tic_Cod" class="form-control input-xs readOnly" required="" readonly="readonly" disabled></select>
                                            </div>
                                            ...
                                            <div class="col-xs-3">
                                                <div class="col-xs-12 input-group input-group-xs">
                                                    ...
                                                    <span id="cambiarAut" class="btn btn-block btn-success input-group-addon " title="Cambiar de Autorizacion" disabled="true">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-5">
                                                <div class="input-group input-group-xs">
                                                    ...
                                                    <input type="text" id="Vet_Num" name="Vet_Num" onchange="validarTic_Cod()" class="form-control input-xs trigger readonly" tabindex="5" required="" data-container="body" data-toggle="popover" / readonly disabled>
                            ...
                            <div class="col-md-7 col-xs-12">
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <button class="btn btn-sm btn-primary" type="button" onclick="$('#formDocumento').formSubmit();" disabled="true"><i class="glyphicon glyphicon-floppy-disk"></i> Guardar</button>
                                    </div>
                                </div>
                            </div>
    ...
    <div id="retDetaDialog" title="Retenci�n">
    ...
    <script>
        ...
        $(function() {
            ...
            $('#retencion').createGrid($.extend(opts, {
                ...
                width: 593,
                responsive: false,
                caption: 'Detalle Retenci�n <button type="button" role="button" tabindex="-1" class="ui-button ui-widget ui-state-default ui-corner-all pull-right" title="Cerrar Ventana" onclick="$(\'#retDetaDialog\').dialog(\'close\')"><span class="ui-button-icon-primary ui-icon ui-icon-closethick"></span></button>'
            }), true);
