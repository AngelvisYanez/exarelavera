...
if(isset($ajax_notif))
{
	...
	?>
        ...
        <script language="javascript">alert("¡Ya exíste el número "+ <? echo $NumFact;?> +"!"); document.getElementById("Vet_Num").selectionStart = 0;document.getElementById("Vet_Num").value='<?php echo $Vet_Num; ?>';</script>
	<?		
	}else{
