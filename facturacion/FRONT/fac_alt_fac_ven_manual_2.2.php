...
if(isset($ajax_notif))
{
	...
	?>
        ...
        <script language="javascript">alert("�Ya ex�ste el n�mero "+ <? echo $NumFact;?> +"!"); document.getElementById("Vet_Num").selectionStart = 0;</script>
	<?		
	}else{
		if($SecIni<=$NumFact && $SecFin>=$NumFact)
		{
			...
			?>
              <img src='../../mascaras/model1/imagenes/32x32/cancel.gif' width='16' height='16' type='image'/>
              <script language="javascript">alert("�N�mero fuera de rango (Rango valido: "+ <? echo $SecIni;?> +" al "+ <? echo $SecFin;?> +")!"); 
...
{	
	...
	if($total_rs_buscaAutori==1)
	{
		...
		$correcto=0;
		?><script language="javascript">alert("�No hay Autorizaci�n para la fecha ingresada!");</script> <?
	}
}
