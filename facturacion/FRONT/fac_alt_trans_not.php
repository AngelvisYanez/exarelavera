...
//obtenemos el detalle de la nota de Entrega
...
<BODY>
    ...
    <div class="panel panel-main">
        <div class="panel-heading exa-header"><h3 class="panel-title">&raquo;  Gestion de Notas de Entrega</h3></div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">  
                        <fieldset class="exa-fieldset">                           
                           <legend class="Titulos2">Facturar Notas de Entrega</legend> <!-- Form Name -->
                          <div class="row">
                               ...
                               <fieldset class="exa-fieldset clienteFact">                           
                                ...
                                <!-- Text input-->
                                    ...
                                    <div class="form-group">
                                      <label class="col-xs-2 control-label label-xs required" for="cliente">C&eacute;dula/R.U.C:</label>  
                                      <div class="col-xs-6">
                                            <div class="input-group input-group-xs">                                                
                                                ...
                                                <span class="input-group-btn">
                                                    <button class="btn btn-success" onclick="$('#cliFactDialog').dialog('open');" type="button"><span class="glyphicon glyphicon-search" title="Buscar Clientes"></span></button>
                                                </span>
                                            </div><!-- /input-group -->                                          
                                ...
                                <legend class="Titulos2">Datos de la Factura</legend> <!-- Form Name -->                                    
                                    ...
                                    <div class="form-group">  
                                      ...
                                      <div class="col-md-7 msgDiv">
                                        ...
                                        <?php }else{ ?>
                                        <img class="imgMsg" src="../../mascaras/model1/imagenes/32x32/cancel.gif"><label class="lblMsg">No tiene <b>Autorizacion</b> para Facturar en <b><?php echo $hoy; ?></b></label>
                                        <?php } ?>
                                      </div>
                                    </div> 
       ...
       <script>                                
            $(document).ready(function () { 
                ...
                $("#items").jqGrid({
                     ...
                     colModel:[
                             {name:'Pro_Cod',label:'Cod. Int', width:60, sorttype:"int",align:'center'},
                             {name:'Iva_Cod',label:'CodIva', width:20,hidden:true},
                             {name:'Ite_Lar',label:'Producto', width:100},                                                 
                             ...
                             {name:'Pro_Obs',label:'Observacion', width:120}        
                     ],
                     pager: "#pitems",
                     footerrow:true,
            ...
            $('#For_Cod').on('change',function ()
            {
                ...
                $.get('<?Php echo filter_input(INPUT_SERVER, 'PHP_SELF', FILTER_SANITIZE_STRING); ?>',{tiposPago:true, For_Cod:codigo}, function(response){
                 ...
                 setCuenta(Pec_Val);
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-6">
                                            <div class="input-group input-group-xs">                                                
                                                ...
                                                <span class="input-group-btn">
                                                    <button class="btn btn-success" onclick="$('#cliDialog').dialog('open');" type="button"><span class="glyphicon glyphicon-search" title="Buscar cliente"></span></button>
                                                    <button class="btn btn-danger" onclick="setCliente({});" type="button"><span class="glyphicon glyphicon-new-window" title="Quitar cliente"></span></button>
                                                </span>
                                            </div><!-- /input-group -->                                          
                                        </div>
                                    </div>
                                     ...
                                     <div class="col-sm-9">                                        
                                          ...
                                          <label class="col-xs-2 control-label label-xs " for="Tic_Cod">Documento:</label>
                                            ...
                                            <div class="col-xs-6">
                                                <select name="Tic_Cod" id="Tic_Cod" class="form-control input-xs" required onchange="this.form.submit()">
                                                  <?Php
                                                  foreach($row_tipo_compr as $row)
                                                  { if($row['Tic_Cod']=='32'){ $Tic_Cod=$row['Tic_Cod'];?>
                                                  <option  <?Php if ($Tic_Cod == $row['Tic_Cod']){ echo "selected"; } ?> value="<?Php echo $row['Tic_Cod']; ?>"><?Php echo $row['Tic_Des']; ?></option>
                                                  <?Php
                                                  }}
                                                  ?>
                                        ...
                                        <div class="form-group">  
                                         ...
                                         <div class="col-md-3" style="padding-top: 10px;">
                                          <div class=""><button type="button"  onclick="this.form.submit()" class="btn btn-sm btn-success" title="Buscar"><span class="glyphicon glyphicon-search"></span> &nbsp;Filtrar</button></div>
                                      </div>
                                </fieldset>
                                <fieldset class="exa-fieldset">
                                    <!-- Form Name -->
                    ...
                    <div class="col-sm-12">  
                        <fieldset class="exa-fieldset">                           
                           <legend class="Titulos2">Listado de Notas de Entrega</legend> <!-- Form Name -->
                           <table id="list"></table>
                           <div id="listPager"></div>
                        </fieldset>
                        <div style="" class="">                            
                            <button type="button" class="btn btn-sm btn-primary start" onclick="send();" title="Gestionar Notas de Entrega"> <span class="glyphicon glyphicon-floppy-open"></span>&nbsp; <span>Facturar Notas de Entrega</span></button>
                    ...
                    $(document).ready(function () { 
                        ...
                        compGrid=$("#list").createGrid({                           
                            colModel: [                               
                                { label: 'Cod.Int.', name: 'Vet_Cod', key: true, hidden:true,viewable:true }, 
                                { label: 'Fecha', name: 'Caj_Fec',align:"center", width: 40  },  
                                { label: 'C&eacute;dula/R.U.C.', name: 'Prs_Ced', width: 55, align:"center", classes:'bgNoRight'},
                                { label: 'Cliente', name: 'cliente', width: 100, classes:'bgNoRight'},
                                { label: 'Observaci&oacute;n', name: 'Vet_Obs', width: 80, classes:'bgNoRight'},
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            let model=[
                { label: 'Cod.Int.', name: 'Cli_Cod', key: true,hidden:true,viewable: true },                
