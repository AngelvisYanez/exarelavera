...
<HTML>
	<HEAD>		
                ...
                <TITLE><?Php echo "Prod. Form. Consultar [EXA]"; ?></TITLE>
                <meta charset= "UTF-8">
...
<BODY>
    ...
    <div class="panel panel-main">
        <div class="panel-heading exa-header"><h3 class="panel-title">&raquo;  Consultar Formulas/Mesclas</h3></div>
                             ...
                             $(document).ready(function () {
                                ...
                                kardexGrid.jqGrid({
                                    ...
                                    colModel: [                               
                                        ...
                                        { label: 'Descripci�n', name: 'Mes_Des', width: 200  }, 
