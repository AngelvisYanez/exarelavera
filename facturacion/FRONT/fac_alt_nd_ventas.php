                ...
                <div class="row">
                          ...
                          <div class="row">
                           ...
                           <fieldset class="exa-fieldset">                           
                                <legend class="Titulos2">Datos de La Factura</legend> <!-- Form Name -->
                                    ...
                                    <!-- Textarea -->
                                    <div class="form-group">
                                      <label class="col-sm-2 control-label" for="Vet_Obs">Observación:</label>
                                      <div class="col-sm-10">                     
                           ...
                           <script>                                
                              ...
                              function setCuenta(value){
                                  ...
                                  $.get('<?Php echo filter_input(INPUT_SERVER, 'PHP_SELF', FILTER_SANITIZE_STRING); ?>',{cuentas:true,Pla_Cod:periodo[1]}, function(response){
                                         ...
                                         <div class="col-sm-9">                                        
                                            ...
                                            <div class="form-group">  
                                              ...
                                              <div class="col-md-3" style="padding-top: 10px;">
                                                  <div class=""><button type="button"  onclick="this.form.submit()" class="btn btn-sm btn-success" title="Ejecutar BÃºsqueda"><span class="glyphicon glyphicon-search"></span> &nbsp;Filtrar</button></div>
                                              </div>
                                    </fieldset>
                    ...
                    <script>
                        ...
                        compGrid.jqGrid({
                            ...
                            colModel: [                               
                                { label: 'CÃ³d.Int.', name: 'Vet_Cod', key: true, hidden:true,viewable:true }, 
                                ...
                                { label: 'Cédula/R.U.C.', name: 'Prs_Ced', width: 55, align:"center"},
                                { label: 'Cliente', name: 'cliente', width: 100},
                                { label: 'Observación', name: 'Vet_Obs', width: 80},
                            ...
                            subGridRowExpanded: function(subgrid_id, row_id) {
                                ...
                                $("#"+subgrid_table_id).jqGrid({
                                        ...
                                        colModel: [
                                                ...
                                                {label:'ObservaciÃ³n',name:"Pag_Obs",width:100},
...
//                            });
    ...
    <div id="cliDialog" title="Búsqueda de Clientes">  
