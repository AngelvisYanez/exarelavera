            ...
            foreach ($pagos as $pag) {
                ...
                if ($pag['Forma_Cod'] * 1 == 2) {
                    if (!empty($editDoc['Cpc_Cod'])) {
                        ...
                        /* Total a registrar incluyendo retención */
                        $totalReal = $pag['Vet_Tot'] + $Ren_Tot;
                        /* Inserta línea DEBE por el total en cuenta del pago */
...
<HEAD>
    ...
    <script type="text/ecmascript" src="../VALIDACIONES/fac_val_factura.js?a=23">
    </script>
    <script>
        edit_reten = true;
        inicializarDocVenta();
