...
<label class="Titulos2">Resultados de la busqueda</label>
	...
	$num_row_rs_existe_pagos=0;
		...
		if(true)
		{
			...
			<?  }else{ $existe_pagos++;
				?><img src="../../mascaras/model1/imagenes/32x32/fac_ele.jpg" title="Factura electr&oacute;nica Autorizada" width="22" height="22"><?  
			    }			
			}else{ $existe_pagos++;
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" >
        ...
        <tr>
          ...
          <td class="Etiqueta1"><div align="left">
            <input name="Num_Aut" id="Num_Aut" type="text"  size="40" maxlength="49" value="<? echo $row_rs_cliente['Ret_Aut'];?>"  align="right" />
          </div></td>
        </tr>
        <tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" >
  <tr>
	...
	<?	foreach($rs_factForPagSri as $row)
		{ ?>
		  <option <? if ($row['Tpc_Cod']==$rs_cliente[0]['Tpc_Cod']){echo "selected";}?> value="<?Php echo $row['Tpc_Cod'];?>"><?Php echo $row['Tpc_Sri'].'  -  '.$row['Tpc_Des'];   ?></option>
		  <?Php 
		} //Fin del foreach
		?>
		</select>      
