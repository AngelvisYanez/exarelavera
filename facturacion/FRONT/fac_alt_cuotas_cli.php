 ...
 */
 ...
 /* Creacion del objeto mysql para las consultas */
     ...
     */
    if (isset($ventasAjax)) {
    $datos = array_merge($_GET, array('setWhere' => array('isActive','setTotales','setAliCuotas'/*'aliPagosGeneral'*//*,'byAliPagos'*//*,'addNumeroVenta'*/,'isTicCod0'/*'byTicCod'*/,'groupByAliCod'/*'setAliPagos'*//*,'addVerificaSaldo'*/)));
    ...
    if(isset($searchAllFacVentas)){
        ...
        if(trim($data['letra']) == 'Por Pagar'){$datos = array_merge($_GET, array('setWhere' => array('isActive','setTotales','setAliCuotas'/*'aliPagosGeneral'*//*,'byAliPagos'*//*,'addNumeroVenta'*/,'isTicCod0'/*'byTicCod'*/,'groupByAliCod'/*'setAliPagos'*//*,'addVerificaSaldo'*/,/*'hasSaldo'*//*'isSaldo'*/),'having'=>'Resto>0')); }
...
<HEAD>
	<TITLE> <?php echo "CONTROL ALICUOTAS [EXA]"; ?></TITLE>
                                                ...
                                                <fieldset class="exa-fieldset">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-5 radioset">
                                                            <input id="rad_ba1" name="op_opciones" type="radio" value="k" checked="" onclick="setfocus(this.form.search)"/><label for="rad_ba1">&nbsp;&nbsp;Cliente&nbsp;&nbsp;</label>
                                                            <input id="rad_ba2" name="op_opciones" type="radio" value="d" onclick="setfocus(this.form.search)"/><label for="rad_ba2">&nbsp;&nbsp;Factura&nbsp;&nbsp;</label>
                                                            <input id="rad_ba3" name="op_opciones" type="radio" value="f" onclick="setfocus(this.form.search)"/><label for="rad_ba3">&nbsp;&nbsp;Por Fecha&nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-xs-8" >
                                                            <div class="input-group">
                                                                ...
                                                                <span class="input-group-btn"><button id="btnSearch" type="button" onclick="this.form.submit()" class="btn btn-success btn-xs" title="Buscar Factura"  tabindex="-1"><span class="glyphicon glyphicon-search"></span> <span>Buscar</span></button></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </fieldset>
		 ...
		 cellpadding="3" border="1" class="noBorder">
			<thead>
				<tr>
					...
					<th style="width:60%;" align="center">Descripci�n</th>
	...
	<script src="../VALIDACIONES/fac_val_alicuotas.js?k=199"></script>
