  	...
  	<td  align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" >
  	  <tr>
  	    <td colspan="6" align="center" class="LetraPlan"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  	      <tr>
  	        <td width="21%" align="left"><img src="<?php echo $Ses_Emp_Log;?>" width="90" height="80"></td>
  	        <td width="79%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  	          <tr>
  	            <td align="left" class="tituloFact"><strong><?php echo $Ses_Emp_Cor;?></strong></td>
	            </tr>
  	          <tr>
  	            <td align="left" class="tituloFact2"><?php echo strtoupper($Ses_Emp_Nom);?></td>
	            </tr>
  	          <tr>
  	  ...
  	  <tr>
  	    <td colspan="6" align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  	      <tr>
  	        ...
  	        <td width="86%" class="etiquetaFact">&nbsp;<?php echo $claveacceso;?></td>
	        </tr>
	      </table></td>
	    </tr>
  	  <tr>
				...
				?>
  	            ...
  	            <tr>
  	              <td height="100" valign="bottom"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="etiquetaFact">
  	                ...
  	                <tr>
  	                  <td align="left">&nbsp;<strong>Forma de Pago:</strong> <?php echo strtoupper($row_rs_formapago['Tpc_Des']);?></td>
  	                  <td align="right">Iva:&nbsp;</td>
  	                  <td align="right"><?Php echo formato_numero($resultados[3], 2, 1); ?>&nbsp;</td>
	                  </tr>
  	                <tr>
  	                  <td width="73%" align="left">&nbsp;<strong>Nota:</strong> Descargue su Factura Electr&oacute;nica en:  &nbsp;&nbsp;exa.ofsercont.com/facturacion/FRONT/electronica.php?Emp_Cod=<?php echo $Ses_Emp_Cod;?>&Prs_Cod=<?php echo $row_rs_cliente[0]['Prs_Cod'];?></td>
