...
if($Ses_Suc_Cod=='6' && $Ses_Prs_Cod=='1')
{
	//$Cop_Cod='1';
...
onChange="if(this.value==4){document.getElementById('NotasCredito').className = 'muestra';}else{document.getElementById('NotasCredito').className = 'oculta'} ;ajax_datos('<?Php echo $_SERVER['PHP_SELF']; ?>?ajax_con_numcom=1&Prv_Cod=' + document.getElementById('Prv_Cod').value +'&Cop_Num=' + document.getElementById('Cop_Num').value +'&Tic_Cod=' + this.value,'div_con_num_com'); ">
 ...
 <table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
   ...
   onBlur="if (document.getElementById('Cop_Aut').value!=''){ numerico(this); minimo_maximo(this, '10','37');}" onkeypress="Ent_Sub();">
      <label></label>
      </span></td>
	...
	?>
    <td width="480" valign="bottom" class="LetraNegra"><input name="Cop_Fec" type="text" id="Cop_Fec" value="<?php echo $row_rs_periodo['Ann'].'-'.$ann[1].'-'.$ann[2]; ?>" size="10" onKeyUp="mascara(this,'-',patron,true)" onBlur="validar_fecha2(this);" onkeypress="Ent_Sub();">      <img src="../../mascaras/model1/imagenes/32x32/info.gif"  title="Fecha de la emision del documento por el Proveedor" /></td>
  </tr>
  <tr>
    ...
    <td class="LetraNegra"><input name="Cop_Imp" type="text"  id="Cop_Imp" value="" size="10" onkeyup="mascara(this,'-',patron,true)" onBlur="validar_fecha2(this);" onkeypress="Ent_Sub();"/> 
	  <img src="../../mascaras/model1/imagenes/32x32/info.gif" title="Fecha de creacion del documento en la imprenta" /></td>
    </tr>
    <tr>
  <td  rowspan="2" class="Etiqueta1">Observaci&oacute;n: </td>
  <td rowspan="2"><textarea name="Cop_Obs" cols="35" rows="3" id="Cop_Obs" style="text-transform:uppercase" onkeypress="Ent_Sub();" ></textarea></td>
  ...
  <td>
        ...
        <input name="Cop_Cad" type="text" id="Cop_Cad" value="" size="10" onKeyUp="mascara(this,'-',patron,true)" onblur="validarCaducidad(this, '<?Php echo $hoy; ?>'); validar_fecha2(this);" onkeypress="Ent_Sub();"></div>        
         </td>
    ...
    <tr>
      ...
      <td><input name="Com_Fec" type="text" id="Com_Fec" value="<?Php echo $hoy; ?>" size="10" onKeyUp="mascara(this,'-',patron,true)" onBlur="validar_fecha2(this);" onkeypress="Ent_Sub();"> 
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="">
	...
	<tr class="Cabecera1" height="35">
		...
		<th width="8%"><span class="Asterisco">*</span> Cuenta</th>
	     <th width="1%"></th>
		 <th width="13%">Descripci&oacute;n</th>
		 <th width="6%">Renta</th>
		 <th width="1%">&nbsp;</th>
		 <th width="1%">&nbsp;</th>
		 <th width="5%">IVA</th>
...
<?Php include('../COMPONENTES/tesComChequesCompra.php'); ?>
<?php }?>
<br>
