...
<HTML>
    <HEAD>
        ...
        <script type="text/ecmascript" src="../VALIDACIONES/fac_val_not_ent.js?x=0">
        </script>
        <script>
...
<BODY>
    <div class="panel panel-main">
        <div class="panel-heading exa-header"><h3 class="panel-title ">&raquo; Modificar Despachos</h3><p id="cabeceraPuntoImp" class="text-right col-xs-12  " style="margin-top:-15px;">punto de impresion</p></div>
                        ...
                        <div class="col-xs-6">
                            <fieldset class="exa-fieldset">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-2" >
                                        <select id="estado" name="estado" class="form-control input-xs search_pec">
                                           <option value="">TODAS</option>
                                           <option value="U">Facturadas</option>
                                           <option value="A">Por facturar</option>
                                        </select>
                                    </div>
                                </div>
                            </fieldset>
                    ...
                    function cargarDoc(doc){
                        ...
                        $('#searchGrid').createGrid({
                            ...
                            colModel: [
                                ...
                                { label: 'SubTotal', name: 'subtotal', width: 35, align: "right"},
                                { label: 'IVA', name: 'impuesto', width: 35, align: "right"},
                                { label: 'Total', name: 'total', width: 35, align: "right"},
                                { label: 'Estado', name: 'Vet_Est', width: 25,align:"center", formatter:'estado', title:false },
                            ...
                            loadComplete: function(data){
                                ...
                                for(var i=0,z=data.rows.length;i<z;i++){
                                    //if(data.rows[i]['Vet_Est'] ==='I') $("#"+data.rows[i].Vet_Cod+' td:not(.jqgrid-rownum)').addClass('cellOrange1');
                                    if(data.rows[i]['Vet_Est'] ==='U') $("#"+data.rows[i].Vet_Cod+' td:not(.jqgrid-rownum)').addClass('cellGreen2');
                                    ...
                                    <div class="col-md-7 col-xs-12">
                                        <fieldset class="exa-fieldset" id="docuFormTemp">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-6" >
                                                    <select id="Tic_Cod" name="Tic_Cod" class="form-control input-xs " required="">
   ...
   <script type="text/javascript">
    ...
    <div id="codiDialog" title="B&uacute;squeda de Cédigos Retención">
