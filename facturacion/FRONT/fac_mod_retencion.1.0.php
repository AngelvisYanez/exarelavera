...
/** Actualizacion de datos de la retenci�n ********************************************************/
if(isset($hdd_save))
{
...
/** Cargado de los porcentajes d retenci�n *******************************************************************************************/
if(isset($Ret_Cod))
{
	/** Consulta los datos de la retenci�n a modificar ***********************************************/
...
/** Cargado de Iva Renta atrav�s de AJAX ********************/	
	if (isset($codigoret))
 {
...
<table width="495" border="0">
  ...
  <table width="495" height="36" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td width="90" height="28" class="BarraBusqueda"><div align="right"><span class="Asterisco">* </span>B�squeda:</div></td>
...
<table width="561" border="0">
  <tr>
    <td width="57" class="Etiqueta1">C�dula:</td>
  ...
  <tr>
    <td width="57" class="Etiqueta1">Direcci�n:</td>
...
<FIELDSET>
<LEGEND>
<label class="Titulos2">Detalle de la retenci�n </label>
</LEGEND>
