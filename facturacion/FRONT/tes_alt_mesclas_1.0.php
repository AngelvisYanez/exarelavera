...
<HTML>
	<HEAD>		
                ...
                <TITLE><?Php echo "Prod. Form. Registrar [EXA]"; ?></TITLE>
                <meta charset= "UTF-8">
...
<BODY>
    ...
    <div class="panel panel-main">
        <div class="panel-heading exa-header"><h3 class="panel-title">&raquo;  Crear Formulas/Mesclas</h3></div>
                        ...
                        <fieldset class="exa-fieldset">                           
                           <legend class="Titulos2">Datos de la Formula:</legend> <!-- Form Name -->
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-9">   
                                  <input name="Mes_Nom" type="text" value="" class="form-control input-xs" required="" />                                                             
                              </div>                                  
                            </div>
                            <!-- static input-->
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-xs-3">    
                                  <input type="text" id="Mes_Max" name="Mes_Max" class="form-control input-xs" style="text-align:right" value="1" required="" />
                              </div>  
                              <div class="col-xs-3">                                    
