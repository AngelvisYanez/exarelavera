...
require_once('../LOGICA/fac_log_factu_prueba.php');
...
<HTML>
    <HEAD>		
        ...
        <script type="text/ecmascript" src="../VALIDACIONES/fac_val_factu_prueba.js?x=49999"></script>
        <style>
