...
{	
	...
	elseif ($op_opciones == "r") //por numero venta
	{
	...
	elseif($op_opciones == "c") // por cedula. Esta busqueda no tiene restrincion de puntos de impresion
	{		
	...
	*/
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
	  ...
	  <tr>
	    ...
	    <td colspan="3" class="LetraNegra">&nbsp;<span id="CliCli"><?Php echo $rs_cliente[0]['Prs_Ape'].' '.$rs_cliente[0]['Prs_Nom']; ?></span>
