...
switch ($op){
	/* 
	* Impresión de reporte individual del reporte de la factura 
	*/
	case 2:	
		/* 
			...
			?>
				<table width="100%" border="1" cellpadding="0" cellspacing="0">
				  <tr class="TablaRepCompr">
			        ...
			        <td class="TablaRepCompr" width="8%" align="center">No. Documento</td>
			        <td class="TablaRepCompr" width="10%" align="center">No. Retenci&oacute;n                                        
				  	<td class="TablaRepCompr" width="10%" align="center">Fecha 
		  		    <td class="TablaRepCompr" align="center">C&eacute;dula/R.U.C.</td>
		  		    <td class="TablaRepCompr" align="center">Cliente</td>
		  			<td width="8%" class="TablaRepCompr" align="center">SubTotal</td>
		  			<td width="8%" class="TablaRepCompr" align="center">Descuento</td>
		  			<td width="8%" class="TablaRepCompr" align="center">Iva </td>
		  			<td width="8%" class="TablaRepCompr" align="center">Total</td> 
		  		  </tr>
				    <?Php 
					/* 
...
<tr class="Texto_Reporte">
					    	  ...
					    	  <td align="center">&nbsp;</td>
					    	  <td align="center">&nbsp;</td>
					    	  <td align="right" class="fixedHeader02">&nbsp;</td>
					    	  <td align="right" class="fixedHeader02"><strong>TOTALES:</strong></td>
					    	  <td align="right" class="fixedHeader02"><b><?Php echo formato_numero($total_imp,2,2);?></b></td>
					    	  <td align="right" class="fixedHeader02"><b><?Php echo formato_numero($total_des,2,2);?></b></td>
					    	  <td align="right" class="fixedHeader02"><b><?Php echo formato_numero($total_iva,2,2);?></b></td>
					    	  <td align="right" class="fixedHeader02"><b><?Php echo formato_numero($total_tot,2,2);?></b></td>
		    	  </tr>	                        
		  		</table>
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
                  <tr class="Texto_Reporte">
...
if (isset($hdd))
{
	...
	{		
		?>
			...
			<table width="100%" border="1" cellpadding="0" cellspacing="0">
			  <tr class="TablaRepCompr">
				<td class="TablaRepCompr" align="center" width="4%">C&oacute;d. Int.</td>
				<td class="TablaRepCompr" align="center" width="8%">No. Documento</td>
				<td width="10%" class="TablaRepCompr" align="center">Fecha 
				<td class="TablaRepCompr" align="center">Cliente</td>
				<td class="TablaRepCompr" align="center">Detalle</td>
				<td class="TablaRepCompr" align="center">Total</td> 
			  </tr>
				<?Php 
				/* 
				* Consulta el total de todas las facturas 
				*/
				...
				do { 
					...
					?> 
						<tr class="Texto_Reporte">
						  <td align="center" valign="top" width="10%"><?php echo $row_rs_buscarcarrera['Vet_Cod']; ?></td>
						  <td align="center" valign="top" width="10%"><?php echo $row_rs_buscarcarrera['Vet_Num']; ?></td>
						  <td valign="top" align="center" width="15%"><?php echo $row_rs_buscarcarrera['Caj_Fec']; ?></td>
