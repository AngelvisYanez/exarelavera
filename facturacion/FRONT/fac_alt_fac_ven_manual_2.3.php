...
<HTML><HEAD>
    ...
    <BODY <? if (isset($total_rs_vendedor)&&$total_rs_vendedor > 0){if ($total_rs_apercaja > 0){if ($total_rs_autorizaci > 0){if ($Vet_Num <= $row_rs_autorizaci['Aut_Fin']){ /*if ($codigo > 0){ */ ?> onLoad="setInterval('parpadeo(\'txt_blink\')',700);"<? /*}*/}}}}?> >	
    <div id="set1">
<?Php //
/** 
...
<tr>
   ...
   <? if($correcto==1){?>	
	<form action="<? echo $_SERVER['PHP_SELF']; ?>" method="post" name= "form1" id="form1">
     ...
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td align="center"><? if(($Ses_Dat_Dis!='agronuevo')&& !isset($hdd_volver)  && isset($hdd_save)){echo "<br><span class='Texto_grande' style='color:blue;'>".mes($mese[1],1)."</span><br><span class='Texto_grande'><b style='color: darkgoldenrod;'>Cod:</b> ".$Vet_Cod."</span>";}?></td>
                </tr>
                </table>  
