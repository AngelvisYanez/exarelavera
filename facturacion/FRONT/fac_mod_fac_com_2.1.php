    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td colspan="3" align="left">   
          ...
          <input name="Cop_Nns" type="text" id="Cop_Nns" value="<? echo str_replace('-','',$CopNns);?>" size="15" maxlength="20" />
        </td>
        </tr>
      <tr>
        ...
        <td colspan="3" align="left"><span class="LetraNegra">
          <input name="Cop_Nna" type="text" id="Cop_Nna"  size="38" value="<? echo $Cop_Nna;?>" maxlength="37" />
        </span></td>
        </tr>
    </table>    
	<script language="javascript">
