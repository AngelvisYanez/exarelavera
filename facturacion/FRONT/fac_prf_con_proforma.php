...
if(isset($profDetalleAjax)){
    $resProformas=array(
        'success' => true,
        'todasPrf'=>$obBD_con1->getArrayConsultaSql("select prfd.Prf_Cod, prfd.Pfd_Int, prfd.Pro_Cod, prfd.Prf_Imp,  prfd.Prf_Cant, prfd.Prf_Pru, prfd.Iva_Cod, prf.Prf_Cod, prf.Prf_Des,prf.Prf_Num, prf.Prf_Obs, prd.Pro_Cod, prd.Ite_Cod, iv.Iva_Cod, iv.Iva_Por, iv.Iva_Ini, iv.Iva_Fin, itm.Ite_Cod, CONCAT(itm.Ite_Lar,' ', prfd.Prf_Adi) AS Ite_Lar, prfd.Prf_Adi  from proformas_det prfd, proformas prf, producto prd, item itm, iva iv WHERE prf.prf_cod=prfd.prf_cod AND prfd.Pro_Cod=prd.pro_cod AND prd.ite_cod=itm.ite_cod and iv.Iva_Cod=prfd.Iva_Cod and prfd.Prf_Cod='$Prf_Cod';", $obBD_conexion),
...
$tituloImp= 'Proforma N�- '.($numActualProf['total'] + 1);
		...
		<div id="datosPrf" class="box-container">
			...
			<table style=" width: 700px;font-size: 12px;border-collapse: collapse;" border="1">
				...
				<tr style="height: 40px;">
					<td>
						<div id="Prf_Obs" align='left' style="padding: 5px; overflow: hidden; word-wrap: break-word; width: 600px;" name="Prf_Obs" class="form-control input-xs databind datatitle bold"></div>
					</td>
					<td>
