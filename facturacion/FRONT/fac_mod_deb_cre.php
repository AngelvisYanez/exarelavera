...
if(isset($docDetalle)){
    ...
    if(!empty($Cop_Cod)){
        ...
        foreach ($resp['items'] as $r)
            if($r['Iva_Por']*1>0){ $resp['Iva_Cod']=$r['Iva_Cod']; break; }
...
if(isset($saveDocument)){
    ...
    try{
        ...
        $obBD_ins1->operacionobBD(11, $Tic_Cod.'*'.$Prv_Cod.'*'.$Ciu_Cod.'*'.trim($Cop_Num).'*'.trim($Cop_Aut).'*'.$Cop_Fec.'*'.$hoy.'*'.trim($Cop_Obs).'*'.$Cop_Cad.'*'.$Cop_Imf.'*'.$Tri_Cod.'*'.$Cop_Des.'*'.$Pec_Cod.'*'.(isset($Tpc_Cod)?$Tpc_Cod:'').'*'.$Cop_Ntd.'*'.$Cop_Nns.'*'.$Cop_Nna.'*'.$Vnd_Cod.'*'.$Cop_Sec.'*'.'**'.$Cop_Cod, $obBD_conexionIns);  
        ...
        foreach($array_kardex AS $i =>$k){
            $k['Kar_Int']=$i+1;
            $obBD_ins1->updateStockProd($Ses_Suc_Cod, $k, true, $obBD_conexion,$obBD_conexionIns);   
        } 
...
<BODY>
    <div class="panel panel-main">
        <div class="panel-heading exa-header"><h3 class="panel-title">&raquo; Modificar Notas de Cr&eacute;dito/D&eacute;bito</h3></div>
            ...
            <div id="documentoSearch">
                ...
                <script>
                    ...
                    function editDocument(doc){  
                        ...
                        $.getDataJson('',{docDetalle:true,Cop_Cod:doc['Cop_Cod'],Com_Cod:doc['Com_Cod'],Cop_Fec:doc['Cop_Fec']},function(resp){
                            selectModDoc();
                    ...
                    $(function() { 
                        $(function() { 
                            ...
                            $('#docDetaDialog').createDialog({height:300,width:600,noTitleStuff:false,noBorder:true});
                        });
                    });    
                    ...
                    <div class="row">
                        <div class="col-xs-5">
                            ...
                            <fieldset class="exa-fieldset" id="modiFormTemp">
                                ...
                                <div class="form-group">
                                    <label class="col-xs-2 control-label label-xs required">Autorizaci&oacute;n:</label>  
                                    <div class="col-xs-10" >
                                        <div class="input-group input-group-xs"> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-3">
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-addon input-xs" title="Fecha de Emisi&oacute;n del Proveedor"><i class="glyphicon glyphicon-info-sign blue"></i></span>
                                            </div>
                                        </div>    
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <label class="col-xs-2 control-label label-xs required">Impresi&oacute;n:</label>  
                                        <div class="col-xs-3">
                                            <div class="input-group">
                                                <input id="Cop_Imf" name="Cop_Imf" type="text" class="form-control input-xs datepickers empty" tabindex="9" readonly="" required="" />
                                                <span class="input-group-addon input-xs" title="Fecha de Creaci&oacute;n en Imprenta"><i class="glyphicon glyphicon-info-sign blue"></i></span>
                                            </div>
                                        </div>  
                                    </div>
                                    <div class="form-group">
                            ...
                            <fieldset class="exa-fieldset" id="provFormTemp">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-3" >
                                        ...
                                        <select id="For_Cod" name="For_Cod" class="form-control input-xs readOnly" required="" onchange="<?php if($configs['Cof_Con']==='S'){ echo 'checkCuentaPago();'; } ?>" required="">
                                            <option value="">Seleccione...</option>
    ...
    <div id="cuenDialog" title="B&uacute;squeda de Cuentas" style="display: none"></div></script>
    <script>
    ...
    <div id="docDetaDialog" title="Documento">
        <fieldset class="exa-fieldset" >
            ...
            <div class="form-group condensed">            
                ...
                <div class="col-xs-12" style="text-align: right;font-size: 8px;padding-top: 2px;"><b>CREACI&Oacute;N:</b> <span name="Cop_Sys" class="databind"></span> &nbsp;&nbsp;-&nbsp;&nbsp; <b>USUARIO:</b> <span name="vendedor" class="databind"></span></div>
            </div> 
            </div>    
        </fieldset> 
    </div>
