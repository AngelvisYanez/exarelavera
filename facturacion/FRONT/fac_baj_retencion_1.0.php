...
<?php	
/**
* Descripci�n: Permite dar de baja un retencion
* Fecha de actualizaci�n:	2013-05-13 
* Moificado: Jos� Cumbicos
*/
...
<table width="695" border="0">
  ...
  <table width="591" height="36" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td width="91" height="28" class="BarraBusqueda"><div align="right"><span class="Asterisco">* </span>B�squeda:</div></td>
	...
	<table width="100%"  border="1" cellpadding="0" cellspacing="0" class="fixedHeader01">
	 <thead> 
	  ...
	  if($total_rs_buscar != 0)
	  {
		$i=0;  
		/*
		* inicializo un contador para saber si en la b�squeda se encuentran facturas con pagos
		*/
		$existe_pagos=0;
		...
		*/
		...
		$i++;
	  	...
	  	/*
		*  Consultar si la factura se registro de forma autom�tica 
		*/
