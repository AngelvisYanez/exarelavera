                ...
                {		   
                    ...
                    foreach($productos as $fila){
                            ...
                            if($fila[15]!=""){
                                ...
                                $Asi_Val=($fila[5]*($fila[19]/100));$ban=true;
                                for($i=0;$i<count($retencion);$i++){
                                        if($retencion[$i]['Pld_Cod']==$row_rs_retcuen['Pld_Cod']){
                                            $retencion[$i]['Asi_Val']=$retencion[$i]['Asi_Val']+$Asi_Val;$ban=false;
                                        }
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name= "frmEmi" id="frmEmi">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td width="79%"><button type="button" class="btn btn-primary btn-mini" onClick="this.form.submit();"><i class=" icon-ok-sign icon-white"></i> <span>ok</span> </button></td>
                </tr>
            </table>   
        </form>
   </FIELDSET>
...
<table width="95%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td width="88%" class="LetraNegra">
            <input type="text" name="Prs_Ced" id="Prs_Ced" value="<?Php echo $row_rs_cliente['Prs_Ced'] ?>" size="11" maxlength="13"></input>
            ...
            <button type="button" class="btn btn-primary btn-mini" onClick="BuscarCliente_x_Cedula();"><span class="icon-search icon-white"></span> <span>Buscar</span> </button>
        </td>
    </tr>
    <tr>	
...
<script>
    ...
    function BuscarCliente_x_Cedula()
    {
        ...
        }else{respuesta=validar_cedula(cedula,campo);}
        ...
        if(respuesta===true)
        {
            ...
            $.post("<?php echo htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES, 'UTF-8'); ?>",data,function(response){
                if(response['Cliente']===true)
                {
                    ...
                    var r = confirm("Cliente no existe desea registrarlo!");
                    if (r === true) {
                        ajax_datos('<?Php echo $_SERVER['PHP_SELF']; ?>?ajax_cliente=1&Prs_Ced='+cedula,'ajax_modal');
                        Muestra_Aparecer();
                    } else {
