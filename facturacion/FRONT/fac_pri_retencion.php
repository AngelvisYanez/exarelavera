  ...
  if($opf==1)
	{ 
		if($Chk_For==1) 
		{
			...
			/**
			*  R E S U M E N  Consulta de totales de c�digos de formularios por fecha de comprobante de compra 
			*/
		...
		{
 	        /**
			*  Consultar comprobantes de retenci�n por fecha de comprobante de compra 
			*/
    ...
    {	
		...
		{ 
			/**
			*  Consulta de totales de c�digos de formularios por fecha de comprobante de retenci�n 
			*/
...
if($total_rs_buscar != 0)
{
	 ...
	 { 
	  ...
	  <table width="528" border="0" cellpadding="0" cellspacing="0">
		<tr>
		  <td width="170" class="Etiquetas"><div align="left">Comprobantes de retenci�n: </div></td>
		  ...
		  <?Php 
		  	if($Ren_Por!="")
			{ 
				echo 'Porcentaje de retenci�n:';
			}  
			if(!empty($Ren_Cod))
			{ 
				echo 'C�digo de formulario:';
			}?>
          </td>
...
<label class="Titulos2">Resultados de la busqueda</label>
	...
	<table border="1" cellpadding="0" cellspacing="0">
	  ...
	  <tr class="Fondo">
		...
		<?Php /** Base de retenci�n de las facturas *****************/ 
       if(isset($hdd)){
