...
<?php	
/*
* Descripci�n: Consulta las ventas individual, total y detallada, de cada vendedor y punto de impresi�n
* Fecha de actualizaci�n: 2012-05-25
...
<?php
		...
		tabs(3,'Individual*Totales*Detalle*Puntos de Impresi�n', $pag1.'*'.$pag2.'*'.$pag3.'*'.$pag4, $op);
		?>		
<div id="ContTabul">		
<?Php
switch ($op){
