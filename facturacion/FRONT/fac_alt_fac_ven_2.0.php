...
{   
	...
	*/
	...
	$rs_infoEmpresa = $obBD_con1->getRowConsulta(1211, $SucCod, $obBD_conexion);
...
if($ajax_con_numVenta==1)
{	
	/**
	* verifico si el numero de venta esta entre rango de la autorizacion
	*/	
	$rs_ventaNum = $obBD_con1->getRowConsulta(1222,$AutSri.'*'.$VetNum, $obBD_conexion);		
	...
	{		
		...
		{ 	
			...
			*/
            ...
            <script type="text/javascript">document.getElementById("btnguarda").style.visibility="hidden"</script>    
	<?php  }else{ /* visto correcto del numero de retencion*/
			?>&nbsp;<img src="../../mascaras/model1/imagenes/ok-s.gif">
			<script type="text/javascript">document.getElementById("btnguarda").style.visibility="visible"</script> 
			<?php
		}
	}else{   
			/**
...
<label class="Titulos2"> Generales </label>
 ...
 <table width="95%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="15%" class="LetraNegra">&nbsp;<?php echo $row_rs_apercaja['Caj_Fec'] ?>
    <input name="Caj_Fec" type="hidden" id="Caj_Fec" value="<?php echo $row_rs_apercaja['Caj_Fec'] ?>">
    </td>
    <td width="6%" class="Etiqueta1">Ciudad:</td>
    <td width="16%" class="LetraNegra">&nbsp;<?Php echo $row_rs_ciudad['Ciu_Des']; ?>      
    ...
    <td width="51%" class="LetraNegra">
    <div id="contenedormarca">
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="25%" class="Etiqueta1"><span class="Asterisco">* </span>No Secuencia:</td>
        <td width="26%"><input name="Vet_Num" type="text" id="Vet_Num" size="7" maxlength="7" value="<?Php echo $Vet_Num; ?>" style="text-align:right" onKeyPress="return validar_numeric(event)">
...
<br>	
 ...
 <td width="181">
 <button type="button" class="btn btn-primary start" id="btnguarda" name="btnguarda" title="Guardar" onclick="validar_facturacion(this.form)">
