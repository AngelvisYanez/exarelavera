      ...
      <?php
		...
		// $titulo = "<strong><span class='TITULO_REPORTE_2'>Reporte de Ventas $estado</span></strong>";
				...
				if ($_SERVER["REQUEST_METHOD"] == "POST") {
					...
					if ($tic_cod == "4") {
						$titulo = "<strong><span class='TITULO_REPORTE_2'>Reporte de Notas de Credito $estado</span></strong>";
						// Aquí puedes ejecutar cualquier acción adicional, como una consulta a la base de datos
					} else {
						$titulo = "<strong><span class='TITULO_REPORTE_2'>Reporte de Ventas $estado</span></strong>";
					}
				}
			...
			?>
				<table width="100%" border="1" cellpadding="0" cellspacing="0">
				  <tr class="TablaRepCompr">
					...
					<td class="TablaRepCompr" align="center"><?php if(isset($rubros)){ echo "Cantidad";} /*if(isset($rubros_cli)){ echo "Clientes";}*/?></td>
				  ...
				  <tr class="Texto_Reporte">
					...
					?></td>
					<td align="right"><?Php echo formato_numero($row_rs_buscarcarrera['Vet_Can'] ,2,2); ?></td>
