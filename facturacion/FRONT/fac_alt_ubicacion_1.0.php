...
<?php 
/**
* Descripci�n: Permite registrar las ubicaciones
	...
	*/
	if(isset($_POST['hdd']))
	{
		...
		{				
			...
			*/
			$parametros = $_POST['Ubi_Des']."*".$_POST['Ubi_Obs']."*".$nivel_actual."*".$Ses_Emp_Cod;
			/** 
			* Se guarda la el tipo de precio 
			*/
			$obBD_con1->operacionobBD(40, $parametros, $obBD_conexion);
			/*
...
<table width="100%">
	<tr class="BarraTitulo">
    	<td>
			&raquo; Registrar  Ubicaci&oacute;n
		</td>
	</tr>
</table>    
...
<?php 
	...
	<table border="1" cellpadding="0" cellspacing="0" width="100%" class="fixedHeader01">
		...
		<tr>
            ...
            <th width="42%">Observaci&oacute;n</th>
			<th width="10%">&nbsp;</th>
		</tr>
        </thead>
        <tbody>
			...
			?>
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td width="86%">&nbsp;<input type="text" id="Ubi_Des" name="Ubi_Des" style="text-transform:uppercase"/></td>
					</tr>
					<tr>
						<td width="14%" class="Etiqueta1">&nbsp;Observaci&oacute;n:</td>
						<td width="86%">&nbsp;<textarea id="Ubi_Obs" name="Ubi_Obs" cols="20" style="text-transform:uppercase"></textarea></td>
					</tr>
				</table>
		</fieldset>
		<br />
