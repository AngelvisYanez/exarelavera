...
if (isset($hdd_save) && !isset($hdd_volver))
{
	...
	*/
	$obBD_ins1->operacionobBD(34, $Vet_Num.'*'.$Vet_Obs.'*'.$Vet_Des.'*'.$Ret_Fec.'*'.$Num_Ret.'*'.$Num_Aut.'*'.$codigo, $obBD_conexion);	
	/** 
		...
		{   
			...
			*/
			$obBD_ins1->operacionobBD(40, $param[2].'*'.$param[8].'*'.
				$param[4].'*'.$param[5].'*'.$param[6].'*'.$codigo.'*'.$param[0].'*'.$param[9].'*'.$param[11].'*'.$param[10].'*'.$param[12].'*'.$param[13].'*'.$param[14].'*'.$param[17].'*'.$param[18], $obBD_conexion);
