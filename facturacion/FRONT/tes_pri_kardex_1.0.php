		...
		foreach($rs_saldo as $row_rs_saldo){
		  ...
		  <table width="100%" border="1" cellpadding="0" style="border-collapse:collapse" cellspacing="0">
		    ...
		    <tr class="Texto_normal_10">
		      <td width="9%" class="LetraNegra" align="center"><? echo $row_rs_consulta['Kar_Fec']; ?></td>
		      <td width="7%" class="LetraNegra"><? echo $documento; ?></td>
		      <td width="7%" class="LetraNegra"><? echo $numero; ?></td>
		      <td width="7%" class="LetraNegra"><? echo $Tipo_Comprobante; ?></td>
		      <td width="34%" class="LetraNegra"><? echo $observacion; ?></td>
