...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table">
  ...
  <FIELDSET>
   ...
   ?>
    ...
    <input name="Des_Cod" type="hidden" id="Des_Cod" value="<? echo $_POST['Des_Cod'];?>" />
	...
	<table width="100%" border="0" cellpadding="2" cellspacing="0">
	  ...
	  <tr>
	    ...
	    <td  class="LetraNegra">&nbsp;
        <input name="Des_Adu" type="text" id="Des_Adu" style="text-transform:uppercase" value="<? echo $row_rs_persona['Des_Adu'];?>" size="15" maxlength="20" /></td>
	    </tr>
	  <tr>
	    <td class="Etiqueta1">C&oacute;digo Establecimiento(SRI):</td>
	    <td  class="LetraNegra">&nbsp;
        <input name="Des_Sri" type="text" id="Des_Sri" style="text-transform:uppercase" value="<? echo $row_rs_persona['Des_Sri'];?>" size="15" maxlength="3" /></td>
	    </tr>
	  <tr id="Natural">
	    <td class="Etiqueta1">        
