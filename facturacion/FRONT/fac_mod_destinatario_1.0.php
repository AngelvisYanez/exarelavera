 ...
 * @version 1.0
 * Fecha de actualizaci�n:	2015-06-30
...
if (isset($_POST['hdd_save']))
{
  	...
  	{		
  		 ...
  		 */
		 //$_POST['Zon_Cod'].
  		$Param_destinatario =$_POST['Prs_Cod'].'*'.$Ses_Emp_Cod.'*'.$_POST['Des_Sri'].'*'.$_POST['Des_Adu'].'*'.$_POST['Des_Cod'];
		//echo "<br>".$Param_cliente;
  		 ...
  		 * @var string
  		 */
  		$Param_persona = $_POST['Prs_Ced'].'*'.$_POST['Prs_Nom'].'*'.$_POST['Prs_Ape'].'*'.$_POST['Prs_Dir'].'*'.$_POST['Prs_Cor'].'*'.$_POST['Prs_Cod'];
		//echo "<br>".$Param_persona."<br>";
		$obBD_con1->updatePersonaCliente(12,$Param_persona,13,$Param_destinatario);
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table">
   <tr class="BarraTitulo">
    <td height="10">&raquo; modificar Destinatario
    </td>
   </tr> 
   <tr>
   ...
   <?Php
  if(isset($_POST['txt_busqueda']) && !isset($_POST['Des_Cod']))
  {
  ?>
   <FIELDSET>
   <LEGEND>
	...
	{	
		...
		<tr>
		 ...
		 <form name='form6' method='post'  action='<?php echo $_SERVER['PHP_SELF'];?>'>
			...
			<input name="Des_Cod" id="Des_Cod" type="hidden" value="<?Php echo $row['Des_Cod']; ?>">
  ...
  if(isset($_POST['Des_Cod']) && !isset($_POST['hdd_volver']))
  {
  ?>
  <FIELDSET>
   <LEGEND>
   ...
   <?php 
   	 $thisPost->startPost();
	 $row_rs_persona = $obBD_con1->getRowConsulta(11,$_POST['Des_Cod'],$obBD_conexion);
   ?>
    <input name="Prs_Cod" type="hidden" id="Prs_Cod" value="<?php echo $row_rs_persona['Prs_Cod'];?>" />
    <input name="Des_Cod" type="hidden" id="Des_Cod" value="<?php echo htmlspecialchars($_POST['Des_Cod'], ENT_QUOTES, 'UTF-8');?>" />
	...
	<table width="100%" border="0" cellpadding="2" cellspacing="0">
	  ...
	  <tr>
	    ...
	    <td  class="LetraNegra">&nbsp;
        <input name="Des_Adu" type="text" id="Des_Adu" style="text-transform:uppercase" value="<?php echo $row_rs_persona['Des_Adu'];?>" size="15" maxlength="20" /></td>
	    </tr>
	  <tr>
	    <td class="Etiqueta1">C&oacute;digo Establecimiento(SRI):</td>
	    <td  class="LetraNegra">&nbsp;
        <input name="Des_Sri" type="text" id="Des_Sri" style="text-transform:uppercase" value="<?php echo $row_rs_persona['Des_Sri'];?>" size="15" maxlength="3" /></td>
	    </tr>
	  <tr id="Natural">
	    <td class="Etiqueta1">        
      ...
      <tr>
        ...
        <td class="LetraNegra">&nbsp;
        <input name="Prs_Cor" type="text" id="Prs_Cor" value="<?php echo $row_rs_persona['Prs_Cor'];?>" size="66" maxlength="60" >
        </td>
      </tr>
      <tr>
    ...
    <table width="300" border="0" cellpadding="0" cellspacing="0">
      <tr> 
      	<td width="110">
      		 <button type="button" class="btn btn-inverse fileinput-button" title="Atr�s" onClick="campos_hide(this.form, 'txt_busqueda*op_opciones*hdd_volver', '<?php echo $_POST['txt_busqueda'].'*'.$_POST['op_opciones'].'*'.'1';?>')">
  ...
  ?>
<script type="text/javascript" src="../VALIDACIONES/fac_par_destinatario.js"></script>
