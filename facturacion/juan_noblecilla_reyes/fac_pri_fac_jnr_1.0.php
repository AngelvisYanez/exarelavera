...
<tr>
          <td width="338" height="192" colspan="4" align="left" valign="top">
        ...
        <tr>
          <td height="12">&nbsp;</td>
          <td width="36%"><?php if ($row_rs_representante['Cli_Fac'] != "")
			{ 
          ...
          <td width="51%" rowspan="2" align="right" valign="middle"><table width="89%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
            <tr>
...
<tr>
            <td colspan="4" valign="top"><table width="87%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
              <tr>
             ...
             <!-- <tr>
              ...
              <tr>
                ...
                <td width="32%" height="10" align="right">0.00<?Php //echo formato_numero($resultados[2]+0, 2, 1); ?></td>
              </tr>                                         
              <tr>
