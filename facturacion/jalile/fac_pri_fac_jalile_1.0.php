...
<table width="75%" border="0" align="left" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td height="122" colspan="4" align="left" valign="bottom" class="LetraPlan">&nbsp;</td>
                      </tr>
                      <tr>
		    ...
		    ?></td>
                        <td width="18%" align="left">FECHA EMISION:</td>
                        <td width="24%"><?php echo $dia."/".$mes."/".$anio;?></td>
                      </tr>
                      <tr>
  ...
  <tr>
            <td height="440" colspan="4" align="left" valign="bottom"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">              
              <tr>
                <td width="50%" rowspan="6" align="left" valign="top">&nbsp;</td>
                <td width="38%" height="18" align="right">Tarifa 12%&nbsp;&nbsp;</td>
