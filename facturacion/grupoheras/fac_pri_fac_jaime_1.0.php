...
<tr>
  ...
  <tr>
    <td height="326"  colspan="4" align="left" valign="top"><table width="92%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_3">
      <tr>
        <td height="35" align="right" valign="bottom">&nbsp;</td>
        <td width="61%" valign="bottom"><?php if ($row_rs_representante['Cli_Fac'] != "")
			{ 
				echo $row_rs_representante['Cli_Fac'];  
			}
			else { echo $row_rs_cliente['Prs_Ape'].' '.$row_rs_cliente['Prs_Nom']; }
		    ?></td>
        <td width="33%" rowspan="2" align="center" valign="middle"><table width="100%" height="29" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_3">
          <tr>
      ...
      <tr>
        <td colspan="3" align="left" valign="bottom"><?Php 
	 $tarifa_0 = 0;
	 $tarifa_12 = 0;
...
<tr>
            <td height="265" colspan="4" valign="top"><table width="89%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_3">
              <tr>
