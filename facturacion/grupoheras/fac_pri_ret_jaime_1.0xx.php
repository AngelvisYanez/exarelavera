...
<table width="853"   border="0" align="left">
        ...
        <tr >
          <td height="13" colspan="2" align="left" valign="middle" class="Letra_punto_venta_2"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
            <tr>
              ...
              <td width="80%" valign="middle"><?php echo $row_prin_renta['Prs_Ape'].' '.$row_prin_renta['Prs_Nom']; ?></td>
            </tr>
          </table></td>
          <td align="right" valign="middle" class="Letra_punto_venta_2"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
            <tr>
              ...
              <td width="65%"><?php echo $row_prin_renta['Prs_Ced']; ?></td>
              </tr>
          </table></td>
        </tr>
        <tr >
          <td height="20" colspan="2" align="left" valign="bottom" class="Letra_punto_venta_2"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
            <tr>
              <td width="20%" height="30">&nbsp;</td>
              <td width="80%" valign="bottom"><?php echo $row_prin_renta['Prs_Dir']; ?></td>
            </tr>
          </table></td>
          <td height="20" valign="bottom" class="Letra_punto_venta_2"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
            <tr>
              <td width="35%">&nbsp;</td>
              <td width="65%"><?php echo $row_prin_renta['Ciu_Des']; ?></td>
            </tr>
          </table></td>
        </tr>
        <tr >
        ...
        <tr>
          <td height="30" align="center" valign="bottom" class="Letra_punto_venta_2" ><?php echo $row_prin_renta['Tic_Des']; ?></td>
		...
		{  
          ...
          <td width="339" colspan="-2" align="left" valign="bottom" class="Letra_punto_venta_2"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_2">
            <tr>
              <td width="36%">&nbsp;</td>
              <td width="64%"><?php echo $row_prin_renta['Cop_Fec']; ?></td>
            </tr>
          </table></td>
        </tr>
        <tr >
          <td height="50" align="left" valign="bottom" class="Letra_punto_venta_2">&nbsp;&nbsp;&nbsp; <?php 
		if ($row_rs_renta['Aut_Cod'] != "") 
		{ 
