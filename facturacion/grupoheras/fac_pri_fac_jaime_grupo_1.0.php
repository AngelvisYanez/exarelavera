...
<html>
    ...
    <body>
        ...
        <table width="553" height="100%" border="0" align="left">
            <tr>
                <td width="547" height="72" colspan="4" align="left" valign="top">&nbsp;</td>
            <tr>
                <td height="326"  colspan="4" align="left" valign="top">
                    <table width="92%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_3">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td align="center" valign="middle"><?Php echo $row_institucion['Ciu_Des']; ?></td>
                        </tr>
                        <tr>
                            <td height="59">&nbsp;</td>
                            ...
                            <td colspan="3" align="left" valign="bottom">
                                ...
                                <? do { ?>
                                    <!--<tr>
                                            ...
                                            <td width="10" align="right"><?Php echo number_format($row_rs_cliente['Vet_Pru'], 2); ?>&nbsp;&nbsp;</td>
                                            <td width="40" align="right" ><div align="right"><?Php echo number_format($row_rs_cliente['Vet_Imp'], 2); ?></div></td>
                                        </tr>-->
                                    <?Php
                                    /*
                                     * % de Descuento total 
                                    ...
                                    $rs_interes = $obBD_con1->consulta(sentencias_tes(74, $obBD_con1->parametros($Vet_Cod . '*' .
                                                            $row_rs_cliente['Nge_Cod'] . '*' . $row_rs_cliente['Asi_Int'] . '*' . $row_rs_cliente['Pro_Cod'])), $obBD_conexion->conexion);
                                ...
                                ?>
                                    <tr>
                                        <td width="30" height="28" align="left"><div align="left">1</div></td>
                                        <td width="170" align="left"><div align="left">&nbsp;<?php echo $observacion;?><?Php // echo $row_rs_cliente['Ite_Lar'].' '.$row_rs_cliente['Vet_Obs']?></div></td>
                                        <td width="10" align="right">&nbsp;&nbsp;<?Php echo formato_numero($resultados[0], 2, 1); ?></td>
                                        <td width="40" align="right" ><div align="right"><?Php echo formato_numero($resultados[0], 2, 1); ?></div></td>
                                    </tr> 
                                </table>
            ...
            <tr>
                <td height="265" colspan="4" valign="top">
                    <table width="89%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_3">
                        <tr>
                            <td align="right"><!--Subtotal&nbsp;-->&nbsp;</td>
                            <td height="28" align="right" valign="middle"><?Php echo formato_numero($resultados[0], 2, 1); ?></td>
                        </tr>
                        <tr>
                            <td align="right"><!--Descuento&nbsp;-->&nbsp;</td>
                            <td height="28" align="right"><?Php echo formato_numero($resultados[4], 2, 1); ?></td>
                        </tr>
                        <!-- <tr>
                        ...
                        <tr>
                            ...
                            <td width="32%" height="28" align="right">0.00
                            <?Php //echo formato_numero($resultados[2]+0, 2, 1);  ?></td>
                        </tr>
                        <tr>
                            <td align="right"><!--IVA&nbsp;-->&nbsp;</td>
                            <td height="28" align="right"><?Php echo formato_numero($resultados[3], 2, 1); ?></td>
                        </tr>
                        <tr>
                            <td align="right"><!--TOTAL&nbsp;-->&nbsp;</td>
                            <td height="28" align="right" valign="bottom"><strong><?php echo number_format($resultados[5], 2); ?></strong></td>
                        </tr>
                        <tr>
