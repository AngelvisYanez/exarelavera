...
<span style="top:185px;left:42px;" class="flota"><? if ($row_rs_representante['Cli_Fac'] != ""){echo $row_rs_representante['Cli_Ruf'];}else{echo $row_rs_cliente['Prs_Ced'];}?></span>
<span style="top:185px;left:360px;" class="flota"><? echo $row_institucion['Ciu_Des'];?></span>
