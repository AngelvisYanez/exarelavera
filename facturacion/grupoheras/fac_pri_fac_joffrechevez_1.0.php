...
-->
.flota{position: absolute;font-size: 10px;font-weight: normal;font: 8pt Verdana;}
...
<span style="top:133px;left:42px;" class="flota"><?php if ($row_rs_representante['Cli_Fac'] != ""){echo $row_rs_representante['Cli_Fac'];}else{ echo $row_rs_cliente['Prs_Ape'].' '.$row_rs_cliente['Prs_Nom'];}?></span>
<span style="top:161px;left:42px;" class="flota"><?php if ($row_rs_representante['Cli_Dir'] != ""){echo substr($row_rs_representante['Cli_Dir'],0,31);}else{echo substr($row_rs_cliente['Prs_Dir'],0,31);}?></span>
<span style="top:185px;left:42px;" class="flota"><?php if ($row_rs_representante['Cli_Fac'] != ""){echo $row_rs_representante['Cli_Ruf'];}else{echo $row_rs_cliente['Prs_Ced'];}?></span>
<span style="top:185px;left:360px;" class="flota"><?php echo $row_institucion['Ciu_Des'];?></span>
<span style="top:107px;left:305px;" class="flota"><?php echo $dia.'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$mes.'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$anio; ?></span>

<?php $aux=235;
do{?>
	<span style=" top:<?php echo $aux; ?>px;left:10px;" class="flota"><?php echo formato_numero($row_rs_cliente['Vet_Can'],1,1);?></span>
    <span style="top:<?php echo $aux; ?>px;left:45px;" class="flota"><?php echo $row_rs_cliente['Ite_Lar'].' '.$row_rs_cliente['Pro_Obs'];?></span>
    <span style="top:<?php echo $aux; ?>px;left:270px;" class="flota rigth"><?php echo number_format($row_rs_cliente['Vet_Pru'], 2);?></span>
    <span style="top:<?php echo $aux; ?>px;left:345px;" class="flota rigth"><?php echo number_format($row_rs_cliente['Vet_Imp'], 2);?></span>
...
<?php $posTot='580';?>
<span style="top:<?php echo $posTot;?>px;left:345px;" class="flota rigth"><!--Tarifa 0%--><?Php echo formato_numero($resultados[1]+0, 2, 1); ?></span>
<span style="top:<?php echo $posTot+23;?>px;left:345px;" class="flota rigth"><!--Tarifa 12%&nbsp;--><?Php echo formato_numero($resultados[2]+0, 2, 1); ?></span>
<span style="top:<?php echo $posTot+45;?>px;left:345px;" class="flota rigth"><!--Subtotal&nbsp;--><?Php echo formato_numero($resultados[0], 2, 1); ?></span>
<span style="top:<?php echo $posTot+67;?>px;left:345px;" class="flota rigth"><!--Descuento&nbsp;--><?Php echo formato_numero($resultados[4], 2, 1); ?></span>
<span style="top:<?php echo $posTot+89;?>px;left:345px;" class="flota rigth"><!--IVA&nbsp;--><?Php echo formato_numero($resultados[3], 2, 1); ?></span>
<span style="top:<?php echo $posTot+111;?>px;left:345px;" class="flota rigth"><!--TOTAL&nbsp;--><strong><?php echo number_format($resultados[5], 2); ?></strong></span>
