...
<span style="top:138px;left:888px;" class="flota"><? echo $Fec_Emi[2].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$Fec_Emi[1].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$Fec_Emi[0]; ?></span>
<span style="top:248px;left:175px;" class="flota"><? echo $row_prin_renta['Prs_Ape'].' '.$row_prin_renta['Prs_Nom']; ?></span>
<span style="top:248px;left:880px;" class="flota"><? echo $row_prin_renta['Prs_Ced']; ?></span>

<span style="top:290px;left:175px;" class="flota"><? echo $row_prin_renta['Prs_Dir']; ?></span>
<span style="top:290px;left:880px;" class="flota"><? echo $row_prin_renta['Ciu_Des']; ?></span>

<span style="top:385px;left:132px;" class="flota"><? echo $row_prin_renta['Tic_Des']; ?></span>
<span style="top:385px;left:470px;" class="flota"><? echo $row_prin_renta['Cop_Num']; ?></span>
<span style="top:385px;left:755px;" class="flota"><? echo $row_prin_renta['Cop_Fec']; ?></span>
...
{ ?>
	...
	<span style="top:<? echo $fila;?>px;left:1025px;" class="flota"><? echo $Val_Ret=formato_numero((formato_numero($row['Ret_Bas'],2,1)* $row['Ren_Por'])/100,2,1); $Total_Ret+=$Val_Ret; ?></span>
