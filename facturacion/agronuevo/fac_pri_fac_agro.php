  	...
  	<td  align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" >
  	  <tr>
  	    <td colspan="6" align="center" class="LetraPlan"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  	      <tr>
  	        <td width="21%" align="left"><img src="<?php echo $Ses_Emp_Log;?>" width="130" height="80"></td>
  	    ...
  	    <td colspan="6" align="left" valign="top"><?Php 
  	      ...
  	      <table width="100%" border="1" cellpadding="0" cellspacing="0" style="border-collapse:collapse" bordercolor="#AE0D09">
  	        <tr class="titulotabla">
  	          <td width="90" height="19" align="left" bgcolor="#AE0D09"><strong>&nbsp;
  	            <!--Cant.-->
	            </strong>CANT.</td>
  	          <td width="714" align="left" bgcolor="#AE0D09">DESCRIPCI&Oacute;N<strong>&nbsp;
  	            <!--Descripci&oacute;n-->
	            </strong></td>
  	          <td width="152" align="right" bgcolor="#AE0D09">P. UNIT.&nbsp;
  	            <!--PVP--></td>
  	          <td width="185" align="right" bgcolor="#AE0D09">IMPORTE<strong>&nbsp;
  	            <!--Total-->
	            </strong></td>
	          </tr>
  	        <tr>
