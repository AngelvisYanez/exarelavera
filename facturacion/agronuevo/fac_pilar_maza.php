...
<span style="top:<? echo $top-20;?>px;left:0px;" class="titulo">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;** COMERCIAL AGROMAS  ** </span>
<span style="top:<? echo $top+10;?>px;left:90px;" class="flota"><? echo $titFac;?></span>
<span style="top:<? echo $top+40;?>px;left:0px;" class="flota">CLIENTE:&nbsp;<? if ($row_rs_representante['Cli_Fac'] != ""){echo $row_rs_representante['Cli_Fac'];}else{ echo $row_rs_cliente['Prs_Ape'].' '.$row_rs_cliente['Prs_Nom'];}?></span>
<span style="top:<? echo $top+58;?>px;left:0px;" class="flota">CI:&nbsp;<? if ($row_rs_representante['Cli_Fac'] != ""){echo $row_rs_representante['Cli_Ruf'];}else{echo $row_rs_cliente['Prs_Ced'];}?></span>
<span style="top:<? echo $top+58;?>px;left:145px;" class="flota">FECHA:&nbsp;<? echo $dia.'/'.$mes.'/'.$anio; ?></span>
<? if($claveacceso!=''){?>
<span style="top:<? echo $top+75;?>px;left:0px;" class="flota">CLAVE ACCESO/AUTORIZACION:</span>
<span style="top:<? echo $top+85;?>px;left:0px; text-align: left; width: 270px;" class="flota ca"><? echo $row_rs_cliente['Vet_Xml'];?></span>
<? }else{?>

<span style="top:<? echo $top+55;?>px;left:0px;" class="flota">NUMERO VENTA: <? echo $row_institucion['Suc_Sri'].'-'.$auto['Pun_Sri'].'-'.str_pad($row_rs_cliente['Vet_Num'], 9, "0", STR_PAD_LEFT);?></span>
<? }?>

<span style="top:<? echo $top+130;?>px;left:0px;" class="flota">DETALLE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CANT&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;P.U.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TOTAL</span>
<span style="top:<? echo $top+144;?>px;left:0px;" class="flota">------------------------------------------</span>
<? $aux=188;
do{?>	
    <span style="top:<? echo $aux; ?>px;left:0px;" class="flota"><? echo $row_rs_cliente['Ite_Cor'].' '.$row_rs_cliente['Pro_Obs'];?></span>
	<span style=" top:<? echo $aux+17; ?>px;left:90px;" class="flota"><? echo formato_numero($row_rs_cliente['Vet_Can'],1,1);?></span>
    <span style="top:<? echo $aux+17; ?>px;left:118px;" class="flota rigth"><? echo number_format($row_rs_cliente['Vet_Pru'] * $Cambio_Moneda, 4);?></span>
    <span style="top:<? echo $aux+17; ?>px;left:190px;" class="flota rigth"><? echo number_format($row_rs_cliente['Vet_Imp'] * $Cambio_Moneda, 2);?></span>

<? $aux+=30; }while ($row_rs_cliente = $obBD_con1->fetch_assoc ($rs_cliente));
$resultados = explode('*',$obBD_con1->calculos($Vet_Cod, $obBD_conexion));	
?>
<span style="top:<? echo $aux+145;?>px;left:0px;" class="flota">------------------------------------------</span>
...
<span style="top:<? echo $posTot;?>px;left:190px;" class="flota rigth"><?Php echo formato_numero($resultados[0] * $Cambio_Moneda, 2, 1); ?></span>

<span style="top:<? echo $posTot+15;?>px;left:110px;" class="flota">Descuento:</span>
<span style="top:<? echo $posTot+15;?>px;left:190px;" class="flota rigth"><?Php echo formato_numero($resultados[4] * $Cambio_Moneda, 2, 1); ?></span>

<span style="top:<? echo $posTot+30;?>px;left:110px;" class="flota">Tarifa 0%:</span>
<span style="top:<? echo $posTot+30;?>px;left:190px;" class="flota rigth"><?Php echo formato_numero((float)$resultados[1] * $Cambio_Moneda, 2, 1); ?></span>

<span style="top:<? echo $posTot+45;?>px;left:110px;" class="flota">Tarifa 12%:</span>
<span style="top:<? echo $posTot+45;?>px;left:190px;" class="flota rigth"><?Php echo formato_numero($resultados[2]+0 * $Cambio_Moneda, 2, 1); ?></span>

<span style="top:<? echo $posTot+60;?>px;left:110px;" class="flota">IVA:</span>
<span style="top:<? echo $posTot+60;?>px;left:190px;" class="flota rigth"><?Php echo formato_numero($resultados[3] * $Cambio_Moneda, 2, 1); ?></span>

<span aling="rigth" style="top:<? echo $posTot+75;?>px;left:110px;" class="flota">TOTAL:</strong></span>
<span aling="rigth" style="top:<? echo $posTot+75;?>px;left:190px;" class="flota rigth"><strong><?php echo number_format($resultados[5] * $Cambio_Moneda, 2); ?></strong></span>
