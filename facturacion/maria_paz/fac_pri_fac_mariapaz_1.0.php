...
<table width="874" height="100%" border="0" align="left">
<tr>
          <td width="868" height="72" colspan="4" align="left" valign="top">&nbsp;</td>
</tr>
  <tr>
    <td height="275" valign="top"><table width="100%" height="243" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_3">
      <tr>
        <td width="14%" height="18" align="right" valign="bottom">&nbsp;</td>
        <td width="59%" valign="middle"><? if ($row_rs_representante['Cli_Fac'] != "")
			{ 
				echo $row_rs_representante['Cli_Fac'];  
			}
			else { echo $row_rs_cliente['Prs_Ape'].' '.$row_rs_cliente['Prs_Nom']; }
		    ?></td>
        <td width="27%" rowspan="3" align="right" valign="bottom"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_3">
          <tr>
            <td width="34%" height="26" align="center">&nbsp;<? echo $dia;?></td>
            <td width="32%" align="center">&nbsp;<? echo $mes;?></td>
            <td width="34%" align="right">&nbsp;<? echo $anio;?></td>
          </tr>
        </table></td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="27">&nbsp;</td>
        <td valign="bottom"><? if ($row_rs_representante['Cli_Fac'] != "")
			{ 
        ...
        <td align="center" valign="bottom"><?Php echo $row_institucion['Ciu_Des']; ?></td>
      </tr>
      <tr>
        <td height="31" colspan="3" align="left" valign="bottom"><br>
      ...
      <tr>
        <td height="30" colspan="3" align="left" valign="bottom"><?Php 
	 $tarifa_0 = 0;
	 $tarifa_12 = 0;
	...
	?>
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_3">
            <? do{?>
            <tr>
              <td width="100" height="35" align="center"><div align="left"><?Php echo $row_rs_cliente['Vet_Can']?></div></td>
              <td width="405" align="left"><div align="left">&nbsp;<?Php echo $row_rs_cliente['Ite_Lar'].' '.$row_rs_cliente['Pro_Obs']?></div></td>
              <td width="131" align="right"><?Php echo number_format($row_rs_cliente['Vet_Pru'], 2); ?>&nbsp;&nbsp;</td>
      ...
      <tr>
        <td height="60" colspan="3" align="left" valign="bottom">&nbsp;</td>
      </tr>
    </table></td>
  </tr>
  <tr>
            <td height="21" colspan="4" valign="top"><table width="99%" border="0" cellpadding="0" cellspacing="0" class="Letra_punto_venta_3">
              <tr>
                <td align="right"><!--Subtotal&nbsp;-->
                  &nbsp;</td>
                <td height="27" align="right"><?Php echo formato_numero($resultados[0], 2, 1); ?></td>
              </tr>
              <tr>
                <td align="right"><!--Descuento&nbsp;-->
                  &nbsp;</td>
                <td height="26" align="right"><?Php echo formato_numero($resultados[4], 2, 1); ?></td>
              </tr>
              <!-- <tr>
              ...
              <tr>
                <td width="68%" align="right"><!--Tarifa 12%&nbsp;-->
                  &nbsp;</td>
                <td width="32%" height="27" align="right">0.00
                  <?Php //echo formato_numero($resultados[2]+0, 2, 1); ?></td>
              </tr>
              <tr>
                <td align="right"><!--IVA&nbsp;-->
                  &nbsp;</td>
                <td height="26" align="right"><?Php echo formato_numero($resultados[3], 2, 1); ?></td>
              </tr>
              <tr>
                <td align="right"><!--TOTAL&nbsp;-->
                  &nbsp;</td>
                <td height="27" align="right" valign="bottom"><strong><?php echo number_format($resultados[5], 2); ?></strong></td>
              </tr>
              <tr>
