          ...
          <td width="532" height="214" colspan="4" align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" style="table-layout:fixed;" class="Letra_punto_venta_2">
            ...
            <tr>
              ...
              <td valign="bottom"><span style="white-space: nowrap; overflow: hidden;">
                <?php /*Fecha salida */ echo $rs_guia['Gui_Fsa']?>
              </span></td>
              <td align="left" valign="bottom"><span style="white-space: nowrap; overflow: hidden;"><?php /*Num. factura*/ echo $rs_guia['Gui_Nve']?></span></td>
            </tr>
            <tr>
              <td height="6" align="right" valign="bottom">&nbsp;</td>
              <td valign="bottom"><span style="white-space: nowrap; overflow: hidden;">
                <?php /*Fecha llegada*/ echo $rs_guia['Gui_Far']?>
              </span></td>
              <td align="left" valign="bottom"><span style="white-space: nowrap; overflow: hidden;">
                <?php /*Fecha factura*/ echo $rs_guia['Gui_Fve']?>
              </span></td>
            </tr>
            <tr>
              <td height="12" align="right" valign="bottom">&nbsp;</td>
              <td valign="bottom">&nbsp;</td>
              <td align="left" valign="bottom"><?php /*Codigo Aduana*/ echo $rs_destino['Des_Adu']; ?></td>
            </tr>
            <tr>
              <td height="12" align="right" valign="bottom">&nbsp;</td>
              <td valign="bottom">&nbsp;</td>
              <td align="left" valign="bottom"><span style="white-space: nowrap; overflow: hidden;"><?php //echo $rs_guia['Gui_Ave']?></span></td>
            </tr>
            <tr>
            ...
            <tr>
              <td height="12" align="right" valign="bottom">&nbsp;</td>
              <td valign="bottom"><span style="white-space: nowrap; overflow: hidden;">
                <?php /*Fecha Emision guia*/ echo $rs_guia['Gui_Fec']?>
              </span></td>
              <td align="left" valign="bottom">&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td width="59%" valign="middle"><span style="white-space: nowrap; overflow: hidden;">
                <?php /*pto arribo */echo $rs_guia['Gui_Dar']?>
              </span></td>
