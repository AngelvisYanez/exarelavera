...
require_once("tes_sql_cta_deudora.php");
...
class Class_Log_Conexion_Tip extends MysqlConexion{
...
class Class_Log_Datos_Tip extends MysqlDatos{
	...
	*/
	function consultasobBD($sen_sql,$param, $obBD = null)
	{
		...
		return $this->consulta(sentencias_tip($sen_sql,$Par_Sql), $obBD->conexion);
	}
	...
	*/
	...
	{
		$Par_Sql= $this->parametros($param);
		return $this->grabarv_registros(sentencias_tip($sen_sql,$Par_Sql), $obBD->conexion);
	}
