...
/******************************************************/
	...
	*/
	...
	function num_factura($num, $pun)
	{
		...
		mysqli_free_result ($rs_facturas);
		mysqli_free_result ($rs_puntos);	
	}
	...
	function calculos($Vet_Cod)
	{
		...
		mysqli_free_result($rs_calculos);
	}	
	...
	function calculos_compra_ice($Cop_Cod)
	{
		...
		*/
		...
		mysqli_free_result($rs_calculos_comp);
	}	
	...
	function codigo_auto($Pro_Ide)
	{
		...
		return $max;
		mysqli_free_result ($rs_producto);
