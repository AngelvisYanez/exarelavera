...
function ppto_prod_periodo_obtener_fila($mysqli, $proy_id, $Emp_Cod, $anio, $mes, $for_update = false) {
    ...
    $sql = "SELECT * FROM pre_prod_periodos
            WHERE proy_id='$clean' AND Emp_Cod=" . (int)$Emp_Cod . "
...
function ppto_prod_periodo_insert_evento_log($mysqli, $obDatos, $proy_id, $Emp_Cod, $anio, $mes,
    ...
    $sql = "INSERT INTO pre_prod_evento_log
            (proy_id, Emp_Cod, pel_anio, pel_mes, pel_tipo, pel_origen, Usu_Cod, pel_fecha,
    ...
    if ($fila) {
        $sql = "UPDATE pre_prod_periodos
                SET prd_real = $real_val,
                    ...
                    Usu_Cod = " . (int)$Usu_Cod . "
                WHERE proy_id='$clean_proy' AND Emp_Cod=" . (int)$Emp_Cod . "
                  AND prd_anio=" . (int)$anio . " AND prd_mes=" . (int)$mes;
        ...
        $sql = "INSERT INTO pre_prod_periodos
                (proy_id, Emp_Cod, prd_anio, prd_mes, prd_esperada, prd_real, prd_proyectada,
                 prd_estado, prd_fecha_cierre, prd_fecha_registro, Usu_Cod)
                VALUES
                ('$clean_proy', " . (int)$Emp_Cod . ", " . (int)$anio . ", " . (int)$mes . ",
