        ...
        $total_rs_camp = count($rs_camp);
            ...
            <tr class="Cabecera1">
                ...
                <? if($total_rs_camp > 0){
                    ...
                    ?>
                        <td class="Texto_Reporte"><? echo $row_rs_camp['Cam_Cor']; $td +=1;?></td>
                <? 	}
                }?>
		 ...
		 <? if($total_rs_act > 0){
                ...
                ?>
            <tr>
                <td class="Texto_Reporte" align="center"  ><? echo $row_rs_act['Act_Cod'];?></td>
                <td class="Texto_Reporte" align="center"><? echo $row_rs_act['Act_Cdc'];?></td>
                <td class="Texto_Reporte"  ><? echo $row_rs_act['Act_Des'];?></td>
                <td class="Texto_Reporte" ><? echo $row_rs_act['Act_Fec'];?></td>
                <td class="Texto_Reporte" align="center"><? echo $row_rs_act['Act_Ann'];?></td>
                <td class="Texto_Reporte" ><? if($row_rs_act['Act_Obs'] != ''){ echo $row_rs_act['Act_Obs'];}else{ echo "&nbsp;";}?>											
                </td>
               <?
                ...
                <td class="Texto_Reporte" ><? if($row_rs_det_camp['Act_Val'] != ''){ echo $row_rs_det_camp['Act_Val'];}else{ echo "&nbsp;";}?></td><? }?>
    <? 	}//fin  foreach($rs_camp as $row_rs_camp){
        //$row_rs_camp = first_last($rs_camp, $row_rs_camp, 0);
    ?>
        		<td class="Texto_Reporte" align="center"><? echo $row_rs_act['Act_Can']; $cantidad += $row_rs_act['Act_Can'];?></td>
           </tr>
        <? 	}/// fin  foreach($row_rs_act as $rs_act)
           ...
           <tr class="Fondo" >
                ...
                <td class="Texto_Reporte" align="center"><? echo $cantidad; $cantidad = 0;?></td>
             </tr>
           </table>
           <br>
           <br>
