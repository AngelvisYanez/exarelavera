...
require_once("act_sql_activo.php");
...
class Class_Log_Conexion_Activo extends MysqlConexion{
...
class Class_Log_Datos_Activo extends MysqlDatos{
	...
	*/
	function consultasobBD($sen_sql,$param, $obBD)
	{
		...
		return $this->consulta(sentencias_activo($sen_sql,$Par_Sql), $obBD->conexion);
	}
	...
	*/
	...
	{
		$Par_Sql= $this->parametros($param);
		$Query = sentencias_activo($sen_sql,$Par_Sql);//mismo que el archivo sql
