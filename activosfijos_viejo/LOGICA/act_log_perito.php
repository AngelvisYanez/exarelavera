...
require_once("act_sql_perito.php");
...
class Class_Log_Datos_Per extends MysqlDatos{
	...
	*/
	function consultasobBD($sen_sql,$param, $obBD)
	{
		...
		return $this->consulta(sentencias_per($sen_sql,$Par_Sql), $obBD->conexion);
	}
	...
	*/
	...
	{
		$Par_Sql= $this->parametros($param);
		$Query = sentencias_per($sen_sql,$Par_Sql);//mismo que el archivo sql
