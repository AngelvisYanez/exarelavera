<?php
/**
 * @abstract Permite realizar el registro de requisitores
...
if (isset($savePersonal)) {
    ...
    $obBD_con1->operacionobBD(5, $Prs_Cod . '*' . $Ses_Emp_Cod . '*' . $Per_Car . '*' . $Per_Tit . '*' . $Per_Obs.'*'.$Per_Cfi, $obBD_conexion);
...
<HTML>
    ...
    <BODY>
        <div class="panel panel-main">
            <div class="panel-heading exa-header"><h3 class="panel-title">&raquo;  Registrar Requisitor</h3></div>
