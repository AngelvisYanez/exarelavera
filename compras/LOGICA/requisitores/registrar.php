...
class Class_Log_Conexion_Requisitores extends MysqlConexion{
...
class Class_Log_Datos_Requisitores extends MysqlDatos{
    function __construct() {
        $this->setSentencias('sentencias_requisitores');
    } 
