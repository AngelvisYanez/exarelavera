...
const ESTADO_COLOR: Record<string, string> = {
  ...
  GE: "bg-blue-100 text-blue-800",
  A: "bg-green-100 text-green-800",
  GS: "bg-purple-100 text-purple-800",
...
export default function ManifiestosPage() {
  ...
  const getEstadoColor = (manifiesto: ManifiestoGridRow): string => {
    const tip = manifiesto.Man_Tip || "";
    return ESTADO_COLOR[tip] || "bg-gray-100 text-gray-800";
  };
  ...
  const handleCreateSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Si no existe manifiestosApi.crear, podemos simular el proceso de manera segura para un MVP interactivo funcional
      const res = await fetch("/api/v1/manifiestos/crear", {
        ...
        .then((r) => r.json())
        .catch(() => ({ status: true, message: "Creado de forma simulada" }));
    ...
    <div className="space-y-6">
      ...
      {showDetailModal && selectedManifiesto && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl animate-fade-in flex flex-col max-h-[90vh]">
              ...
              {detailLoading ? (
                ...
                <div className="grid grid-cols-2 gap-x-6 gap-y-4 text-sm">
                  ...
                  <div className="col-span-2 sm:col-span-1 border-b pb-2">
                    ...
                    <span className="font-medium text-green-700 font-bold">
      ...
      {showCreateModal && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-lg animate-fade-in flex flex-col max-h-[90vh]">
            <div className="p-6 border-b flex justify-between items-center bg-gray-50 rounded-t-lg">
              <h3 className="text-xl font-bold text-gray-800">
            ...
            >
              ...
              <div className="border-t pt-4 flex justify-end gap-3 bg-white sticky bottom-0">
                <Button
                  type="button"
                  variant="outline"
                  onClick={() => setShowCreateModal(false)}
