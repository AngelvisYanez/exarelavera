...
if(isset($getDatosProveedor)){
	try {
		$data=$_Get;
		$provee=$obBD_con1->getArrayConsulta(1, $data, $obBD_conexion);
...
if (isset($saveProductor)) {
    ...
    if ($cont['productor']<=0) {
	    ...
	    try {
	    	$obBD_ins1->operacionobBD(4,$data,$obBD_conexionIns);
...
<html>
	...
	<BODY>
		<div class="panel panel-main">
			<div class="panel-heading exa-header"><h3 class="panel-title">&raquo;Alta de Productores</h3></div>
			<div class="panel-body ui-widget-content ui-corner-bottom exa-body">
				<?php include("COMPONENTES/form_productor.html");?>
			</div>
		</div>
		<script src="../../framework/jquery/bootstrap/popover/jquery.flyout.js"></script>
		<script type="text/javascript" src="../../framework//jquery/jquery.plugins/MaskedInput//jquery.maskedinput.1.4.1.min.js"></script>
		<script type="text/javascript" src="../../framework/plugins/knockout-3.4.2.js"></script>
