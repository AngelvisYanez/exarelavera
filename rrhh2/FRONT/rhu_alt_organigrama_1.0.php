...
/* 
Alias:	Registrar
Descripción: Permite registrar los departamentos y cargos de la insititucion
Fecha de actualización:	2011-02-21
...
if (isset($ndepartamento))
{
	...
	{			
		...
		$obBD_con1->grabarv_registros(sentencias_rhu(668, $obBD_con1->parametros($txt_busqueda.'*'.$Dep_Des.'*'.$np.'*'.$Ses_Emp_Cod)),$obBD_conexion->conexion);	
		/*Fin del la transaccion*/
		$obBD_con1->fin_transaccion($obBD_conexion->conexion);
	}//Fin del if ($thisPost->postBlock($_POST['postID'])) 
}

/* Grabado de una seccion nueva en algun nodo del plan */
if (isset($nseccion))
{
	if ($thisPost->postBlock($_POST['postID'])) 
	{			
		...
		$obBD_con1->inicio_transaccion($obBD_conexion->conexion);
		/* Inserción de distributivo */
		$obBD_con1->grabarv_registros(sentencias_rhu(706, $obBD_con1->parametros($np.'*'.$Sec_Des)),$obBD_conexion->conexion);	
		/*Fin del la transaccion*/
		$obBD_con1->fin_transaccion($obBD_conexion->conexion);
	}//Fin del if ($thisPost->postBlock($_POST['postID'])) 
}
...
if (isset($ncargo))
{
	...
	{			
		...
		$obBD_con1->inicio_transaccion($obBD_conexion->conexion);
		/* Inserción de distributivo */
		$obBD_con1->grabarv_registros(sentencias_rhu(669, $obBD_con1->parametros($np.'*'.$Tic_Des)),$obBD_conexion->conexion);	
		/*Fin del la transaccion*/
		$obBD_con1->fin_transaccion($obBD_conexion->conexion);
	}//Fin del if ($thisPost->postBlock($_POST['postID'])) 
}
...
<tr class="BarraTitulo">
  <td height="10">&raquo; Registro de Departamentos &amp; cargos</td>
</tr>
	<tr>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" >
	  <tr>
	    <td width="5%" class="Etiqueta1" >Area:&nbsp;</td>
	    <td width="95%" class="LetraNegra" ><?Php echo $row_rs_areas['Are_Des']; ?></td>
	    </tr>	  
	  </table>
   ...
   { 
	  ...
	  <tr>
		   ...
		   if ($total_rs_secciones > 0)
			{ 		
				do{
				   echo '<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="../../mascaras/model1/imagenes/32x32/view_choose.png" width="22" height="25" title="Departamento">'."Cód. Int.:".$row_rs_secciones['Sec_Cod'].' - '.$row_rs_secciones['Sec_Des']; ?>
				  <?
			   } while ($row_rs_secciones = $obBD_con1->fetch_assoc($rs_secciones));
...
<table border="0" cellpadding="0" cellspacing="0">
		      ...
		      <form action="<? echo $_SERVER['PHP_SELF'];?>" method="post" name= "form3" id="form3">
               ...
               <span>&nbsp;&nbsp;Atr&aacute;s&nbsp;&nbsp;</span>
			    ...
			    <td align="right"><input name="Departamento" type="button" class="Boton_Departamento" title="Agregar departamento" id="Departamento" value="" onClick="botones_org(1)"></td>
    <?Php
    /* np = 0, significa que se encuentra en la raiz del arbol */
	if ($np!=0) 
	 { ?>
			    <td align="right"><input name="Seccion" type="button" class="Boton_Distribuir" title="Agregar sección" id="Seccion" value="" onClick="botones_org(2)"></td>
                <td align="right"><input name="Cargo" type="button" class="Boton_Persona_Formal" title="Agregar cargo" id="Cargo" value="" onClick="botones_org(3)"></td>
 ...
 <div id="id_departamento">
   <form action="<? echo $_SERVER['PHP_SELF'];?>" method="post" name= "form4" id="form4">        
	...
	$thisPost->startPost(); ?>    
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
	      <tr>
	        ...
	        <td width="87%" class="LetraNegra"><input name="Dep_Des" type="text" id="Dep_Des" size="50" maxlength="50">&nbsp;</td>
          </tr>
	      <tr>
	...
	<br>
    <input name="btn_save" type="button" class="Boton_Guardar" title="Guardar" id="btn_save" onClick="validar_requeridos(this.form, 'Dep_Des', 1)" value="Guardar">
	  </form> 
	  </div>   
       <div id="id_seccion">
      <form action="<? echo $_SERVER['PHP_SELF'];?>" method="post" name= "form4" id="form">
        <FIELDSET>
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="13%" class="Etiqueta1"><span class="Asterisco">*</span> Sección:&nbsp;</td>
              <td width="87%" class="LetraNegra"><input name="Sec_Des" type="text" id="Sec_Des" size="50" maxlength="50">
                &nbsp;</td>
            </tr>
            <tr>
              <td class="LetraNegra">&nbsp;</td>
    ...
    <div id="id_cargo">
      <form action="<? echo $_SERVER['PHP_SELF'];?>" method="post" name= "form4" id="form">
        <FIELDSET>
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="13%" class="Etiqueta1"><span class="Asterisco">*</span> Cargo:&nbsp;</td>
              <td width="87%" class="LetraNegra"><input name="Tic_Des" type="text" id="Tic_Des" size="50" maxlength="50">
                &nbsp;</td>
            </tr>
            <tr>
              <td class="LetraNegra">&nbsp;</td>
        ...
        <br>
        <input name="btn_save" type="button" class="Boton_Guardar" title="Guardar" id="btn_save" onClick="validar_requeridos(this.form, 'Tic_Des', 1)" value="Guardar">
      </form>
    </div>
