...
class EXAWorkflowIntegrationTestSuite {
    ...
    public function run() {
        ...
        try {
            ...
            echo "\n========================================================================\n";
            echo " ?? TODAS LAS PRUEBAS DE INTEGRACIÓN SE COMPLETARON CON ÉXITO (ALL PASSED)\n";
            echo "========================================================================\n";
        } catch (Exception $e) {
    ...
    protected function testValidacionesCamposObligatorios() {
        ...
        $this->assert(!$action_res['success'], "El motor debió denegar la transacción por comentario obligatorio vacío.");
        ...
        $this->assert(!$action_res_ger['success'], "El motor debió denegar la transacción por adjunto obligatorio ausente.");
