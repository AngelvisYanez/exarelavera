...
- Name: modules.spec.ts >> Módulos EXA Contable Relavera — Flujos Read-Only >> 2. CLIENTES - Listar clientes desde página Actores
- Location: tests\monitoring\modules.spec.ts:62:7
...
Call log:
  - Expect "toHaveURL" with timeout 20000ms
    42 × unexpected value "http://localhost:3000/login"
...
- text: Por favor selecciona una empresa Usuario
- textbox "Usuario":
  - /placeholder: Ingrese su usuario
  - text: "0704439892001"
- text: Empresa
- combobox: Seleccione una empresa
- text: Contraseña
- textbox "Contraseña":
