...
abstract class Zend_Db_Adapter_Abstract
{
     ...
     */
    public function quoteInto($text, $value, $type = null, $count = null, $id_rep = null)
    {
        if($id_rep === null) $id_rep='?';
        if ($count === null) {
            return str_replace($id_rep, $this->quote($value, $type), $text);
        } else {
            return implode($this->quote($value, $type), explode($id_rep, $text, $count + 1));
        }
    }
...
class Auxiliar extends Zend_Db_Adapter_Abstract{
    /**
     * PDO type.
     *
     * @var string
