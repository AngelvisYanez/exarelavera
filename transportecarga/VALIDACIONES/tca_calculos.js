$(function(){
    ...
    //Change para obtener el nï¿½mero de secuencia
    ...
    /*Función para calcular los valores de : subtotal, tarifa0, tarifa12, iva, ice, descuento y total de una factura de venta*/
    /*PARÁMETROS QUE RECIBE*/
    /*  arreglo:detalle de la factura el cual puede ser un array 
        tipo:   indica si el tipo de descuento se lo efectúa en dólares o en porcentaje
    ...
    /* Función para calcular el siguiente número de secuencia*/
    /*PARÁMETROS QUE RECIBE*/
    /*
    ...
    */
    ...
    //Función para cargar los bancos del plan de cuentas
    ...
    //Función para cargar las cuentas deudoras
    ...
    //Función para cargar los datos de un cliente seleccionado
    arreglo=[];
    ...
    //Función para quitar un elemento del detalle de factura
    ...
    //Función para efectuar los calculos de los totales de la factura
    function calcular(){
    ...
    //Función para obtener el número de secuencia
    ...
    //Función para comprobar si el nï¿½mero de secuencia ya se encuentra registrado
    ...
    //Función para presentar cuadro de asientos contables
