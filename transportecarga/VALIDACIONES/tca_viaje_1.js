$(function(){
    ...
    $('#Via_Grid').createGrid({
        ...
        colModel:[
            ...
            { label: '<span class="required"></span> Traslado', name: 'Mot_Cod', width: 55,align:'center',title:false,formatter:'select1', formatoptions:{class:'select_modo',id:'mot_cod',title:'Agregar Traslado',action:"$('#modoDialog').dialog('open');"}},
            ...
            { label: '<span class="required"></span> Serie', name: 'Via_Ded', width: 80,align:'center',title:false,formatter:'input2',formatoptions:{id:'2',attr:''}},
            { label: '<span class="required"></span> Booking', name: 'Via_Has', width: 80,align:'center',title:false,formatter:'input2',formatoptions:{id:'2',attr:''}},
