...
/*Secci�n para cargar los datos de una persona en caso de que esta se encuentre registrada*/
...
<HTML>
    <HEAD>
        ...
        <script type="text/javascript" src="../VALIDACIONES/tca_viaje_1.js"></script>
        <style>
    ...
    <BODY>
        <div class="panel panel-main">
            <div class="panel-heading exa-header"><h3 class="panel-title">&raquo;  Registrar Viaje</h3></div>
                            ...
                            <fieldset class="exa-fieldset">
                                ...
                                <div class="col-md-6 col-sm-8">
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-4 label-sm required">Cliente:</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            <button type="button" class="btn btn-success btn-xs" onclick="$('#personaDialog').dialog('open');"><span class="glyphicon glyphicon-search"></span></button>
                                        </span>
                                    </div>
                                </div>
                            </div>
