...
/*Sección para cargar los datos de una persona en caso de que esta se encuentre registrada*/
...
<HTML>
    <HEAD>
        ...
        <script language="javascript" src="../VALIDACIONES/tca_viaje_1.js"></script>
        <style>
