...
//Secci�n para cargar la configuraci�n de la facturaci�n
...
//Secci�n para cargar los viajes sin facturar de un cliente seleccionado
...
if(isset($saveFactura)){
    ...
    try {
        ...
        //Secci�n para efectuar un insert en la tabla ventas
        ...
        //Secci�n para obtener el id ingresado en la tabla ventas
        ...
        if($Cof_Con=='S'){
            //Secci�n para guardar en la tabla comprobantes
            ...
            //Secci�n para efectuar un insert sobre la tabla ventas_compr
...
<HTML>
    ...
    <BODY>
        <div class="panel panel-main">
            ...
            <div class="panel-body ui-widget-content ui-corner-bottom exa-body">
                ...
                <form id="frm_cab" name="frm_cab" class="form-horizontal normal formulario" action="javascript:">
                    ...
                    <!--Campo de c�digo de la tabla autorizaci-->
        ...
        <!-- Inicio del di�logo para buscar un cliente inmerso en la tabla viaje -->
        ...
        <script type="text/javascript">
            $(function () {
                ...
                $.createSearchDialog('#clienteDialog', [
                    {label: 'C�d.Int.', name: 'Cli_Cod', key: true, hidden: true},
            ...
            //Funci�n para cargar la configuraci�n de la factura tabla confi_fact para saber si la empresa lleva o no contabilidad
            ...
            //Funci�n para guardar una factura de venta
            function saveFactura() {
                ...
                //Se verifica que el n�mero de documento no se repita
