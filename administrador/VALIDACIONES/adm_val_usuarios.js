...
{	
	...
	{
		$.alert("�Ingrese una contrase�a diferente al usuario!",null,'warning');
...
function IsChk(form)
{
	...
	if (found)
	{
		op= confirm("�Est� seguro de realizar esta operaci�n?");
	...
	{
		$.alert("�Es necesario que seleccione al menos una opci�n!",null,'warning');
		return false;
	}
}
