	...
	*/
	if (isset($hdd_save) && $Usu_Pal!="")
	{
		...
		*/
		...
		{
			/**
			* Cierre de la transacci�n sin mensaje de alerta, para evitar error en el 
			*redireccionamiento 
			*/
		...
		//echo error_alerta("La Actualizaci�n de la Contrase�a fue exitosa <br><br> Ingrese nuevamente al sistema con su n�mero de c�dula y la nueva clave <br><br>", 1); 	
