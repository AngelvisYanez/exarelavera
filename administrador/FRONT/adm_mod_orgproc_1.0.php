...
{ ?>
     <div id="id_directorio">
       <?php      
     	/*
		* Consulta los datos de la tabla de organizado
		*/
        ...
        $thisPost->startPost(); ?>    
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="87%" class="LetraNegra"><input name="Org_Des" type="text" id="Org_Des" size="50" maxlength="50" value="<?php echo $row_rs_directorio['Org_Des']; ?>">&nbsp;</td>
              </tr>
              <tr>
                <td class="Etiqueta1"><span class="Asterisco">*</span> Detalle:&nbsp;</td>
                <td class="LetraNegra"><textarea name="Org_Det" cols="70" rows="3" id="Org_Det" value=""><?php echo $row_rs_directorio['Org_Det']; ?></textarea></td>
                </tr>
              <tr>
...
{	
	/*
	* Consulta los datos de un proceso en especifico
	*/
        ...
        <FIELDSET>
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td width="87%" class="LetraNegra"><input name="Pcs_Lin" type="text" id="Pcs_Lin" size="50" maxlength="50" value="<?php echo $row_rs_proceso['Pcs_Lin'];?>">
                &nbsp;</td>
            </tr>
            <tr>
              <td class="Etiqueta1"><span class="Asterisco">*</span> P&aacute;gina:&nbsp;</td>
              <td class="LetraNegra"><input name="Pcs_Nom2" type="text" id="Pcs_Nom2" size="50" maxlength="50" onBlur="caracter(this, '.')" value="<?php echo $row_rs_proceso['Pcs_Nom'];?>">                <input name="Pcs_Nom" type="file" class="Boton" id="Pcs_Nom" size="40">
            ...
            <tr>
              ...
              <td class="LetraNegra">
                ...
                <?Php 
                    ...
                    <tr><td>
                     <input <?php 
					 if($row_rs_proceso['Rut_Cod'] == $row_rs_rutas['Rut_Cod']){
						echo "checked";
					 }?> name="Rut_Cod" id="Rut_Cod" type="radio" value="<?php echo $row_rs_rutas['Rut_Cod'];?>" >
            ...
            <tr>
              ...
              <td class="LetraNegra"><select name="Pcs_Tip" id="Pcs_Tip">
                ...
                <option value="P" <?php if($row_rs_proceso['Pcs_Tip']=='P'){echo "selected";}?> >Proceso</option>
                <option value="R" <?php if($row_rs_proceso['Pcs_Tip']=='R'){echo "selected";}?> >Reporte</option>
                </select></td>
            </tr>
            <tr>
              ...
              <td class="LetraNegra"><select name="Tpr_Cod" id="Tpr_Cod">
				...
				?>
                    <option value="<?php echo $row_rs_tipo_proce['Tpr_Cod']; ?>" <?php if($row_rs_proceso['Tpr_Cod'] == $row_rs_tipo_proce['Tpr_Cod'] ){echo "selected";} ?> ><?php echo $row_rs_tipo_proce['Tpr_Des']; ?></option>
                <?Php
				 }
				?>
              </select></td>
            ...
            <tr>
              <td class="Etiqueta1"><span class="Asterisco">*</span> Detalle:&nbsp;</td>
              <td class="LetraNegra"><textarea name="Pcs_Det" cols="70" rows="3" id="Pcs_Det"><?php echo $row_rs_proceso['Pcs_Det'];?></textarea></td>
            </tr>
            <tr>
              <td class="Etiqueta1">Orden:&nbsp;</td>
              <td class="LetraNegra"><input name="Pcs_Ord" type="text" id="Pcs_Ord" size="3" maxlength="3" onKeyPress="return validar_numeric(event)" value="<?php echo $row_rs_proceso['Pcs_Ord'];?>"></td>
            </tr>
            <tr>
              <td class="LetraNegra">&nbsp;</td>
              <td class="LetraNegra">
...
if (isset($ndirectorio))
{
	...
	{		
		...
		if ($flag1 != "0" and  $flag2 != "0")
		{
			...
			*/
			$params = $np.'*'.$Org_Det.'*'.$Org_Des.'*'.$file1[count($file1)-1].'*'.$file2[count($file2)-1].'*'.$Org_Cod;
			/*
			* Variable que me indica si la imagen se subio correctacmente
			*/					
			$obBD_con1->operacionobBD(9, $params, $obBD_conexion);	
			/*
...
if (isset($nproceso))
{
	...
	{	
		...
		if ($flag3 != "0")
		{
			...
			*/
			$param_dis = $np.'*'.$Pcs_Lin.'*'.$file3[count($file3)-1].'*'.$ruta[0].'*'.$Pcs_Tip.'*'.$Pcs_Det.'*'.$Tpr_Cod.'*'.$Pcs_Ord.'*'.$nproceso;
			/*
			* Inserci�n de distributivo 
			*/
			$obBD_con1->operacionobBD(10, $param_dis, $obBD_conexion);	
			/*
			* Fin del la transaccion
			*/
			$obBD_con1->fin_transaccion($obBD_conexion->conexion);
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table">
	<tr class="BarraTitulo">
	  <td height="10">&raquo; Modificaci&oacute;n de Directorios y Procesos </td>
  </tr>
	<tr>
	  ...
	  <tr>
	    ...
	    <td width="35%"><?Php echo $row_rs_procesos['Rut_Des']."<b>".$row_rs_procesos['Pcs_Nom']."</b>"; ?></td>
	  	...
	  	<td align="center">
            ...
            <button type="button" title="Editar" class="btn btn-primary btn-mini"  onClick="ajax_datos('<?php echo $_SERVER['PHP_SELF']; ?>?ajax_op2=<?php echo $row_rs_procesos['Org_Cod']; ?>&np=<?php echo $row_rs_procesos['Pcs_Cod']; ?>','ajax_modal');Muestra_Aparecer();"><i class=" icon-edit icon-white"></i>
</button>
            </form>
        </td>
        <td align="center">&nbsp;</td>
