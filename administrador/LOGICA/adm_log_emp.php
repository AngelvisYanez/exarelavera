...
class Class_Log_Conexion_Emp extends MysqlConexion{
 ...
 *
 */
class Class_Log_Datos_Emp extends MysqlDatos{	
	/**
	...
	*/
	function consultasobBD($sen_sql,$param, $obBD)
	{
		...
		$Par_Sql= $this->parametros($param);
               // var_dump($Par_Sql);
		return $this->consulta(sentencias_emp($sen_sql,$Par_Sql), $obBD->conexion);
	}
	...
	*/
	...
	{
		$Par_Sql= $this->parametros($param);
		return $this->grabarv_registros(sentencias_emp($sen_sql,$Par_Sql), $obBD->conexion);
	}
