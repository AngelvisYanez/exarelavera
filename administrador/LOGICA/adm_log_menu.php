 ...
 * @package administrador.LOGICA
 */
class Class_Log_Conexion_Men extends MysqlConexion{
 ...
 * @package administrador.LOGICA
 */
class Class_Log_Datos_Men extends MysqlDatos{
	...
	function consultasobBD($sen_sql,$param, $obBD = null)
	{
		...
		return $this->consulta(sentencias_men($sen_sql,$Par_Sql), $obBD->conexion);
	}
	...
	{
		$Query = sentencias_men($sen_sql,$this->parametros($param));
