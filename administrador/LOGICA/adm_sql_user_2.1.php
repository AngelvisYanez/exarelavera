...
function sentencias_cli($id,$Par_Sql)
{
	switch($id)
	{
        ...
        case 28://  Get Perfiles by Empresa
            $sql = "SELECT Per_Cod, Per_Des FROM perfiles WHERE Emp_Cod = $Par_Sql[0] AND Per_Est='A' AND Per_Des != 'Administrador de Sistemas'";
            return $sql;
        break;
        ...
        case 38://  Select User by Cedula and Apellido
            $sql = "SELECT persona.Prs_Cod, usuarios.Usu_Est, usuarios.Usu_Cod, persona.Prs_Ced, CONCAT(persona.Prs_Ape,' ',persona.Prs_Nom) as persona, usuarios.Suc_Cod, persona.Prs_Cod, pu.Pun_Cod, pu.Pun_Des as Pun_Des_m "
        ...
        case 39://  Select all Users
            $sql = "SELECT usuarios.Usu_Cod,usuarios.Usu_Est, persona.Prs_Ced, CONCAT(persona.Prs_Ape,' ',persona.Prs_Nom) as persona, usuarios.Suc_Cod, persona.Prs_Cod, pu.Pun_Cod, pu.Pun_Des as Pun_Des_m "
                ...
                . "INNER JOIN sucursal as suc on suc.Suc_Cod = usuarios.Suc_Cod and suc.Emp_Cod= $_SESSION[Ses_Emp_Cod] "
                . "WHERE usuarios.Usu_Cod IN (SELECT max(usuarios.Usu_Cod) FROM usuarios,sucursal WHERE usuarios.Suc_Cod=sucursal.Suc_Cod AND Prs_Int!='S'  AND Emp_Cod = $_SESSION[Ses_Emp_Cod] GROUP BY usuarios.Prs_Cod ) "
        ...
        case 56:
			$sql = "UPDATE usuarios
					...
					SET Usu_Est= '$Par_Sql[Usu_Est]' 
					WHERE usuarios.Prs_Cod = $Par_Sql[Prs_Cod] AND sucursal.Emp_Cod = $Par_Sql[Ses_Emp_Cod]";
			return $sql;
		break;
	}
}
