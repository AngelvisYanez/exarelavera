...
function sentencias_configs($id,$Par_Sql)
{
    ...
    switch ($id) {
        ...
        case 1:
            ...
            break;
        case 2:
            $sql = "UPDATE empresas SET Emp_Nom = '$Par_Sql[Emp_Nom]', Emp_Rco = '$Par_Sql[Emp_Rco]', Emp_Rep = '$Par_Sql[Emp_Rep]', Emp_Con = '$Par_Sql[Emp_Con]',   Emp_Rre='$Par_Sql[Emp_Rre]', Emp_Reg = '$Par_Sql[Emp_Reg]', Emp_Cnt = '$Par_Sql[Emp_Cnt]' WHERE Emp_Cod = '$_SESSION[Ses_Emp_Cod]'";
            //echo $sql.'<br/>';
            break;
        case 3:
            $sql = "UPDATE confi_fact SET Cof_Con = '$Par_Sql[Cof_Con]',Cof_Fac = '$Par_Sql[Cof_Fac]', Cof_Gce = '$Par_Sql[Cof_Gce]', Cof_Stk='$Par_Sql[Cof_Stk]', Cof_Gcr='$Par_Sql[Cof_Gcr]' WHERE Emp_Cod = '$_SESSION[Ses_Emp_Cod]'";
            //echo $sql.'<br/>';
            break;
        case 4:
