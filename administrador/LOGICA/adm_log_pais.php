...
class Class_Log_Conexion_Pais extends MysqlConexion{
 ...
 *
 */
class Class_Log_Datos_Pais extends MysqlDatos{	
	/**
	...
	*/
	function consultasobBD($sen_sql,$param, $obBD = null)
	{
		...
		$Par_Sql= $this->parametros($param);
               // var_dump($Par_Sql);
		return $this->consulta(sentencias_pais($sen_sql,$Par_Sql), $obBD->conexion);
	}
	...
	*/
	...
	{
		$Par_Sql= $this->parametros($param);
		return $this->grabarv_registros(sentencias_pais($sen_sql,$Par_Sql), $obBD->conexion);
	}
