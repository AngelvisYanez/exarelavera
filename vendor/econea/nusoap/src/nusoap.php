...
class nusoap_server extends nusoap_base
{
    ...
    var $xml_encoding = '';
    /**
     * toggles whether the parser decodes element content w/ mb_convert_encoding(, 'ISO-8859-1', 'UTF-8')
     *
     * @var boolean
     * @access public
     */
...
class nusoap_parser extends nusoap_base
{
    ...
    function character_data($parser, $data)
    {
        ...
        if ($this->xml_encoding == 'UTF-8') {
            ...
            if ($this->decode_utf8) {
                $data = function_exists('mb_convert_encoding') ? mb_convert_encoding($data, 'ISO-8859-1', 'UTF-8') : mb_convert_encoding($data, 'ISO-8859-1', 'UTF-8');
            }
        }
        $this->message[$pos]['cdata'] .= $data;
        // for doclit
...
class nusoap_client extends nusoap_base
{
    ...
    var $decode_utf8 = true;        // toggles whether the parser decodes element content w/ mb_convert_encoding(, 'ISO-8859-1', 'UTF-8')
