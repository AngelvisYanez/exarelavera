    ...
    if ($resumido1 != "T") {
        foreach ($dataReport as $provee) {
            ...
            foreach ($provee['Cpcs'] as $cuenta) {
                ...
                if ($full) $table['{body}'] = $table['{body}'] . '<tr><td style="font-weight:bold;"  colspan="2">' . $Cpp_Data['Com_Codigo'] . '</td>  	    
                    ...
                    <td style="font-weight:bold;" >' . $Cpp_Data['Cpc_Ven'] . '</td>
                    <td></td>
                    <td style="font-weight:bold;" colspan="2">' . $Cpp_Data['Tic_Des'] . ': ' . $Cpp_Data['Vet_Num'] . ' -  ' . $provee['Cliente'] . '</td>
                ...
                if ($Cpp_Data['Cpc_Cod'] != NULL) {
                    ...
                    foreach ($cancelaciones as $pago) {
                        ...
                        if ($PagAbr != 'RET') {
                            ...
                            <td style="text-align:right;mso-number-format:&#39;#,##0.00&#39;;" colspan="1">' . number_format($pago['Cpc_Val'], 2) . '</td>
                            <td></td>
                        </tr>';
                        }
                    }
                ...
                if ($pagoRetencion == false) {
                    ...
                    foreach ($Retenciones as $ret) {
                        ...
                        if ($full) $table['{body}'] = $table['{body}'] . '<tr><td style="font-weight:bold;border-right: ' . $b . ' solid #000;">&gt;</td><td style="color:gray;
                        "></td><td style="text-align:center;">' . $ret['Ret_Fec'] . '</td><td></td><td>' . $ret['tipo'] . '</td><td colspan="2" style="mso-number-format:&#39;@&
                        #39;;">' . $ret['Ret_Num'] . '</td><td></td><td style="text-align:right;mso-number-format:&#39;#,##0.00&#39;;" colspan="2">' . number_format($ret
                        ['retencion'], 2) . '</td><td></td></tr>';
                    }
                }
                if ($full) $table['{body}'] = $table['{body}'] . '<tr><td style="word-wrap: break-word;" colspan="7"><strong>Obs:</strong> ' . $Cpp_Data['Vet_Obs'] . '</td>
                <td colspan="2" style="text-align:right;border-top: ' . $b . ' solid #000;">SALDO DOCUMENTO:</td>
                <td style="border-top: ' . $b . ' solid #000;text-align:right;mso-number-format:&#39;#,##0.00&#39;;">' . number_format($saldo, 2) . '</td></tr><tr>
                <td colspan="9" style="height:20px;"></td></tr>';
    	  ...
    	  <td></td>
            ...
            <td style="border-bottom: 3px double #000;text-align:right;border-top: ' . $b . ' solid #000; mso-number-format:&#39;#,##0.00&#39;;">' . number_format($saldoProvee, 2) . '</td>
                ...
                $table['{body}'] = $table['{body}'] . '<tr>
                <td colspan="8" style="border-bottom:1px solid #D5DADF;"><strong>>>>Cliente: </strong>' . $provee['Cliente'] . '</td>
        ...
        foreach ($dataReport as $provee) {
            ...
            $table['{body}'] = $table['{body}'] . '<tr>
                ...
                <tr>
                <td colspan="8" style="border-left: 0px solid white; border-right:  0px solid white; border-top:0px solid white ;border-bottom: 0px solid #D5DADF; ' . $b . ' solid #000;"></td> 
                <td style="border-left: 0px solid white; border-right:  0px solid white; border-top:0px solid white ;border-bottom: 1px solid #000; ' . $b . ' solid #000;text-align:right;"><strong>Total</strong></td>
                <td style="border-left: 0px solid white; border-right:  0px solid white; border-top:0px solid white ;border-bottom: 1px solid #000; ' . $b . ' solid #000;text-align:right;"><strong>Abonos</strong></td>
                <td style="border-left: 0px solid white; border-right:  0px solid white; border-top:0px solid white ;border-bottom: 1px solid #000; ' . $b . ' solid #000;text-align:right;"><strong>Saldo</strong></td>
                </tr>';
            foreach ($provee['Cpcs'] as $cuenta) {
                ...
                <td style="font-weight:400;" >' . $Cpp_Data['Cpc_Ven'] . '</td> 
...
<HEAD>
    ...
    <!-- variable de negociacion en configuracion -->
    <script>
