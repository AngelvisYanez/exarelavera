                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <fieldset class="exa-fieldset">                           
                                        ...
                                        <!-- Text input-->
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label label-xs " for="Cate_Cod">Categor�a:</label>
                                            <div class="col-sm-6">
                                         ...
                                         <div class="form-group">
                                            <label class="col-sm-3 control-label label-xs " for="Sub_Cod">Subcategor�a:</label>
                                            <div class="col-sm-6">
   ...
   <script type="text/javascript">
    ...
    if($('#prods').length===1){
        ...
        docuView.createGrid({
            ...
            colModel: [
                { label: 'C�d. Int.',  name: 'Pre_Cod',  width: 25, align:"center" },  
                ...
                { label: 'C�d.Int.', name: 'Tpv_Cod', width: 15, align:"center", hidden:true },  
                { label: 'C�d.Int.', name: 'Pre_Com', width: 15, align:"center", hidden:true },
                { label: 'C�d.Int.', name: 'Pre_Por', width: 15, align:"center", hidden:true },  
                { label: 'C�d.Int.', name: 'Pre_Uti', width: 15, align:"center", hidden:true },
                { label: 'C�d.Int.', name: 'Suc_Cod', width: 15, align:"center", hidden:true },
                { label: 'C�d.Int.', name: 'Pro_Cod', width: 15, align:"center", hidden:true },
