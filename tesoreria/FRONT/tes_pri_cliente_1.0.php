...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr align="center">
        <td colspan="4">&nbsp;<?php $obBD_con1->cabeceraReporteStandar($Ses_Suc_Cod, "Listado de Clientes", " ", $obBD_conexion); ?>&nbsp;</td>
        </tr>
	 </table>
 	<table width="100%" border="1" cellpadding="0" cellspacing="0">
      <tr>
        <td width="5%" class="TITULO_REPORTE">Cod. Int. </td>
        <td width="8%" class="TITULO_REPORTE">Cédula/R.U.C.</td>
        <td width="81%" class="TITULO_REPORTE">Cliente </td>
      </tr>
<?php
