...
<table width="608" border="0" class="TablaRepCompr_b">
      ...
      <tr>
		...
		<td width="310" valign="middle" class="Texto_Reporte" style="font-size:14px;"><?php if($row_pri_cheque['Che_Ben']==''){echo $row_pri_cheque['Prs_Ape'].' '.$row_pri_cheque['Prs_Nom'];}else{echo $row_pri_cheque['Che_Ben'];} ?></td>
        <td width="125" valign="middle" style="color: #000000 !important;">**<span class="Texto_Reporte" style="font-size:15px; "><?php echo number_format($row_pri_cheque['Che_Val'],2); ?>**</span></td>
      </tr>
      <tr align="center">
        <td height="25"></td>
