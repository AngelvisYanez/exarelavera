      ...
      <tr>
        <td height="94" colspan="6" align="left" valign="top"><?Php 
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse" >
            ...
            <tr>
              <td colspan="4" class="tituloFact2"><span class="etiquetaFact"><strong>USUARIO:</strong></span><span class="tituloFact">&nbsp;&nbsp; <?php echo $row_rs_datos[0]['usuApe']//.' '.$row_rs_datos[0]['usuNom'];;?></span></td>
              <td>&nbsp;</td>
