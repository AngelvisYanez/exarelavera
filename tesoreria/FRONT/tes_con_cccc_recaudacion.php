                            ...
                            var kardexGrid;
                             $(document).ready(function () {                                 
                                ...
                                kardexGrid.createGrid({
                                    height: 270,
                                    caption:'<span id="caption"></span><div id="order" class="pull-right">Agrupar Por: <select onchange="changeGroup(this.value);"><option value="">Ninguno</option><option value="Pag_Des">Tipo Pago</option><option value="proveedor">Cliente</option></select>&nbsp;</div>',
                                    colModel: [  
