...
<!-- FORMULARIO COMPROBANTE DE EGRESO -->
            <div id="tabs-2">
                ...
                <div colspan="2" style="padding:10px;">
                  <button onclick="$('#comp2').prev('#comp1');" class="btn btn-inverse fileinput-button" title="Volver AtrÃ¡s"><i class=" icon-arrow-left icon-white"></i><span>&nbsp;&nbsp;Atr&aacute;s&nbsp;&nbsp;</span></button><span style="width: 150px;"></span>
