...
<table width="608" border="0" class="TablaRepCompr_b">
      ...
      <tr>
		...
		<td width="371" valign="middle" class="Texto_Reporte" style="font-size:15px;"><strong><? if($row_pri_cheque['Che_Ben']==''){echo $row_pri_cheque['Prs_Ape'].' '.$row_pri_cheque['Prs_Nom'];}else{echo $row_pri_cheque['Che_Ben'];} ?></strong></td>
        <td width="205" valign="middle"><span class="Texto_Reporte" style="font-size:16px;"><strong><? echo number_format($row_pri_cheque['Che_Val'],2); ?></strong></span><b>xxx</b></td>
      </tr>
      <tr align="center">
        <td height="50"></td>
        <td height="53" colspan="2" align="left" valign="top"><span class="Texto_Reporte" style="font-size:15px;">
          ...
          <? $v_absoluto=explode(".",$row_pri_cheque['Che_Val']);
			echo strtoupper(num2letras($v_absoluto[0],false,true).' '.$v_absoluto[1].' /100');
