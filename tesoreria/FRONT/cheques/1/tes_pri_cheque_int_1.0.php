...
<html>
    ...
    <body>
        ...
        <span style="top:57px;left:370px;" class="flota_valor"><b><?php echo number_format($row_pri_cheque['Che_Val'],2).'xxx'; ?></b></span>
        <span style="top:80px;left:25px;" class="flota"><?php echo num2letras($row_pri_cheque['Che_Val']).' xxxxxxxxxxxxxxxxxxx';?></span>
