...
<html>
    ...
    <body>
        <!-- primera linea -->
        <span style="top:39px; left:152px; font-size:12px;" class="flota"><?php if($row_pri_cheque['Che_Ben']==''){echo $row_pri_cheque['Prs_Ape'].' '.$row_pri_cheque['Prs_Nom'];}else{echo $row_pri_cheque['Che_Ben'];} ?></span>
        <!-- valor de cheque -->
        <span style="top:39px; left:552px; font-size:12px;" class="flota"><b><?php echo number_format($row_pri_cheque['Che_Val'],2); ?></b></span>
        <!-- suma -->
        ...
        <!-- Ciudad y fecha -->
        <span style="top:108px; left:125px; font-size:12px;" class="flota"><?php echo $row_institucion['Ciu_Des']?>, &nbsp;<?php list($ann, $mes, $dia) = preg_split('![/.-]!', $fecha); echo $ann.'/'.str_pad($mes, 2, '0', STR_PAD_LEFT).'/'.$dia;?></span>   
    </body>
</html>
<?Php
@$obBD_con1->liberar();
