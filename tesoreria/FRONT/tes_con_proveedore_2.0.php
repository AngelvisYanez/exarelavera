<?php
/**
 * Permite visualizar datos de Proveedore
 *
 * @author car.87cod :)
 * @version 1.0
...
/*Secci�n para listar los proveedore registrados dentro de la empresa*/
...
<div class="panel panel-main">
            <div class="panel-heading exa-header"><h3 class="panel-title">&raquo;  Consultar Proveedore</h3></div>
            <div class="panel-body ui-widget-content ui-corner-bottom exa-body">
                <div id="lista" class="row">
                    <div class="col-md-12">
                        <form id="frm_bus" name="frm_bus" class="form-horizontal normal" action="javascript:$('#Lis_Cli').Search('#frm_bus','ProveedoreAjax');">
                            <fieldset class="exa-fieldset">
                                <legend class="Titulos2">B&uacute;squeda de Proveedore</legend>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 radioset">
                                        ...
                                        <input id="rad_ba2" name="op_opciones" type="radio" value="d" onclick="setfocus(this.form.search)"/><label for="rad_ba2">&nbsp;&nbsp;Proveedore&nbsp;&nbsp;</label>
                                    </div>
                                    <div class="col-sm-4 radioset">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-btn">
                                                <button class="btn btn-success btn-xs" type="button" title="Buscar Proveedore" onclick="this.form.submit()"><span class="glyphicon glyphicon-search"></span> Buscar</button>
                                            </span>
                                        </div>
                                    </div>
                                </div>
<!--                                <div class="form-group">
    ...
    <div id="imprimir" style="display: none;">
        ...
        <?php echo $obBD_con1->getReportHeader($Ses_Suc_Cod, 'REPORTE DE PROVEEDORE', '<span class="subtitle">Total de registros</span>', $obBD_conexion) ?>
    ...
    <div id="exportar" style="display: none;">
        <?php echo $obBD_con1->getReportHeader($Ses_Suc_Cod, 'REPORTE DE PROVEEDORE', '<span class="subtitle">Total de registros</span>', $obBD_conexion, false, 5) ?>
        <table id="tablaExporta" cellspacing="0" cellpadding="0" style="width: 1030px; border-collapse: collapse;table-layout: fixed;"></table>
    </div>
    <!--kk-->
		<script>
                    function imprimir(){
                        $('#tablaReporte').html($('#Lis_Prv').jqGrid('exportGridInnerHTML',{footer:true,generated:false,removeHiddens:true,removeCols:[1]}));
		...
		$(function(){
                ...
                $("#Lis_Prv").createGrid({
                    postData: $("#frm_bus").getData("proveedoreAjax"), height: 295,
                    colModel: [
                        {label: 'Cod.Int.', name: 'Prv_Cod', width: 30, align: "left"},
                        {label: 'C&eacute;dula/R.U.C.', name: 'Prs_Ced', width: 65, align: "left",cellattr:function(){return 'style="'+excelFormats.text+'"';}},
                        {label: 'Nombre', name: 'proveedore', width: 200, align: "left"},
                        {label: 'Direccion', name: 'Prs_Dir', width: 200, align: "left"},
                        {label: 'Correo', name: 'Prs_Cor', width: 120, align: "left"},
			            {label: 'Telefono', name: 'Prs_Tel', width: 70, align: "left"},
                    ]
                }, false, "#Pag_Cli");
