...
<script>   
    ...
    function getPeriodo(){
        for(var i=0;i<periodos.length;i++)
            if(periodos[i]['Pld_Cod']===$("#periodos").val())
                return periodos[i];
                            ...
                            <div class="row">
                                ...
                                <div  class="datasegmento">
                                    <select class="text ui-corner-all"  name="Tia_Cod"  class="isSelectMenu" required>
                                        <option value="">Seleccione...</option>
                                            <?Php 
                                            $row_rs_tipo_asien1 = $obBD_con1->getArrayConsulta(347, "", $obBD_conexion);
                            ...
                            <div class="row">
                                ...
                                <div  class="datasegmento">
                                    <select class="text ui-corner-all"  name="Tia_Cod"  class="isSelectMenu" required>
                                        <option value="">Seleccione...</option>
                                            <?Php 
                                            $row_rs_tipo_asien2 = $obBD_con1->getArrayConsulta(347, "ALL", $obBD_conexion);
                            ...
                            <div class="row">
                                ...
                                <div  class="datasegmento">
                                    <select class="text ui-corner-all"  name="Tia_Cod"  class="isSelectMenu" required>
                                        <option value="">Seleccione...</option>
                                            <?Php 
                                            $row_rs_tipo_asien3 = $obBD_con1->getArrayConsulta(347, "ALL", $obBD_conexion);
