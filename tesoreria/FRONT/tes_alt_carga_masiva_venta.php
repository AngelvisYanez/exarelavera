...
if(isset($saveAportes)){
    ...
    }catch(Exception $e){ $obBD_ins1->rollBack_nomsn($obBD_conexionIns); $responce=array('success'=>false, 'message'=>'No se logro generar el archivo <br/><span style="color:red;">'.$e->getMessage().'</span>', 'error'=>$e->getMessage()); $obBD_con1->echoJson($responce);  }
    if($obBD_ins1->Error==0){ $responce=array('success'=>true); } else{ $responce=array('success'=>false,'message'=>"No se ha logrado realizar la Transaccion",'error'=>$obBD_ins1->MsgError);}  
    $obBD_con1->echoJson($responce);    
...
<BODY> 
    <div class="panel panel-main">
        <div class="panel-heading exa-header"><h3 class="panel-title">&raquo; Reporte aportes extra</h3></div>        
        <div class="panel-body ui-widget-content ui-corner-bottom exa-body">
            ...
            <div>
                <div class="row">   
                   ...
                   <div class="col-xs-12" style="min-height: 250px;"><table id="compextra"></table><div id="listPager"></div></div>  
                </div>
                <div class="row">   
                    <div class="col-xs-12">
