...
if (isset($newConciliacion)) {
    ...
    $last = $obBD_con_get->getRow('conciliacion_bancaria', array('where' => array('conciliacion_bancaria.Ban_Cod' => $conc['Ban_Cod'], 'conciliacion_bancaria.Pec_Cod' => $conc['Pec_Cod']), 'setWhere' => array("isActive", "setEmpCod"), 'order' => 'Cob_Fec DESC'));
    ...
    $asientos = $obBD_con_get->getArray(
        ...
        array(
            ...
            'addCols' => array('' => array(
                ...
                //Doc_Num
               $obBD_con_get->expr(" CONCAT( ' Num.Transf.: ', Num_Doc) AS Num_Doc"),
                /*  $obBD_con_get->expr("
            ...
            <div class="panel-body ui-widget-content ui-corner-bottom exa-body">
                <div class="row">
                    ...
                    <div class="col-xs-12" style="padding-top: 8px;">
                        <button class="btn btn-sm btn-primary" onclick="nuevaConciliacion();"><i class="glyphicon glyphicon-floppy-disk"></i> Nueva Conciliaci&oacute;n</button>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        $("#conciliacionForm").createGrid({
                            ...
                            colModel: [{
                                    ...
                                    formatoptions: {
                                        ...
                                        dataEvents: {
                                            change: 'updateTotal($(this).data("rowId"));'
                                        },
                        ...
                        $("#conciliacion").createGrid({
                            ...
                            colModel: [{
                                ...
                                //{ name: 'paem_imag_src',label:'<i class="glyphicon glyphicon-picture"></i>', width:15, align:'center',viewable: false, formatter:'gridButton', formatoptions:{ action:'showImage', icon:'picture', title:'Seleccionar Item', type:'info', data:['index','Cob_Res'], conditional:function(o){ return !!o.Cob_Res; } }, resizable: false },
                                {
                                    ...
                                    width: 40,
                                    formatter: 'currency',
                                    summaryType: 'sumIfNotDeleted'
                                },
                                {
                                    name: 'view',
                                    label: $.createIcon('eye-open'),
                                    width: 15,
                                    align: 'center',
                                    viewable: false,
                                    formatter: 'gridButton',
