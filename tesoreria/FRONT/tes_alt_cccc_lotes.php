          ...
          <td colspan="2" align="left" valign="top"> 
            <div id="grillaComp" style="padding:10px;">   
                        ...
                        <div style="padding-top:10px;">                            
                            <button type="button" class="btn btn-primary start" onclick="if($('#list').jqGrid('getCol', 'Pago', false, 'sum')===0){$.alert('El valor del Pago es Inválido');}else{SelectFact();}" title="Gestionar el Pago Seleccionado"> <i class="icon-book icon-white"></i> <span>Cobrar</span></button>
                        </div>
                </div> 
                 ...
                 <script type="text/javascript"> 
                        ...
                        function updateSaldos(grid){ 
                            ...
                            for(var i=0;i<rows.length;i++){                                
                                if(rows[i].act==="Yes"){grid.jqGrid("setCell", rows[i].Cpc_Cod, "Pago",rows[i].Saldo );/*console.log(rows[i].Saldo);*/}
                                else{grid.jqGrid("setCell", rows[i].Cpc_Cod, "Pago", "0.00");}
                            }
                        }
                    ...
                    $(document).ready(function () {  
                        ...
                        compGrid.jqGrid({
                            ...
                            colModel: [                               
                                ...
                                { classes:'columnHighlight2',label: 'A Cobrar', name: 'Pago', width: 45, align: 'right', formatter:'currency', decimalPlaces: '2', summaryRound: 2,
                                        formatoptions: {prefix:'$ ', thousandsSeparator:',',decimalSeparator:'.'},
                                        summaryTpl: "Total: {0}",summaryType: "sum" // set the formula to calculate the summary type 
                                }    
                    ...
                    function SelectFact(){ 
                            ...
                            //console.log(cuentas);        
                            valor=(Math.round($('#list').jqGrid('getCol', 'Pago', false, 'sum')*100)/100);
                            resetComp();  
                            $('#comp1').next('#comp2');
                    }
                    function resetPago(){ 
                    ...
                    <form name="formComp" id="formComp" method="post" action="javascript:$.createDialogConfirm('¿Est&aacute; seguro que desea guardar los datos?',null,saveComp)">
                        ...
                        <tr><td valign="top">
                            ...
                            <div class="row">
                                ...
                                <div  class="datasegmento"><input  class="money text small ui-corner-all" name="Com_Val" id="Com_Val_Egre" onchange=" updateValores()" type="text" size="10" maxlength="12" style="text-align:right" onkeypress="return  validar_decimal(event)" /><img src="../../mascaras/model1/imagenes/32x32/info.gif" class="imgMsg" /><label id="lblMsg" class="lblMsg" style="color:blue;"></label></div>
                            </div>                           
