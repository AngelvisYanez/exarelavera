          ...
          <td colspan="2" align="left" valign="top"> 
            <div id="grillaComp" style="padding:10px;">   
                        ...
                        <div style="padding-top:10px;">                            
                            <button type="button" class="btn btn-primary start" onclick="$('#list').stopGridEdit();if($('#list').jqGrid('getCol', 'Pago', false, 'sum')===0){$.alert('El valor del Pago es InvÃ¡lido');updateSaldos($('#list'));}else{SelectFact();}" title="Gestionar el Pago Seleccionado"> <i class="icon-book icon-white"></i> <span>Pagar</span></button>
                        </div>
                </div> 
                 ...
                 <script type="text/javascript"> 
                        ...
                        function setCombo(tipo){ 
                            ...
                            if(tipo==='I') $('#Cmb_Ven').html('<option selected="selected" value="4">Por vencer a 90 dÃ­as &gt;&gt;</option><option value="3">Por vencer a 60 dÃ­as &gt;&gt;</option><option value="2">Por vencer a 30 dÃ­as &gt;&gt;</option>');
                        }
...
<!--                                    <button id="btnBene" onclick="$('#beneDialog').dialog('open');return false;" title="Seleccionar Beneficiario" class="btn btn-success btn-mini" type="button"><i class=" icon-check icon-white"></i></button>-->
                ...
                <div colspan="2" style="padding:10px;">
                    <button onclick="updateSaldos($('#list'));$('#comp2').prev('#comp1');" class="btn btn-inverse fileinput-button" title="Volver AtrÃ¡s"><i class=" icon-arrow-left icon-white"></i><span>&nbsp;&nbsp;Atr&aacute;s&nbsp;&nbsp;</span></button><span style="width: 150px;"></span>
...
<div id="modelo" style="display:none;">
    <table style="margin-bottom:10px;" cellpadding="1" border="1">
        ...
        <tr>
            ...
            <td align="center"><a href="<?php echo $ruta; ?>tes_pri_cheque_rum_1.0.php{link}" target="_blank" title="Banco del RumiÃ±ahui"><img src="../../mascaras/model1/imagenes/32x32/banco_ruminahui.jpg" width="30" height="15"/></a></td>
