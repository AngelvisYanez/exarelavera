<?php 
/**
 * Descripci�n: Alta de cajas para facturaci�n
 * Fecha de actualizaci�n:	2012-03-19 
 ...
 * Fecha de actualizaci�n: 2014-06-01
*/
...
if (isset($ajax_caja))
{
	...
	{ 
	?>
    <font color="#FF0000">La caja fue abierta</font>
    <?Php	
	}
	exit();
}
	...
	?>	
		<form method="post" name= "form2" action="<?php echo htmlspecialchars($_POST['form1'], ENT_QUOTES, 'UTF-8');?>">
			 ...
			 <?Php echo mensaje_requerido(); ?>
			  <table width="559" height="59" border="0" cellpadding="0" cellspacing="0">
				  <tr>
					 <td width="144" height="24" class="Etiqueta1"><span class="Asterisco">*</span>Fecha de apertura:
					 </td>
					 <td width="89">					
	...
	if (isset($hdd_save2)) //apertura de caja
		{	
			...
			{ 
				...
				$obBD_con1->inicio_transaccion($obBD_conexion->conexion);
				$Caj_Hoi = date("H:i:s");
				/* Inserci�n de la apertura de caja */
...
<?Php
echo barra_estado($total_rs_caja);
		  ...
		  <table width="500" border="0" cellpadding="0" cellspacing="0" class="LetraNegra">			 
			 ...
			 <tr>
			   ...
			   <td>&nbsp;<img src="../../mascaras/model1/imagenes/32x32/decrypted2.png" width="24" height="24" border="0" title="<?php echo $row_rs_caja_activa['Caj_Est']; ?>" />
			     <input name="Caj_Exi" id="Caj_Exi" type="hidden"  size="20" maxlength="20" value="" />			     
      ...
      ?>
	      <table width="118" border="0" cellpadding="0" cellspacing="0">
            <tr>
			  ...
			  {
					echo error_alerta (" �No se puede cerrar la Caja del d�a $fecha, porque la fecha actual es $hoy!", 2);  
			  }
			  ?>
...
?>
	...
	<table width="155" border="0" cellpadding="0" cellspacing="0">
      <tr>
		...
		<button type="button" name="button1" class="btn btn-success fileinput-button" title="Abrir Caja" onclick="ajax_datos('<?php echo $_SERVER['PHP_SELF']?>?ajax_new=1&op=2','ajax_contenido');
        Muestra_Aparecer();">
...
<script type="text/javascript" src="../VALIDACIONES/tes_par_aper_caja.js"></script>
