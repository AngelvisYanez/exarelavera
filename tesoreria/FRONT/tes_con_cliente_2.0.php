...
<HEAD>
    ...
    <TITLE><?Php echo "Clientes Consultar [EXA]"; ?></TITLE>
    <meta charset="utf-8">
...
<BODY>
    ...
    <div class="panel panel-main">
        <div class="panel-heading exa-header">
            <h3 class="panel-title">&raquo; Consultar Clientes</h3>
        </div>
    ...
    <script>
        function imprimir() {
            $('#tablaReporte').html($('#Lis_Cli').jqGrid('exportGridInnerHTML', {
                footer: true,
                generated: false,
                removeHiddens: true,
                removeCols: [1]
        ...
        function exportar() {
            $('#tablaExporta').html($('#Lis_Cli').jqGrid('exportGridInnerHTML', {
                footer: true,
                bodyBorder: false,
                removeHiddens: true,
                removeCols: [1]
