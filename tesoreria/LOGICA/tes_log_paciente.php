 ...
 */
require_once("tes_sql_paciente.php");
...
class Class_Log_Datos_Cli extends MysqlDatosContab{
    function __construct(){
        $this->setSentencias('sentencias_pac');
    }
	...
	function InsetPersonaCliente($sen_Prs,$paramPrs,$sen_Cli,$paramCli){
		 ...
		 */
		$this->grabarv_registros(sentencias_pac($sen_Prs,$this->parametros($paramPrs)),$obBD->conexion);
		 ...
		 */
		$this->grabarv_registros(sentencias_pac($sen_Cli,$this->parametros($paramCli)),$obBD->conexion);
