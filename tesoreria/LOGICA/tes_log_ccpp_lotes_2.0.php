...
require_once($APP_REAL_PATH."/tesoreria/LOGICA/tes_sql_ccpp_lotes_2.0.php");

/* Clase para conexion a la capa de acceso a datos */
class Class_Log_Conexion_Ccpp extends MysqlConexion{ }

/* Clase para acceder a los datos*/
class Class_Log_Datos_Ccpp extends MysqlDatosContab{
