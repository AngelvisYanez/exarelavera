...
<label class="Titulos2"> Generales </label>
 ...
 <table width="95%" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	?>
    <select name="Tic_Cod" id="Tic_Cod" onChange="ajax_datos('<?Php echo $_SERVER['PHP_SELF']; ?>?ajax_mar_val=1&punto=<?php echo $row_rs_apercaja['Pun_Cod']; ?>&Tic_Cod='+ document.getElementById('Tic_Cod').value +'&hoy<?php echo $hoy; ?>','contenedormarca')">
    <option  value="">Seleccione...</option>
    <?Php
