...
{		
	...
	<table width="100%" height="17%" border="1" cellpadding="0" cellspacing="0" class="Fondo">
	  ...
	  <tr <? echo focus_row("resaltar_text", "resaltar_back", "undo_resaltar_text", "Cuerpo_ajax");?> class="Cuerpo_ajax">
	    <td height="34%" align="center"><? echo $row_rs_buscta['Gas_Cod']; ?></td>
		<td align="left"><? echo marcar_cadena($txtBusqueda,$row_rs_buscta['Gas_Des'],'#FFFF00', 1); ?></td>
		<td align="left">&nbsp;<? echo formato_numero($row_rs_buscta['Gas_Max'],2,1); ?></td>		
		<td align="center">
		<img src="../../mascaras/model1/imagenes/ok-s.gif" width="16" height="16" title="Agregar cuenta" style="	
		cursor:pointer" onClick="nueva_fila_cajaChica('c_contenido','<? echo $row_rs_buscta['Gas_Cod']; ?>','<? echo $row_rs_buscta['Gas_Des']; ?>','<? echo $row_rs_buscta['Gas_Max']; ?>','<? echo $Cja_Tra?>')">
		</td>
	  </tr>
