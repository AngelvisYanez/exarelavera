...
<table width="100%" height="28" border="0">
  <tr>
    ...
    <td colspan="3"><span class="LetraNegra">
      <input name="Cop_Num" type="text" id="Cop_Num" size="15" maxlength="15" 
	  
	  onblur="var formato=/^[0-9]{3}-[0-9]{3}-[0-9]{7}$/;	
	  if(validar_formato(this,formato,'Los n&uacute;meros de las facturas deben cumplir el siguiente formato: 999-999-9999999\nEjemplo: 001-001-0000586')){
