...
*/ ?>
  ...
  <tr>
    ...
    <td colspan="2"><span class="LetraNegra"><input name="Ret_Int" type="text" id="Ret_Int" style="text-align:right" size="15" maxlength="15" value="<?Php echo $Ret_Id_Man; ?>" onblur="ajax_datos('<?Php echo $_SERVER['PHP_SELF']; ?>?ajax_con_numrenta=1&Pun_Cod=<?Php echo $row_rs_vendedor['Pun_Cod']; ?>&Aut_Cod=<?Php echo $row_rs_autorizacion['Aut_Cod']; ?>&Ret_Id_Man=<?Php echo $Ret_Id_Man; ?>&numIni=<? echo $row_autorizacion_sri['Aut_Ini'];?>&numFin=<? echo $row_autorizacion_sri['Aut_Fin'];?>&Vnd_Cod=' + document.getElementById('Vnd_Cod').value +'&Ret_Int=' + this.value,'div_con_num_renta');">
	</span>
	</td>    
  </tr>
  </table>
