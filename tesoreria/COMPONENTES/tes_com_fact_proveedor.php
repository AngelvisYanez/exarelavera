...
/*Componente que pemite listar las facturas que tiene pendiente todos los proveedores en general*/

	if(isset($hoy))
	{
	/*consulta de las facturas del proveedor*/
	$rs_factura = $obBD_con1->consulta(sentencias_tes(841, $obBD_con1->parametros($txt_fec_fin)), $obBD_conexion->conexion);	//.'*'.$Pec_Cod
...
<FIELDSET>
			...
			<label class="Titulos2">Facturas a cr&eacute;dito</label>
				...
				{	  
				 ...
				 /*cONSULTA PARA OBTENER LOS DIAS QUE FALTAN PARA VENCER UNA FACTURA **/
				  ...
				  <tr class="Fondo">
					...
					<td width="15%" align="center"><?Php echo $row_rs_factura['Prs_Ape'].' '.$row_rs_factura['Prs_Nom'];?>&nbsp;
					</td>
					...
					<input name="Pec_Cod" id="Pec_Cod" type="hidden" value="<?Php  echo $Pec_Cod; ?>">	
					 ...
					 <input name="cadena" type="hidden"  id="cadena"  value="<?php  echo $cadena;?>">	 </td>
				  </tr>
			  ...
			  <td align="right"><strong><?Php echo formato_numero($suma_saldo, 2, 3);?></strong></td>
			  <td align="right"><strong><?Php echo formato_numero($suma_final, 2, 3);?></strong></td>
			  </tr>
