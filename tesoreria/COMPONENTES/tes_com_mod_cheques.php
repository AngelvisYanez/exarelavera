<?php
/* Alias: [--]
   Descripci�n: Componente que permite mostrar los datos del cheque a modificar.
...
$obBD_con1->free_result($rs_cuentas_cheque);
		 		...
		 		echo error_alerta("<< Error de componente: tes_com_mod_cheque.php >> <br>Descripci�n: No se ha definido la Propiedad: Pec_Cod<br>
    	    	Pec_Cod: Variable que contiene el nombre del texto que posse el codigo de la compra", 2);
		 }
	  }else{ /* else if(isset($Cop_Bus)){ */
  			
      			echo error_alerta("<< Error de componente: tes_com_mod_cheque.php >> <br>Descripci�n: No se ha definido la Propiedad: Cop_Bus<br>
    	    	Cop_Bus: Variable que contiene el nombre del texto que posse el codigo de la compra", 2);
  			}
		 }else{ /* else if(isset($For_Cod)){ */    
				echo error_alerta("<< Error de componente: tes_com_mod_cheque.php >> <br>Descripci�n: No se ha definido la Propiedad: For_Cod<br>
