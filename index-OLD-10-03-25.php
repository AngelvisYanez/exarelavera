      ...
      <form action="administrador/FRONT/adm_con_control_1.2.php" method="post" name="acceso" id="acceso">
        ...
        <div class="login-fields">
          ...
          <div class="field">
            ...
            <input type="text" id="user_name" name="user_name" value="" placeholder="Usuario" class="login username-field" onBlur="if(trim(this.value) !== ''){ loadEmp(this.value);/*ajax_classic('<?Php echo $_SERVER['PHP_SELF']; ?>?ajax_empresas=1&ajax_username='+this.value,'div_empresas');*/ }" />
          </div>
          <!-- /field -->          
          <div class="field">
