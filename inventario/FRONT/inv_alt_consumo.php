...
if(isset($proAjax)){
    $responce=$obBD_con1->getPageGrid(1, $search.'*'.$Ses_Emp_Cod.'*'.$op_opciones, $obBD_conexion);
...
//            $obBD_ins1->operacionobBD(16, $kardexie, $obBD_conexion_Ins);
	    ...
	    if($add){
		 array_push ($Prods, $kardexie);
	    }
        }
	//ChromePhp::log($Prods);
        foreach ($Prods AS &$c){            
            //actualiza stock
            $obBD_con1->updateStockProd($Ses_Suc_Cod,$c,true,$obBD_conexion,$obBD_conexion_Ins);
        }
        //var_dump($Prods);
...
<BODY>
    ...
    <div class="panel panel-main">
        <div class="panel-heading exa-header"><h3 class="panel-title">&raquo; Registrar Consumos</h3></div>
                    ...
                    <div class="col-xs-4">
                        ...
                        <fieldset class="exa-fieldset">                           
                           <legend class="Titulos2">Datos del Movimiento:</legend> <!-- Form Name -->
                            ...
                            <div class="form-group" >
                              <label class="col-sm-3 control-label label-xs required">Tipo:</label>  
                              <div class="col-sm-9">                                       
                            ...
                            <div class="form-group">
                              <label class="col-sm-3 control-label label-xs required">N�mero:</label>  
                              <div class="col-sm-9">   
                        ...
                        <script>//                            
                            ...
                            $(document).ready(function () {
                                ...
                                kardexGrid.createGrid({
                                    ...
                                    colModel: [                               
                                        { label: 'C�d.Int.', name: 'Index', key:true, hidden:true,viewable:true, width: 25,align:'center' }, 
                                        { label: 'C�d.Int.', name: 'Pro_Cod', hidden:false,viewable:true, width: 25,align:'center' }, 
                                        { label: 'C�d.Int.', name: 'Iva_Cod',hidden:true,viewable:false, width: 0,align:'center' }, 
                                        ...
                                        { label:'&nbsp;', name: 'act1', width: 15, align: 'center',viewable: false, formatter:'gridButton',formatoptions:{action:eliminarFila,title:'Quitar',data:function(o){ return o.Index; }, type:'danger', icon:'trash'} }                                           
                                    ]                                    
                            ...
                            function eliminarFila(Index){ $('#prods').jqGrid('delRowData',Index); }
            ...
            <fieldset class="exa-fieldset">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7" >
                        ...
                        <input name="search" onkeydown="if (event.keyCode === 13) this.form.submit()" type="text" size="50" maxlength="50" placeholder="Ingrese b�squeda..." autofocus  class="form-control input-sm "/>
...
<script>
    function validarForm(){
        ...
        $.createDialogConfirm('Esta seguro que desea guardar el  <b>Consumo</b>.', data, guardar,function (){$("#prods").startGridEdit();});
    }
