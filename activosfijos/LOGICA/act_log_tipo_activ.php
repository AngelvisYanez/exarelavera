...
require_once("act_sql_tipo_activ.php");
...
class Class_Log_Conexion_Act extends MysqlConexion{
...
class Class_Log_Datos_Act extends MysqlDatos{
	...
	*/
	function consultasobBD($sen_sql,$param, $obBD = null)
	{
		...
		return $this->consulta(sentencias_act($sen_sql,$Par_Sql), $obBD->conexion);
	}
	...
	*/
	...
	{
		$Par_Sql= $this->parametros($param);
		$Query = sentencias_act($sen_sql,$Par_Sql);//mismo que el archivo sql
