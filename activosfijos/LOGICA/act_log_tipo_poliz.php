 ...
 * @author car.87cod :)
 * @version 1.0
 * Fecha de actualizaciÃ³n:	2012-04-16
 *
 * @package tesoreria.LOGICA
 */

require_once ('../../auditoria/LOGICA/aud_log_auditoria.php');
require_once("act_sql_tipo_poliz.php");
...
class Class_Log_Conexion_Tipo_Poliz extends MysqlConexion{
...
class Class_Log_Datos_Tipo_Poliz extends MysqlDatos{
	...
	*/
	function consultasobBD($sen_sql,$param, $obBD = null)
	{
		...
		return $this->consulta(sentencias_tipo_poliz($sen_sql,$Par_Sql), $obBD->conexion);
	}
	...
	*/
	...
	{
		$Par_Sql= $this->parametros($param);
		return $this->grabarv_registros(sentencias_tipo_poliz($sen_sql,$Par_Sql), $obBD->conexion);
	}
