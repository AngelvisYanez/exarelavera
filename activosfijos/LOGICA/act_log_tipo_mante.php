 ...
 *
 * @author JosÃ© AmbuludÃ­
 * @version 1.0
 * Fecha de actualizaciÃ³n:	2016-06-03
 *
 * @package tesoreria.LOGICA
 */

require_once ('../../auditoria/LOGICA/aud_log_auditoria.php');
require_once("act_sql_tipo_mante.php");
...
class Class_Log_Conexion_Tipo_Mante extends MysqlConexion{
...
class Class_Log_Datos_Tipo_Mante extends MysqlDatos{
	...
	*/
	function consultasobBD($sen_sql,$param, $obBD = null)
	{
		...
		return $this->consulta(sentencias_tipo_mante($sen_sql,$Par_Sql), $obBD->conexion);
	}
	...
	*/
	...
	{
		$Par_Sql= $this->parametros($param);
		return $this->grabarv_registros(sentencias_tipo_mante($sen_sql,$Par_Sql), $obBD->conexion);
	}
