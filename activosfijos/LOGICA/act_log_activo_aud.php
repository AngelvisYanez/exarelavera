...
require_once ("act_sql_activo_aud.php");

/**
 * Clase para conexion a la capa de acceso a datos
 * @author car.87cod :)
 * 
 * @package activosfijo.LOGICA
 */
class Class_Log_Conexion_Cch extends MysqlConexion{
 ...
 * @author car.87cod :)
 *
 * @package activosfijos.LOGICA
 */
class Class_Log_Datos_ActAu extends MysqlDatos{
	...
	function consultasobBD($sen_sql,$param, $obBD = null)
	{
		...
		return $this->consulta(sentencias_act_aud($sen_sql,$Par_Sql), $obBD->conexion);
	}
	...
	{
		$Query = sentencias_act_aud($sen_sql,$this->parametros($param));
