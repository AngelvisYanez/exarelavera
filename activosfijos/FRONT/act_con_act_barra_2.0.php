...
<?php	
/**
* Descripci�n: Reporte de codigo de barras de Activos
* Fecha de actualizaci�n:	2011-08-02
* Fecha de actualizaci�n:	2013-05-028
    ...
    <tr>
		...
		<table width="842" border="0">                               
              <tr>
                ...
                <span class="LetraNegra">Descripci�n</span></td>
                ...
                <td width="153" class="LetraNegra">
                    ...
                    <span class="LetraNegra"></span>
                <span class="LetraNegra">C�digo secuencial</span>
                </td>
