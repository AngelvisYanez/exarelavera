...
<HTML>
    ...
    <BODY>
        ...
        <script type="text/javascript">
            ...
            $("#list_1").createGrid({    
                height: 200, rowNum: 10000000, pgbuttons: false,pgtext: null, caption:'Cuenta Depreciaci�n',            
                colModel: [
                    { label: 'Dep.C�d', name: 'Dep_Cod', width: 40, align:"center", hidden:false },
                    { label: 'C�d.Int.', name: 'Pld_Cod', key: true, width: 40,align:"center", hidden:false },                                
            ...
            function deleteCuenta(Dep_Cod)
            {
                ...
                $.createDialogConfirm('�Est� seguro que desea eliminar esta cuenta?',data,deleteCta);
            }
