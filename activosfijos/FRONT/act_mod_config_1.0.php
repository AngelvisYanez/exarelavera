<?php
/**
 * @abstract Permite realizar la edici�n de la configuraci�n de activos.
 * @author Jos� Ambulud�
 * @version 1.0
 * Fecha de creaci�n  2016-12-08
 */
...
//Secci�n para verificar si ya se registro un ingreso en la tabla config_activo
...
//Secci�n para cargar datos registrados
if(isset($cargar)){
...
//Secci�n para eliminar un registro de porcentaje de la tabla activo_poorcent
...
<HTML>
    ...
    <BODY>
                        ...
                        <fieldset class="exa-fieldset">
                            ...
                            <form id="frm_Con" name="frm_Con" class="form-horizontal normal" action="javascript:saveForm();">
                                <div id="modificar">
                                    ...
                                    <!--Campo que especifica que se har� un insert en la tabla activo_porcent-->
        ...
        <script type="text/javascript">
            ...
            //Funci�n para verificar si existe un registro la tabla config_activo
            function verificar(){
            ...
            //Funci�n para comprobar de que no exista al menos un registro en la tabla activo_deprecia
            function comprobar(){
                $.post("<?Php echo htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES, 'UTF-8');?>",{comprobar:true},function(response){
                    if(response['existe']===true){
                        ...
                        $.alert('El proceso de depreciaci&oacute;n ya se encuentra iniciado, por tal motivo no se puede modificar la configuraci�n..!!');
                    }
                },'json').fail(function(){$.alert();});
            }
            function cargar(){
