    ...
    <label class="Titulos2">Buscar por:&nbsp;</label>
     ...
     <table height="36" border="0" cellpadding="0" cellspacing="0">
       <tr class="BarraBusqueda">
		...
		?>
               <option <? if($row_rs_tip_act['Tia_Cod'] == $Tia_Des){echo " selected";}?> value="<?php echo $row_rs_tip_act['Tia_Cod']?>"  ><?Php echo $row_rs_tip_act['Tia_Des'].'('.$row_rs_tip_act['Tia_Cdc'].')'?> </option>
               <?php
			} ?>
           </select></td>
...
<fieldset>
  <LEGEND>
	...
	<tr>
	  ...
	  <td width="83%" class="LetraNegra">&nbsp;<?php echo $row_rs_con_tip_act["Tia_Des"];?> 
	    <input type="hidden" name="Tia_Cdc" id="Tia_Cdc" value="<? echo $row_rs_tip_act['Tia_Cdc'];?>">
	 	</td>
	  </tr>
	<!--<tr>
  ...
  <input name="Tia_Des" type="hidden" id="Tia_Des" value="<? echo $Tia_Des; ?>">
    ...
    <tr>
	  ...
	  <button name="boton_guardar" id="boton_guardar" title="Guardar" type="button" class="btn btn-primary fileinput-button" value="Guardar" <? if($str != ""){ ?> onClick="validar_requeridos(this.form,'Act_Des*Suc_Cod*Prv_Cod*Pri_Cod*Cus_Cod*Est_Cod*Act_Can*<?php echo substr($str, 0, -1); ?>',1)" <? }else{?>onClick="validar_requeridos(this.form,'Act_Des*Suc_Cod*Prv_Cod*Pri_Cod*Cus_Cod*Sec_Cod*Est_Cod*Act_Can*Act_Fec*Act_Val*Act_Res*Act_Ann',1)"<? }?> >
