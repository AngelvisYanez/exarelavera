...
/*Secci�n ajax para guardar un nuevo tipo de activo*/
if(isset($saveTipoActivo)){   
	...
	if($Tia_Tip=='D')
	{
		/*Secci�n para obtener el c�digo de la �ltima inserci�n en la tabla tipo_activ*/
    ...
    $obBD_con1->operacionobBD(620, $Tia_Cod.'*'.$Apr_Cod, $obBD_conexion);
		...
		foreach($campos as $valor)
		{
			...
			/*Secci�n para obtener el c�digo de la �ltima inserci�n en la tabla campos_act*/
...
<BODY>
                            ...
                            <form id="formTipo_Activ" class="form-horizontal normal"  action="javascript:saveForm();"  >
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10">
                                      ...
                                      <input id="des_padre" name="des_padre" type="text" placeholder="" class="form-control input-xs bold" readonly value="Activo Ra&iacute;z" />
   ...
   <script type="text/javascript">
   /*Funci�n para eliminar un registro tanto del jqgrid como del array*/
   ...
   /*Funci�n para ubicar el c�digo del nuevo tipo de activo*/
   ...
   $treeview.jstree({'core' : {'data': {}}}).on('select_node.jstree', function (e, data) { 
		...
		bloquear(tipo);
		/*Llama a la funci�n updateCodigo para generar el nuevo c�digo del tipo de activo*/
		updateCodigo();
   });
   
   /*Funci�n para bloquear los elementos del formulario en caso de que sea un detalle*/
