...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table">
	<tr class="BarraTitulo">
	  <td height="10">&raquo; Registrar tipo de poliza</td>
  </tr>
	<tr>
        ...
        */
        ...
        <table width="574" border="0">
          <tr>
            ...
            <td width="458">
            <div class="Titulos2" id="div_tipo_poliz">
            <input name="Tip_Des" type="text" id="Tip_Des" value="" size="30" maxlength="30" style="text-transform:uppercase" 
            onfocus="if (trim(this.value) != '')ajax_datos('<?Php echo $_SERVER['PHP_SELF']; ?>?ajax_tipo_poliz=1&Tip_Des='+this.value,'div_tipo_poliz')">
            </div>
            </td>
          </tr>
           <tr>
            ...
            <td width="458">
            <input name="Tip_Obs" type="text" id="Tip_Obs" value="" size="30" maxlength="30" style="text-transform:uppercase">
            </td>
          </tr>
      </table>     
	  </FIELDSET>	
      ...
      <input name="hdd_save" type="hidden" id="hdd_save" value="insertar">
       <button type="button" id="btnGuadar" class="btn btn-primary start" title="Guardar" onclick="validar_requeridos(this.form, 'Tip_Des*Tip_Obs', 1)">
...
<script type="text/javascript" src="../VALIDACIONES/act_par_tipo_poliz.js"></script>
