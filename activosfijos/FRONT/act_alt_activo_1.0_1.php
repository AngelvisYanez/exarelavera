...
//Secci�n para guardar las fotos del activo (Se actualiza el activo para poder registrar en el campo Act_Fot)
if(isset($uploadfoto2)){      
    ...
    if($nombre[$last]!="")
    {
        ...
        foreach($act_cod as $row){
            ...
            //Verificamos si el campo Act_Fot esta vac�o o lleno(concatenar)
...
<BODY>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapse3">Elecci�n Cuenta Contable</a>
        </h4>
      </div>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapse2">Elecci�n Im�genes Activo</a>
        </h4>
      </div>
      <div id="collapse2" class="panel-collapse collapse">
        <div class="panel-body">Lorem ipsum dolor sit amet, consectetur adipisicing elit,
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapse3">Proyecci�n Depreciaci�n Activo</a>
        </h4>
      </div>
      <div id="collapse3" class="panel-collapse collapse">
        <div class="panel-body">Lorem ipsum dolor sit amet, consectetur adipisicing elit,
                            ...
                            <div class="col-sm-12">
                                <fieldset class="exa-fieldset">                           
                                    ...
                                    <div class="col-sm-4 col-md-5">
                                        <!-- Text input -->
                                        <div class="form-group">
                                            <label class="col-md-5 control-label label-xs required" for="Act_Val">Vida &Uacute;til (a�os):</label>
                                            <div class="col-md-5">
                                        ...
                                        <!-- Text input-->
                                        <div class="form-group">
                                            <label class="col-md-5 control-label label-xs required" for="des_padre">C�digo Secuencia:</label>  
                                            <div class="col-md-5">
                                        ...
                                        <!-- Text input-->
                                        <div class="form-group">
                                            <label class="col-md-5 control-label label-xs required" for="des_padre">Garant�a (meses):</label>  
                                            <div class="col-md-5">
            ...
            <fieldset class="exa-fieldset">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 radioset" >
                        ...
                        <input id="rad4" name="op_perito" type="radio" value="c" onclick="setfocus(this.form.search_perito)" alt="" /><label for="rad4">&nbsp;&nbsp;C�dula/R.U.C.&nbsp;&nbsp;</label>
                    </div>
                </div>
                <div class="form-group">
    ...
    <!-- Inicio del di�logo para buscar un proveedoor --> 
            ...
            <fieldset class="exa-fieldset">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 radioset">
                        ...
                        <input id="rad6" name="op_opciones" type="radio" value="c" onclick="setfocus(this.form.search)" alt="" /><label for="rad6">&nbsp;&nbsp;C�dula/R.U.C.&nbsp;&nbsp;</label>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-2 control-label">B&uacute;squeda:</label>
    ...
    $(document).ready(function(){
        //Deshabilito botones de la pesta�a cuenta contable
    ...
    $(document).ready(function()
    {
        ...
        $('#Tia_Cod').on('change', function() {
            ...
            $.post('<?Php echo htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES, 'UTF-8'); ?>',codigo, function( response ){
                ...
                /*Llama a la funci�n addcampos para agregar los campos que pertenecen al tipo de activo seleccionado*/
                addcampos(); 
            },'json');
        });
    });
    ...
    $(document).ready(function() {               
        $.createSearchDialog('#productoSDialog',[
            { label: 'C�d.Int.', name: 'Pro_Cod', key: true,hidden:true,viewable: true },                                
    ...
    function inicializar_input_file(){
        $("#file5").fileinput({
            uploadUrl: '<?Php echo htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES, 'UTF-8'); ?>', // you must set a valid URL here else you will get an error
            showCaption: false,
            showRemove: false,
            showCancel: false,
    ...
    function saveForm(){ 
        ...
        .done(function(responce){
            if(responce.success===true){
                ...
                //Secci�n para actualizar el GridDialog de productos con factura de compra
