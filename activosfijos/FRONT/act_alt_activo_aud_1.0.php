 ...
 * Descripci�n: Permite verificar los activos dados al personal       *
 * Desarrollador: Didimo Zamora                                       *
 * Fecha de actualizaci�n:	2013/07/09                                *
 *********************************************************************/
...
/**
 * Controla el reenvio de la p�gina
 */
            	...
            	<td colspan="2">
                	...
                	<tr>
                        ...
                        <td width="179"><input type="radio" name="op_opciones" value="2" <?Php if($op_opciones==2){ echo "checked";}?> onClick="setfocus(this.form.txt_busqueda)">
                            <span class="LetraNegra">C�dula</span></td>
                  	</tr>
                  	</table>
                </td>
            </tr>
...
<p>
   ...
   */
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" >      
		<tr>
			<td width="14%" class="Etiqueta1">Instituci�n:</td>
	...
	<thead>
		...
		<th width="24%" align="center">Descripci�n del Activo</th>     	  
