 ...
 * Descripci�n: Permite consultar los controles de custodia de activos fijos.       *
 * Desarrollador: Didimo Zamora                                                     *
 * Fecha de actualizaci�n:	2013/07/24                                              *
 ************************************************************************************/
  ...
  <FIELDSET>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" >      
			...
			<tr>
				...
				<td width="2%" align="left" class="Etiqueta1" >C�dula:</td>   	
