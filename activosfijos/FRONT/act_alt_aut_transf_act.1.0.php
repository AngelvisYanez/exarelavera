<?php 
/************************************************************************** 
 * Alias: Autorizaci�n de Activos a Custodio.							  *
 * Descripci�n: Permite la confirmaci�n final de los activos a un custodio*
 * Desarrollador:  Didimo Zamora						                  *
 * Fecha de actualizaci�n:	2013/06/11	
 * Fecha de actualizaci�n:	2013/09/06					                  *
 **************************************************************************/
		 ...
		 */ 
		 if (isset($arr)){	
			...
			for ($j=1; $j<= count($cant_act)-1; $j++)
				{				
					//Actualiza estado de confirmaci�n del activo fijo para el custodio.
            ...
            <FIELDSET>
                ...
                <label class="Titulos2">Datos del Custodio:</label>
                    ...
                    <table   width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td width="15%" class="Etiqueta1" ><span class="Etiqueta1">C�dula:</span></td>
