 ...
 * Fecha de actualizaci�n:	12-06-2013.
 */
...
$total_rs_seccion = count($rs_seccion);
 ...
 { 
	...
	{ 
			...
			/**
			 * Consulta el ultimo activo insertado para el c�digo manual
			 */
			$rs_ult_act = $obBD_con1->getRowConsulta(426,$Tia_Des, $obBD_conexion);
			$Act_Cdc = $rs_ult_act["Cod"] + 1;			
			/**
			 * Inserci�n del activo
			 */
			$Act_Cdc = $Tia_Cdc.'.'.$Act_Cdc;
			$Act_var ='';
			$Act_gen ='';	
			/**
			* Asignaci�n del tipo para c�digo de barras
			*/
			if($Act_Gen==1)
			{
...
<?php if(isset($Tia_Des))
	  { 
	  	/**
		* Consulta la descripci�n del tipo de activo especifico
		*/
...
<fieldset>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<!--<tr>
		<td width="17%" class="Etiqueta1"><span class="Asterisco">*</span> C�digo Activo:</td>
  ...
  <LEGEND>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="84%" colspan="2">&nbsp;<input name="Act_Ann" type="text" id="Act_Ann" value="0" size="10" maxlength="3" onKeyPress="return validar_numeric(event)" style="text-align:right"><span class="Etiqueta1"> A�os </span></td>
        </tr>
	</table>
	</fieldset>
   <fieldset>
