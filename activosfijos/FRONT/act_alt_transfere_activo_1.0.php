 ...
 * Descripci�n: Permite la consulta de custodio 
 * Desarrollador: Didimo Zamora
 * Fecha de actualizaci�n:	2013/06/11
 * Fecha de actualizaci�n:	2013/08/20
*/
		 ...
		 */ 
		 if (isset($arr)){	
			...
			for ($j=1; $j<= count($cant_act)-1; $j++)
				{						
						/**
						 * Consultar el orden para una nueva asignaci�n.
						 */
		 ...
		 unset($codigo);
		 /**
		  * Inserci�n de los activos seleccionados 
		  */
	 }	 
?> 
<HTML>
                ...
                <table width="317" border="0">
                  <tr>
                    ...
                    <td width="313"><input type="radio" name="op_opciones" value="2" onClick="setfocus(this.form.txt_busqueda)">
                        <span class="LetraNegra">C�dula</span>
                    </td>
                  </tr>
                </table>
              </td>
...
<FIELDSET>
	...
	<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="11%" height="23" class="Etiqueta1" ><span class="Etiqueta1">C�dula: </span></td>
...
<FIELDSET>
    ...
    <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
     ...
     <tr>
      ...
      <tr>
        <td width="24%" class="Etiqueta1"><span class="Asterisco">*</span> Raz�n de Traslado :</td>
