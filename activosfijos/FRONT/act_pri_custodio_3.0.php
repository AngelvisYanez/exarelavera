...
/** 
 @Alias:		 Imprimir
 @Descripci�n:   Permite la impresi�n de activos por Custodio
 @Desarrollador: Didimo Zamora.
***********************************
 @Fecha de actualizaci�n:	2013-06-10
*/
...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="20%" ><span class="Etiqueta1">Instituci�n :</span></td>
  ...
  <tr>
    ...
    <td><span class="Etiqueta1">C�dula :</span></td>
...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="Texto_Reporte">
	...
	/*
		foreach($Observaciones as $Obser => $valor) { 
			...
			echo " <td width='55%' align='left' valign='top'><span class='Etiqueta1'> &nbsp; El Ord: ".$Obser." tiene la Observaci�n: ".$valor." </span></td> "; 
			echo " </tr>";
		}*/
...
<tr >
      ...
      <p>&nbsp;</p>
      <p><b>En la ciudad de Machala y en esta fecha, se procede a realizar la legalizaci�n del traspaso de responsabilidad y custodia de los bienes a usted entregados por el Ministerio de Cordinaci�n de Seguridad - Centro Zonal de Seguridad ECU-911, para el normal desempe�o de sus labores, cumpliendo con lo se�alado en el Reglamento General Sustitutivo para el Control de Manejo y Control de los Bienes del Sector P�blico(Art. 3 - Art. 92) y en el Manual General de Administraci�n y Control de los Activos fijos del Sector P�blico(Acuerdo No. 12 CG), publicado en el suplemento del Registro Oficial No. 59 Capitulo III, del 7 de Mayo de 1997 y de acuerdo con lo establecido en el manual de funciones. Para constancia de lo antes detallado firmamos por triplicado. </b></p></td>   
    </tr>
</table>
