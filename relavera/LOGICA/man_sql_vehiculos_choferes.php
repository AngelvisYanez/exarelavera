    ...
    switch ($id) {
            ...
            if (empty($Par_Sql['limits'])) {
                $sql = "SELECT COUNT(*) as total 
                        ...
                        WHERE vehiculo.Veh_Est = 'A' 
                          ...
                          AND manifiesto_vehiculo.Pla_Cod = '$Par_Sql[Pla_Cod]' $search";
            } else {
        ...
        case 9:
            ...
            $sql = "INSERT INTO vehiculo (Veh_Mar, Veh_Pla, Veh_Col, Veh_Cap, Veh_Tit, Emp_Cod, Veh_Tip, Mat_Cod, Veh_Est, Prv_Cod)
                    VALUES ('$Par_Sql[0]', '$Par_Sql[1]', '$Par_Sql[2]', '$Par_Sql[3]', '$Par_Sql[4]', '$Par_Sql[5]', 'VM', NULL, 'A', " . (empty($Par_Sql[7]) ? 'NULL' : "'$Par_Sql[7]'") . ")";
            break;
