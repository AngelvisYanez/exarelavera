...
require_once("man_sql_datos_personales.php");
...
class Class_Log_Conexion_Actualizacion extends MysqlConexion{
...
class Class_Log_Datos_Actualizacion extends MysqlDatos{
    function __construct() {
        $this->setSentencias('sentencias_actualizacion');
    } 
