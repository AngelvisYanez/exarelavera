<?php
/**
 * Certificado B.07.01 por factura agrupado por placa de vehículo (HTML, sin firma).
 * Con firma electronica usar man_rep_certificado_factura_vehiculo_pdf.php.
...
if ($firmar && $Vet_Cod > 0) {
    ...
    $redir = 'man_rep_certificado_factura_vehiculo_pdf.php?Vet_Cod=' . $Vet_Cod;
...
<head>
    <meta charset="UTF-8">
    <title>Certificado de Manifiestos por Vehículo</title>
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        table.data-table tr.group-subtotal td {
    ...
    <div class="report-wrap">
        <header class="report-header">
            <div class="brand">
                ...
                <p class="doc-type">Certificado de manifiestos por vehículo B.07.01</p>
            </div>
            <div class="logo-wrap">
        ...
        <div class="cert-official-header">
            ...
            <p class="cert-main-title">Certificado de manifiestos por vehículo — fase de disposici&oacute;n final<br>de desechos peligrosos y/o especiales B.07.01</p>
        ...
        <div class="table-block">
            <table class="data-table">
                <caption>Manifiestos agrupados por vehículo (placa)</caption>
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Fecha</th>
                ...
                <tbody>
                    ...
                    <tr class="group-header">
                        <td colspan="7">VEH&Iacute;CULO: <?php echo h($placa); ?> &mdash; <?php echo (int)$cant_placa; ?> manifiesto(s)</td>
                    </tr>
                    <?php foreach ($items as $item):
                        $suma_total += (float)$item['Valor'];
                        $suma_peso += (float)$item['Man_Pes'];
                        $sub_peso += (float)$item['Man_Pes'];
                        $sub_valor += (float)$item['Valor'];
                    ?>
                    <tr>
                    ...
                    <tr class="group-subtotal">
                        <td colspan="5">Subtotal (Placa: <?php echo h($placa); ?>)</td>
                        <td class="numeric"><?php echo number_format($sub_peso, 2, '.', ','); ?></td>
                        <td class="numeric">$ <?php echo number_format($sub_valor, 2, '.', ','); ?></td>
                    </tr>
                    <?php endforeach; ?>
                    <tr class="total-row">
