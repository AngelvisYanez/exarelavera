...
(function ($, window, document, Date) {
    ...
    $.MonthPicker = {
        ...
        i18n: {
            ...
            prevYear: 'Anterior',
            nextYear: 'Siguiente',
            next12Years: 'Adelante 12 A&ntilde;os',
            prev12Years: 'Atras 12 A&ntilde;os',
            nextLabel: 'Sig.',
            prevLabel: 'Ant.',
            buttonText: 'Selecionar Mes',
            jumpYears: 'Saltar A&ntilde;os',
            backTo: 'Volver a',
    ...
    function _applyButtonHint(_button, _hintText) {
      ...
      function _fadeInHint() {
        _currentLabel = _labelElem.html();
        _labelElem.animate({ opacity: 1 }, _speed).html(_hintText);
      }
      ...
      function _fadeInLabel() {
        _labelElem.html( _currentLabel ).animate({opacity: 1}, _speed);
      }
    ...
    $.widget("KidSysco.MonthPicker", {
        ...
        _create: function () {
            ...
            $(_iconClass, this._nextButton).html(this._i18n('nextLabel'));
            $(_iconClass, this._prevButton).html(this._i18n('prevLabel'));
