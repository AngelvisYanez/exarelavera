...
!function(e){"use strict";"function"==typeof define&&define.amd?define("jstree.node_customize",["jquery","jstree"],e):"object"==typeof exports?e(require("jquery"),require("jstree")):e(jQuery,jQuery.jstree)}(function(s,e,f){"use strict";s.jstree.plugins.node_customize||(s.jstree.defaults.node_customize={key:"type",types:{},default:function(e,t){var n=t.icon,i=t.text;n!==f&&null!==n&&""!==n.trim()&&s(e).find(">a>i.jstree-icon.jstree-themeicon").removeAttr("class").addClass("jstree-icon jstree-themeicon jstree-themeicon-custom "+n),i!==f&&null!==i&&""!==i.trim()&&0===s(e).find(">a>span.node_customize").length&&s(e).find(">a").append(i)}},s.jstree.plugins.node_customize=function(e,a){this.redraw_node=function(e,t,n,i){var s=this._model.data[e],o=a.redraw_node.apply(this,arguments);if(o&&(""===s.text||s.text===f)){var r=this.settings.node_customize,u=s&&s.original&&s.original[r.key],c=u&&r.types[u],d=r.default;c&&c(o,s),s.text='<span class="node_customize">'+s.text+"</span>",s.icon+=" node_customize",d&&d(o,s)}return o}})});
$.jstree.core.prototype.get_data=function(t,e,r){if(!(t=this.get_node(t||$.jstree.root)))return!1;e&&e.flat&&!r&&(r=[]);var a,d,i={id:t.id,data:(!e||!e.no_data)&&$.extend(!0,{},t.data||t.original)};if(e&&e.flat?i.parent=t.parent:i.children=[],e&&e.flat&&t.id!==$.jstree.root&&r.push(i),!e||!e.no_children)for(a=0,d=t.children.length;a<d;a++)e&&e.flat?this.get_data(t.children[a],e,r):i.children.push(this.get_data(t.children[a],e));return e&&e.flat?r:t.id===$.jstree.root?i.children:i};
