...
var ChatWindow = (function () {
    function ChatWindow(options) {
        ...
        this.$windowTitle = $("<div/>").addClass("chat-window-title").addClass('decored').appendTo(this.$window);
        if(this.options.state)
            $('<div class="profile-status '+(this.options.status*1===1?'online':'offline')+'"></div>').prependTo(this.$windowTitle);
        ...
        $('<div></div>').addClass("text").html(this.options.title).appendTo(this.$windowTitle);        
