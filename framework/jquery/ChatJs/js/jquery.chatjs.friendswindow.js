...
var ChatFriendsWindow = (function () {
    function ChatFriendsWindow(options) {
        ...
        defaultOptions.titleText = "Amigos";
        defaultOptions.isMaximized = false;
        defaultOptions.offsetRight = 400;
        defaultOptions.emptyRoomText = "No se econtraron usuarios en este chat.";
...
//            userListOptions.userClicked = _this.options.userClicked;
        //$("#verq").userList(userListOptions);
        
        var chatWindowOptions = new ChatWindowOptions();
        chatWindowOptions.title = this.options.titleText;
        chatWindowOptions.state = false;
        chatWindowOptions.canClose = false;
        chatWindowOptions.height = 240;
        chatWindowOptions.width = 200;
        chatWindowOptions.isMaximized = this.options.isMaximized;
        chatWindowOptions.isMaximized=false; //agregado para q aparezca minimizado
        ...
        this.chatWindow.setRightOffset(this.options.offsetRight+0);
