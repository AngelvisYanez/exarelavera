...
var UserList = (function () {
    function UserList(jQuery, options) {
        ...
        defaultOptions.emptyRoomText = "No hay usuarios para chatear.";
        //defaultOptions.height = 150;
    ...
    UserList.prototype.populateList = function (rawUserList) {
        ...
        if (userList.length === 0) {
            ...
            for (var i = 0; i < userList.length; i++) {
                ...
                $("<div/>").addClass("profile-status").addClass(userList[i].Status*1 === 0 ? "offline" : "online").appendTo($userListItem);
