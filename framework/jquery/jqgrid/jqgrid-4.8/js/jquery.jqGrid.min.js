...
p=[];p=a.jgrid.findPos(f),d.left=(($('body').width()-(d.width*1))/2)-140/*p[0]+4*/,d.top=p[1]+4}o.top=d.top+"px",o.left=d.left; }else(0!==d.left||0!==d.top)&&(o.left=d.left,o.top=d.top+"px");if(a("a.ui-jqdialog-titlebar-close",l).click(function(){var
