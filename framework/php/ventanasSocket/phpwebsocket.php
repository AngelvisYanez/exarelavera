 ...
 */
 function frame_decode($payload){
	if (!isset($payload)) return null;  //empty data return nothing
	...
	if (strlen($masks)==4 && strlen($data)==0) { return "ping"; }
...
class User{
	...
	public function __toString(){ return "(User: ". $this->id." )"; }
}  //end of class User
