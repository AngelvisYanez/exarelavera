...
/* Ajax - Componente para la busqueda de la modalidad-etapa-periodo-carrera 
Modalidad = todas
Etapa = todas
Periodo = en base a la etapa y modalidad
Carreras = las que el director de escuela esta autorizado
Nota: Se utiliza la variable de sesion $Ses_Suc_Cod para filtar
*/
...
{	
	...
	$rs_carreras_etapa=$obBD_con1->consulta(sentencias_com(6, $obBD_con1->parametros($Cod_Eta.'*'.$Ses_Prs_Cod)), $obBD_conexion->conexion);
