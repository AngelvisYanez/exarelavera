...
<input name="txt_busqueda" type="text" id="txt_busqueda" style="text-transform:uppercase" value="" size="45"></td>
	...
	<input name="bnt_buscar" type="button" class="Boton_Buscar" title="Buscar" id="bnt_buscar" onClick="if (document.getElementById('txt_busqueda').value != ''){ ajax_datos('<?Php echo $_SERVER['PHP_SELF']; ?>?ajax_perDocente=1&ref='+ document.getElementById('txt_busqueda').value +'&opc=' + document.getElementById('opcion').value,'div_busDocente') }
    else { alert('El dato de este campo es requerido') }">
