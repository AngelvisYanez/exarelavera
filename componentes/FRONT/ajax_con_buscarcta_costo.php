	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0" class="fixedHeader01">
     <thead>
	  ...
	  <tr <? echo focus_row("resaltar_text", "resaltar_back", "undo_resaltar_text", "Cuerpo_ajax"); ?>  class="Cuerpo_ajax">
	    <td align="center"><? echo $row_rs_buscta['Pld_Cod']; ?>
			<input name="hdd_Cod" id="hdd_Cod" type="hidden" value="<? echo $row_rs_buscta['Pld_Cod']; ?>">
        </td>
		<td align="left"><?Php echo marcar_cadena($ajax_buscod, $row_rs_buscta['Pld_Cdc'],'#FFFF00', 1);?>
			<input name="hdd_Cdc" d="hdd_Cdc" type="hidden" value="<? echo $row_rs_buscta['Pld_Cdc']; ?>">
        </td>
		<td align="left"><?Php echo marcar_cadena($ajax_buscod, $row_rs_buscta['Pld_Des'],'#FFFF00', 1);?>
			<input name="hdd_Des" id="hdd_Des"type="hidden" value="<? echo $row_rs_buscta['Pld_Des']; ?>">
        </td>
		<td><div align="center"><? if ($row_rs_recur['Pld_Des'] != ""){?><input name="hdd_Gru" id="hdd_Gru" type="hidden" value="<? echo $row_rs_recur['Pld_Des'].'-'.$row_rs_grupo['Pld_Des']; ?>"> <?php echo $row_rs_recur['Pld_Des']." <strong>(".$row_rs_grupo['Pld_Des'].")</strong>"; }else{ 
								echo "&nbsp;"; } ?></div>
			</td>
