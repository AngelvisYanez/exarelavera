...
class Inspector implements InspectorInterface
{
    ...
    {
        $aux = $this->extractDocrefUrl($this->exception->getMessage());
        return $aux['message'];
    }
    ...
    public function getPreviousExceptionMessages()
    {
        return array_map(function ($prev) {
            /** @var \Throwable $prev */
            $aux = $this->extractDocrefUrl($prev->getMessage());
            return $aux['message'];
     ...
     */
    public function getFrames($frameFilters = array())
    {
        if ($this->frames === null) {
