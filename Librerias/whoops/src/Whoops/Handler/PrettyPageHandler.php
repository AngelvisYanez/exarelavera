...
class PrettyPageHandler extends Handler
{
     ...
     */
    protected $editorPathReplacements = array();
    ...
    public function __construct()
    {
        if (ini_get('xdebug.file_link_format') || get_cfg_var('xdebug.file_link_format')) {
            ...
            $this->editors['xdebug'] = function ($file, $line) {
                return str_replace(array('%f', '%l'), array($file, $line), ini_get('xdebug.file_link_format') ?: get_cfg_var('xdebug.file_link_format'));
            };
        ...
        if (class_exists('Symfony\Component\VarDumper\Cloner\VarCloner')) {
            ...
            $cloner->addCasters(array('*' => function ($obj, $a, $stub, $isNested, $filter = 0) {
                $class = $stub->class;
                $classes = array($class => $class) + class_parents($obj) + class_implements($obj);
    ...
    public function handle()
    {
        ...
        $vars = array(
            ...
            "tables"      => array(
                ...
                "Files"                 => isset($_FILES) ? $this->masked($_FILES, '_FILES') : array(),
                "Cookies"               => $this->masked($_COOKIE, '_COOKIE'),
                "Session"               => isset($_SESSION) ? $this->masked($_SESSION, '_SESSION') :  array(),
